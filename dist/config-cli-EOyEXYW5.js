...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef, o as coerceSecretRef } from "./types.secrets-CL51SR4g.js";
...
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-FVeYRZYq.js";
import { n as info, o as success, t as danger } from "./globals-CZuktVBk.js";
import { a as resolveSecretRefValue } from "./resolve-CqhiFUTe.js";
import { C as validateConfigObjectRaw, u as readConfigFileSnapshot, x as collectUnsupportedSecretRefPolicyIssues } from "./io-E69J4lLI.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-OL6hE5dN.js";
import { n as setCommandJsonMode } from "./json-mode-C9EXv0q6.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-Clq3nB-A.js");
