...
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-DtfLeHAx.js";
import { t as sendMessageZalo } from "./send-COcJxJxo.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Dx-KpYRw.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-BmZT2ULA.js");
