...
import { $b as mergeAllowlist, Av as resolveMentionGating, Dv as resolveInboundSessionEnvelopeContext, Xp as resolveChannelMediaMaxBytes, Xv as dispatchReplyFromConfigWithSettledDispatcher, tx as summarizeMapping } from "./pi-embedded-DhFkhMap.js";
...
import { f as createScopedExpiringIdCache } from "./text-runtime-Cbjdi5n6.js";
...
import { r as resolveDefaultGroupPolicy } from "./runtime-group-policy-D9hbk91w.js";
...
import { d as resolveDualTextControlCommandGate, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists, s as resolveEffectiveAllowFromLists } from "./dm-policy-shared-3Jdbvvlm.js";
...
import { A as DEFAULT_WEBHOOK_MAX_BODY_BYTES } from "./webhook-ingress-CwnvXQ9i.js";
import "./system-events-D_U3rn_H.js";
import "./ssrf-policy-Cve-f-IZ.js";
import { a as resolveSenderScopedGroupPolicy, i as evaluateSenderGroupAccessForPolicy } from "./group-access-DOh5Oa0c.js";
import { x as buildMediaPayload } from "./reply-payload-DgkHZodm.js";
...
import { a as buildPendingHistoryContextFromMap, s as clearHistoryEntriesIfEnabled, u as recordPendingHistoryEntryIfEnabled } from "./reply-history-CYr7j6cE.js";
...
import { f as createDraftStreamLoop, n as keepHttpServerTaskAlive } from "./channel-lifecycle-CDODjVG7.js";
import "./mcp-config-vaYGkUmW.js";
import "./channel-setup-DNUJjRZ0.js";
import "./outbound-media-C5ItLzKv.js";
import "./msteams-D4Fc_NcY.js";
import "./runtime-api-DxXOQM0x.js";
import { a as resolveMSTeamsRouteConfig, i as resolveMSTeamsReplyPolicy, n as resolveMSTeamsAllowlistMatch, t as isMSTeamsGroupAllowed } from "./policy-CXs5tgk-.js";
import { A as resolveRequestUrl, C as isDownloadableAttachment, D as normalizeContentType, E as isUrlAllowed, M as safeHostForUrl, O as resolveAttachmentFetchPolicy, S as inferPlaceholder, T as isRecord, _ as GRAPH_ROOT, b as extractHtmlFromAttachment, d as createMSTeamsTokenProvider, f as loadMSTeamsSdkWithAuth, g as ATTACHMENT_TAG_RE, j as safeFetchWithPolicy, k as resolveMediaSsrfPolicy, l as createBotFrameworkJwtValidator, m as getMSTeamsRuntime, s as resolveMSTeamsCredentials, u as createMSTeamsAdapter, v as IMG_SRC_RE, w as isLikelyImageAttachment, x as extractInlineImageCandidates, y as applyAuthorizationHeaderForUrl } from "./graph-users-B1yQNP1u.js";
import { o as resolveMSTeamsChannelAllowlist, s as resolveMSTeamsUserAllowlist } from "./resolve-allowlist-BfMOQqIW.js";
import { S as extractMSTeamsPollVote, _ as classifyMSTeamsSendError, b as createMSTeamsConversationStoreFs, c as renderReplyPayloadsToMessages, d as withRevokedProxyFallback, f as getPendingUpload, g as uploadToConsentUrl, h as parseFileConsentInvoke, l as sendMSTeamsMessages, m as buildFileInfoCard, p as removePendingUpload, s as buildConversationReference, u as AI_GENERATED_ENTITY, v as formatMSTeamsSendErrorHint, x as createMSTeamsPollStoreFs, y as formatUnknownError } from "./probe-3l3_XS5K.js";
...
function createTeamsReplyStreamController(params) {
	...
	return {
		...
		preparePayload(payload) {
			if (!stream || !streamReceivedTokens || !stream.hasContent) return payload;
			if (!Boolean(payload.mediaUrl || payload.mediaUrls?.length)) return;
			return {
				...payload,
				text: void 0
			};
...
async function monitorMSTeamsProvider(opts) {
	...
	expressApp.use((req, res, next) => {
		...
		jwtValidator.validate(authHeader, serviceUrl).then((valid) => {
			if (!valid) {
