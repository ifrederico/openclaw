...
import { t as DEFAULT_AGENT_ID } from "./session-key-BR3Z-ljs.js";
import { V as listRiskyConfiguredSafeBins, z as normalizeTrustedSafeBinDirs } from "./io-CS2J_l4V.js";
...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-Bp5fxpNd.js";
...
import { V as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-CBfBa44f.js";
...
import { n as collectEnabledInsecureOrDangerousFlags, t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-CIadoUap.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-J8xdlrOz.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-DFXhmhPA.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-DjEksc0S.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-DYqJ4wxu.js");
...
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-Ot8KXetw.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-DS_a955m.js"),
		import("./probe-auth-DKWNWH8y.js"),
		import("./probe-CrBbTzee.js")
