...
import { $r as resolveDefaultModelForAgent, Eo as createNonExitingRuntime, No as isVerbose, O as loadConfig, Xi as logError, Yi as logDebug, eo as danger, io as shouldLogVerbose, no as logVerbose, o as createSubsystemLogger, oo as warn } from "./env-D1ktUnAV.js";
import { C as resolveRequiredHomeDir, _ as resolveStateDir } from "./paths-CjuwkA2v.js";
import { _ as normalizeAccountId, u as resolveAgentIdFromSessionKey } from "./session-key-CYZxn_Kd.js";
...
import { a as clearExpiredCooldowns, f as resolveProfilesUnavailableReason, s as isProfileInCooldown } from "./auth-profiles-DLfrJtR9.js";
import { i as withFileLock } from "./file-lock-Cm3HPowf.js";
import { c as ensureAuthProfileStore } from "./profiles-CRvutsjq.js";
import { l as normalizeMessageChannel } from "./message-channel-ZzTqBBLH.js";
import { b as updateSessionStore, h as readSessionUpdatedAt, m as loadSessionStore } from "./sessions-uRDRs4f-.js";
...
import { i as resolveHumanDelayConfig } from "./identity-xGthCqY8.js";
import { $i as GatewayOpcodes$1, $l as dispatchReplyWithDispatcher, Ai as MessageReactionAddListener, Bi as UserSelectMenu, Br as stripUndefinedFields, Ci as TextDisplay, Cn as registerGateway, DC as normalizeDiscordToken, Di as GuildDeleteListener, Dt as dispatchPluginInteractiveHandler, EC as resolveDiscordMaxLinesPerMessage, Ei as Modal, Ev as resolveNativeCommandSessionTargets, Fi as VoiceServerUpdateListener, Fo as buildModelsProviderData, Gi as Command, Gn as createDiscordFormModal, Hi as RoleSelectMenu, Hv as formatInboundEnvelope, Ii as VoiceStateUpdateListener, Ji as Plugin, Jn as parseDiscordComponentCustomIdForCarbon, Jr as normalizeDiscordAllowList, Ki as ChannelSelectMenu, Kn as formatDiscordComponentEventText, Li as ListenerEvent, Mi as PresenceUpdateListener, Ni as ReadyListener, Oi as InteractionCreateListener, Pi as ThreadUpdateListener, Pn as editDiscordComponentMessage, Qb as canonicalizeAllowlistWithResolvedIds, Qi as GatewayIntentBits, Ql as dispatchReplyWithBufferedBlockDispatcher, Qr as resolveDiscordChannelConfigWithFallback, Ri as Client, Si as Separator, Ti as Row, Tl as getPluginCommandSpecs, Ui as MentionableSelectMenu, Vi as StringSelectMenu, Wi as CommandWithSubcommands, Wv as resolveEnvelopeFormatOptions, Xb as addAllowlistUserEntriesFromConfigEntry, Xi as ChannelType, Xn as parseDiscordModalCustomIdForCarbon, Xr as resolveDiscordAllowListMatch, Yi as serializePayload, Yn as parseDiscordModalCustomId, Yr as normalizeDiscordSlug, Zb as buildAllowlistResolutionSummary, Zi as GatewayCloseCodes$1, Zl as createReplyReferencePlanner, _l as executePluginCommand, ai as resolveGroupDmAllow, ci as formatDiscordUserTag, ei as resolveDiscordGuildEntry, er as resolveDiscordComponentEntry, ex as patchAllowlistUsersInConfigEntries, gb as resolveExecApprovalCommandDisplay, ia as Routes, ib as wrapFetchWithAbortSignal, ji as MessageReactionRemoveListener, ki as MessageCreateListener, la as setPresence, mb as getExecApprovalApproverDmNoticeText, na as ButtonStyle, ni as resolveDiscordOwnerAccess, oi as shouldEmitDiscordReactionNotification, qi as Button, qn as parseDiscordComponentCustomId, qr as isDiscordGroupAllowedByPolicy, ra as ChannelType$1, si as formatDiscordReactionEmoji, sr as formatMention, ta as ApplicationCommandOptionType, ti as resolveDiscordMemberAccessState, tr as resolveDiscordModalEntry, tx as summarizeMapping, vi as createDiscordClient, wC as resolveDiscordAccount, wi as Container, wn as unregisterGateway, xi as chunkDiscordTextWithMode, yl as matchPluginCommand, zi as RateLimitError } from "./pi-embedded-DhFkhMap.js";
import { i as resolveAgentRoute } from "./resolve-route-C5Xj9lGN.js";
import { E as resolveTextChunkLimit, O as summarizeStringEntries, T as resolveChunkMode, r as chunkItems, t as withTimeout } from "./text-runtime-Cbjdi5n6.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "./runtime-group-policy-D9hbk91w.js";
import { F as resolvePluginConversationBindingApproval, N as parsePluginBindingApprovalCustomId, T as buildPluginBindingResolvedText, c as ensureConfiguredBindingRouteReady, l as resolveConfiguredBindingRoute, s as recordInboundSession, t as formatThreadBindingDurationLabel } from "./conversation-runtime-BfLWHgdb.js";
...
import { c as resolvePinnedMainDmOwnerFromAllowlist, l as resolveCommandAuthorizedFromAuthorizers, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-3Jdbvvlm.js";
...
import { o as resolveStoredModelOverride } from "./level-overrides-CnI16lFp.js";
import { i as formatDurationSeconds } from "./format-duration-BZ91X8Zr.js";
import { r as enqueueSystemEvent } from "./system-events-D_U3rn_H.js";
import { m as resolveTextChunksWithFallback, p as resolveSendableOutboundReplyParts } from "./reply-payload-DgkHZodm.js";
...
import { c as listChatCommands, d as listNativeCommandSpecsForConfig, g as resolveCommandArgMenu, h as resolveCommandArgChoices, m as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, v as serializeCommandArgs } from "./commands-registry-kALONq2A.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-X9DVN0CB.js";
import { t as loadWebMedia, u as getAgentScopedMediaLocalRoots } from "./web-media-B7RZCKik.js";
import { t as require_src } from "./src-hV2aBDoy.js";
import { n as createConnectedChannelStatusPatch, t as createOperatorApprovalsGatewayClient } from "./gateway-runtime-_5BLwTPa.js";
import { a as createArmableStallWatchdog } from "./channel-lifecycle-CDODjVG7.js";
import { S as buildDiscordInboundAccessContext, T as resolveDiscordChannelInfo, _ as buildGuildLabel, a as handleDiscordDmCommandDecision, f as resolveDiscordThreadParentInfo, g as buildDirectLabel, h as deliverDiscordReply, i as resolveDiscordEffectiveRoute, n as resolveDiscordBoundConversationRoute, o as resolveDiscordDmCommandAccess, s as sendTyping, x as buildDiscordGroupSystemPrompt, y as resolveDiscordSenderIdentity } from "./route-resolution-CpcM0TAI.js";
import { a as isThreadArchived } from "./thread-bindings.messages-c9E7_yjo.js";
import { o as normalizeDiscordListenerTimeoutMs, s as runDiscordTaskWithTimeout } from "./timeouts-BITLzPy1.js";
import { n as fetchDiscordApplicationId, t as DiscordUiContainer } from "./ui-D0TJd0MB.js";
import { t as resolveDiscordUserAllowlist } from "./resolve-users-fClEOaYr.js";
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-C5jzsnl7.js";
...
async function resolveDiscordNativeAutocompleteAuthorized(params) {
	...
	if (isGroupDm && discordConfig?.dm?.groupEnabled === false) return false;
	if (!isDirectMessage) {
		const { hasAccessRestrictions, memberAllowed } = resolveDiscordMemberAccessState({
			channelConfig,
			guildInfo,
...
function createDiscordGatewaySupervisor(params) {
	const emitter = getDiscordGatewayEmitter(params.client.getPlugin("gateway"));
	const pending = [];
	if (!emitter) return {
		attachLifecycle: () => {},
		detachLifecycle: () => {},
	...
	let phase = "buffering";
	let disposed = false;
	const logLateTeardownEvent = (event) => {
		params.runtime.error?.(danger(`discord: suppressed late gateway ${event.type} error during teardown: ${event.message}`));
	};
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-CGdcXCzN.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-DGTHFMWq.js");
