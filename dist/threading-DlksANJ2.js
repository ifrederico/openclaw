...
import { t as extractAssistantText } from "./pi-embedded-utils-BkjmxXgM.js";
...
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./agent-runtime-DODG47Qy.js";
import { o as Routes, s as StickerFormatType } from "./v10-FULzL-xS.js";
import { o as mergeAbortSignals } from "./timeouts-CVZiQUc8.js";
...
function resolveDiscordThreadStarterRoleIds(member) {
	return Array.isArray(member?.roles) ? member.roles.map((roleId) => String(roleId)) : void 0;
}
