...
import { n as resolveGatewayAuth, t as resolveEffectiveSharedGatewayAuth } from "./auth-resolve-CUlf3sC8.js";
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-E69J4lLI.js";
...
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-umkNj9Rb.js";
import { h as resolveRuntimeConfigCacheKey } from "./runtime-snapshot-DFDX1J4B.js";
import { t as buildChannelUiCatalog } from "./catalog-DYcB5w-_.js";
import { r as replaceConfigFile } from "./mutate-BYT2NP_Z.js";
import "./config-Dq84uU6c.js";
import { n as isRestartEnabled } from "./commands.flags-B7qbzmZ1.js";
import { a as publicKeyRawBase64UrlFromPem, r as loadOrCreateDeviceIdentity } from "./device-identity-BLrydLS4.js";
import { a as hasGatewayClientCap, n as GATEWAY_CLIENT_IDS, t as GATEWAY_CLIENT_CAPS } from "./client-info-DQju26jn.js";
import { i as isInternalNonDeliveryChannel } from "./message-channel-core-D2XbUpib.js";
import { c as isGatewayMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-B1O_CztY.js";
import { r as setSafeTimeout } from "./timer-delay-CboQ9I_p.js";
import { o as gatewayStartupUnavailableDetails } from "./client-DZ1aRkVL.js";
import { $ as validateExecApprovalsSetParams, $t as validateSkillsSearchParams, A as validateConfigSchemaParams, At as validateSessionsAbortParams, B as validateDevicePairApproveParams, Bt as validateSessionsListParams, Cn as validateWebPushUnsubscribeParams, Ct as validatePollParams, D as validateConfigPatchParams, Dn as validateWizardStartParams, E as validateConfigGetParams, En as validateWizardNextParams, F as validateCronRemoveParams, Ft as validateSessionsCompactionListParams, G as validateDeviceTokenRotateParams, Gt as validateSessionsPreviewParams, H as validateDevicePairRejectParams, Ht as validateSessionsMessagesUnsubscribeParams, I as validateCronRunParams, It as validateSessionsCompactionRestoreParams, Jr as ErrorCodes, Jt as validateSessionsSendParams, Kt as validateSessionsResetParams, L as validateCronRunsParams, Lt as validateSessionsCreateParams, Mt as validateSessionsCompactParams, N as validateCronAddParams, Nt as validateSessionsCompactionBranchParams, O as validateConfigSchemaLookupParams, On as validateWizardStatusParams, P as validateCronListParams, Pt as validateSessionsCompactionGetParams, Q as validateExecApprovalsNodeSetParams, Qt as validateSkillsInstallParams, R as validateCronStatusParams, Rt as validateSessionsDeleteParams, Sn as validateWebPushTestParams, St as validatePluginsUiDescriptorsParams, T as validateConfigApplyParams, Tn as validateWizardCancelParams, U as validateDevicePairRemoveParams, Ut as validateSessionsPatchParams, V as validateDevicePairListParams, Vt as validateSessionsMessagesSubscribeParams, W as validateDeviceTokenRevokeParams, Wt as validateSessionsPluginPatchParams, X as validateExecApprovalsGetParams, Xt as validateSkillsBinsParams, Yr as errorShape, Yt as validateSessionsUsageParams, Z as validateExecApprovalsNodeGetParams, Zt as validateSkillsDetailParams, _ as validateChannelsStatusParams, _n as validateUpdateStatusParams, _t as validateNodePendingEnqueueParams, a as validateAgentsCreateParams, an as validateTalkRealtimeRelayAudioParams, bn as validateWebLoginWaitParams, c as validateAgentsFilesListParams, cn as validateTalkRealtimeRelayToolResultParams, ct as validateNodeListParams, d as validateAgentsUpdateParams, dn as validateTalkSpeakParams, dt as validateNodePairRejectParams, en as validateSkillsStatusParams, et as validateLogsTailParams, f as validateArtifactsDownloadParams, ft as validateNodePairRemoveParams, g as validateChannelsStartParams, gn as validateUpdateRunParams, gt as validateNodePendingDrainParams, h as validateChannelsLogoutParams, hn as validateToolsInvokeParams, ht as validateNodePendingAckParams, i as validateAgentWaitParams, in as validateTalkModeParams, it as validateNodeEventParams, j as validateConfigSetParams, jt as validateSessionsCleanupParams, k as validateConfigSchemaLookupResult, kt as validateSendParams, l as validateAgentsFilesSetParams, ln as validateTalkRealtimeSessionParams, lt as validateNodePairApproveParams, m as validateArtifactsListParams, mi as COMMAND_DESCRIPTION_MAX_LENGTH, mn as validateToolsEffectiveParams, mt as validateNodePairVerifyParams, n as validateAgentIdentityParams, nn as validateTalkConfigParams, nt as validateModelsListParams, o as validateAgentsDeleteParams, on as validateTalkRealtimeRelayMarkParams, ot as validateNodeInvokeParams, p as validateArtifactsGetParams, pn as validateToolsCatalogParams, pt as validateNodePairRequestParams, qt as validateSessionsResolveParams, r as validateAgentParams, rt as validateNodeDescribeParams, s as validateAgentsFilesGetParams, sn as validateTalkRealtimeRelayStopParams, st as validateNodeInvokeResultParams, t as formatValidationErrors, tn as validateSkillsUpdateParams, tt as validateMessageActionParams, u as validateAgentsListParams, ut as validateNodePairListParams, v as validateChannelsStopParams, vn as validateWakeParams, w as validateCommandsListParams, wn as validateWebPushVapidPublicKeyParams, wt as validatePushTestParams, xn as validateWebPushSubscribeParams, yn as validateWebLoginStartParams, yt as validateNodeRenameParams, z as validateCronUpdateParams, zt as validateSessionsDescribeParams } from "./protocol-MvVoNN0Z.js";
import { n as annotateInterSessionPromptText, o as normalizeInputProvenance } from "./input-provenance-DyAc2t0f.js";
import { n as DEFAULT_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-D88uBdlI.js";
import { a as TALK_SECRETS_SCOPE, t as ADMIN_SCOPE$1 } from "./operator-scopes-D9nPeeKf.js";
import { n as authorizeOperatorScopesForMethod } from "./method-scopes-CXVBHLXE.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-Dd-BFtwl.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-D1nDbTwX.js";
import { n as ensureAuthProfileStore } from "./store-CSOk8Bno.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-BNUgpUnK.js";
import { g as patchPluginSessionExtension } from "./loader-B-GXgDrk.js";
import { i as asOptionalRecord, n as asNullableRecord } from "./record-coerce-BjNW89OI.js";
import { G as resolveMemoryDreamingConfig, H as isSameMemoryDreamingDay, J as resolveMemoryDreamingWorkspaces, K as resolveMemoryDreamingPluginConfig, W as resolveMemoryDeepDreamingConfig, X as resolveMemoryRemDreamingConfig, Y as resolveMemoryLightDreamingConfig } from "./dreaming-oOlVey8D.js";
import { M as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-B0MMVyKh.js";
import { i as hasInternalHookListeners, m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-C9TbPRWK.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-CSgsEl_z.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-C7L7pyed.js";
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-D10iqlpI.js";
import { a as resolveSessionFilePath, i as resolveRotatedGeneratedSessionFilePath, o as resolveSessionFilePathOptions, u as resolveSessionTranscriptsDirForAgent } from "./paths-DG09LE-n.js";
import { h as stringifyRouteThreadId } from "./channel-route-clbSK-46.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, r as mergeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-tofZwoN5.js";
import { t as loadSessionStore } from "./store-load-DjtlQRVG.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BkuUNjzB.js";
import { n as mergeSessionEntry } from "./types-B6qmUh0I.js";
import { o as updateSessionStore } from "./store-DvxAjGkI.js";
import "./plugins-C729ZIvi.js";
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-DEgkNCWw.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-L5yC6_6J.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BhLQLn2S.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-Dv4u8i3g.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-umbOEWUL.js";
import { d as normalizeReasoningLevel, f as normalizeThinkLevel } from "./thinking-kzXz5eaE.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-G30DI_5w.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-COZ3YHhO.js";
import { n as getDiagnosticStabilitySnapshot, r as normalizeDiagnosticStabilityQuery } from "./diagnostic-stability-BzDrfjbc.js";
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-7EMiaNjW.js";
import { t as detectRespawnSupervisor } from "./supervisor-markers-o73TiHFO.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, t as buildRestartSuccessContinuation } from "./restart-sentinel-DO_SYQPb.js";
import { l as getTotalQueueSize } from "./command-queue-DpckWpGD.js";
import { t as resolveAgentTimeoutMs } from "./timeout-XT_E4tFL.js";
import { c as setHeartbeatsEnabled } from "./heartbeat-wake-DUv91Jr5.js";
import { a as enqueueSystemEvent, s as isSystemEventContextChanged } from "./system-events-MVYRIFaX.js";
import { t as extractToolPayload } from "./tool-payload-C9IkpcXW.js";
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-BZXQbagB.js";
import { a as resolveCronRunLogPath, n as readCronRunLogEntriesPage, r as readCronRunLogEntriesPageAll } from "./run-log-CLsvfPr0.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-D11PDYbp.js";
import { i as normalizeCronJobCreate, o as normalizeCronJobPatch } from "./openclaw-tools-0ftkmYS3.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-Ce8ZI4la.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-CIiGJzcD.js";
import { i as restoreRedactedValues, n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-BS55lNZ2.js";
import { D as textToSpeech, E as synthesizeSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, f as listTtsPersonas, g as resolveTtsConfig, h as resolveTtsAutoMode, i as getResolvedSpeechProviderConfig, l as isTtsEnabled, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, u as isTtsProviderConfigured, v as resolveTtsProviderOrder, w as setTtsPersona } from "./tts-runtime-Btvk-HT-.js";
import "./tts-B4VxOis2.js";
import { a as DEFAULT_MEMORY_FILENAME, c as DEFAULT_USER_FILENAME, f as isWorkspaceSetupCompleted, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-Caf7L7oC.js";
import { i as resolveSandboxConfigForAgent } from "./config-CGjxzNyH.js";
import { a as isTimeoutError } from "./failover-error-BCSVecGt.js";
import "./auth-profiles-Dqjb7Hia.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-C2_-l33V.js";
import { c as projectOutboundPayloadPlanForMirror, n as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-ByxJCZw_.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-CAkDft3R.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-uCeCLCPX.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-ARCpniZT.js";
import { i as parseAbsoluteTimeMs } from "./stagger-CEHMsNAM.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-BBNQdZHS.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-DKSb7ihh.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-8S675UW4.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-D0sdiUGK.js";
import { n as normalizePollInput } from "./polls-FdbgCKC5.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-_QsE7dBj.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Bm48pkHP.js";
import "./target-resolver-BMkzXkOi.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-KLnCMtm0.js";
import { i as resolveReplyToMode } from "./reply-threading-Bdq9rx5I.js";
import { t as buildOutboundSessionContext } from "./session-context-vk35o4pA.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-dXse5DzJ.js";
import { n as validateTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-Db2GyQz5.js";
import { r as resolveOutboundTarget } from "./targets-C8HruAmn.js";
import { n as resolveAgentIdentity } from "./identity-Cg93gos2.js";
import { s as clearSessionQueues } from "./queue-Hu4RqkB4.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-Bq1zWbWO.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-D9s06l8h.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-KrU2mfs9.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-BwbreWcK.js";
...
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-BL0N_d2N.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-B4eaH2KK.js";
import "./skills-Z6LDXFJX.js";
import { n as resolveSendPolicy } from "./send-policy-B7J7eeE2.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-Buk7nxJx.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-BM_dGBRf.js";
import "./commands-registry-cUCFmu0M.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-D5DVs9d7.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-UxSPMMtB.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-CbBe5N3J.js";
import { n as compactEmbeddedPiSession } from "./pi-embedded-Bcz04p2i.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-DSbvD5XF.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-Qy95mLpA.js";
import { t as getChannelActivity } from "./channel-activity-BdX2_9eU.js";
import { t as WizardCancelledError } from "./prompts-Bz2hXswL.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-B8DtIXp7.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-DEYtFZmR.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-CjU7Wwrv.js";
import { t as movePathToTrash } from "./browser-trash-C_LPVXeM.js";
import "./browser-maintenance-BbF2fGRl.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-CJ2WLtHD.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-Dwvmm9sK.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-Dgmbkf1F.js";
import { r as agentCommandFromIngress } from "./agent-command-CYAAR35V.js";
...
import { t as formatForLog } from "./ws-log-CeB90f53.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-CzaiEDDD.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-Dd9iHtsW.js";
import { t as canExecRequestNode } from "./exec-defaults-By6E6M1v.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-jPSUGy7G.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-D8pwRdCX.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-lImLBdCk.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CFZErj4r.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-DEZToWwd.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-B1MRm3c4.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-DQc1wJCP.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-ClqNt1G_.js";
import { n as createOutboundSendDeps } from "./deps-BvJgAY_2.js";
import "./agent-CuJF6TBO.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-edFCbTni.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-ToBUFQLN.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-BHbG1w6j.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DHZmYZhu.js";
import "./server-constants-DqhtKRzX.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-3xUbD00m.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-C0WN1Q5d.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-B8Ooqwet.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-DA4gUz5k.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-BA41nF-I.js";
import { t as loadProviderUsageSummary } from "./provider-usage-C-fSW1nD.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-status-access-CbjyOjRp.js";
import { s as fetchClawHubSkillDetail } from "./clawhub-DYXBn9Hn.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-r4Lwlqy6.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-ffrMTyXD.js";
import { s as performGatewaySessionReset } from "./session-reset-service-CYdXwUFC.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-B9g8ht8U.js";
import { s as normalizeUpdateChannel } from "./update-channels-C2R3-lJO.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-OL6hE5dN.js";
import { t as readConfiguredLogTail } from "./log-tail-BQVt_1Zb.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-C35QDL1Z.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-Cy02odKY.js";
import { t as buildChannelAccountSnapshot } from "./status-CbEhefqS.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-DUqyxANF.js";
import { t as installSkill } from "./skills-install-DPUBJTr-.js";
import { n as readPackageVersion } from "./package-json-DB3j1HSU.js";
import { t as getStatusSummary } from "./status.summary-BQMJG2y5.js";
import "./status-CFvwnioE.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-CuE7CXqw.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-9yQUjG9X.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-Cuwt3qoX.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-1umYJ54y.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-DIMVdW2S.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CpGn9QCx.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-CT3ozyNA.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CGSsuDFi.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-CH3Y4cdj.js";
import "./heartbeat-runner-DpQCcYf2.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-CdFNwJxs.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-ytqN_zyh.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-CNenBt1p.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-VFjTOzR3.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-DkqMXMRL.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-B7CZkHEQ.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-Deubtfd_.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-DP6hkW-_.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-CrjeMps8.js";
...
const agentHandlers = {
	agent: async ({ params, respond, context, client, isWebchatConnect }) => {
		...
		if (requestedSessionKey) {
			...
			const rotatedGeneratedSessionFile = storePath && isNewSession && entry?.sessionId ? resolveRotatedGeneratedSessionFilePath({
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C2z_rC4-.js");
