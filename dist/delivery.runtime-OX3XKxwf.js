...
import { r as isInternalMessageChannel } from "./message-channel-B1O_CztY.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-BkuUNjzB.js";
import "./plugins-C729ZIvi.js";
import { i as normalizeOutboundPayloadsForJson, l as projectOutboundPayloadPlanForOutbound, n as createOutboundPayloadPlan, r as formatOutboundPayloadLog, s as projectOutboundPayloadPlanForJson, t as deliverOutboundPayloads } from "./deliver-ByxJCZw_.js";
...
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-CFZPY6Um.js";
...
async function deliverAgentCommandResult(params) {
	...
	if (deliver && deliveryChannel && !isInternalMessageChannel(deliveryChannel)) {
		if (deliveryTarget) deliverySucceeded = (await deliverOutboundPayloads({
			cfg,
