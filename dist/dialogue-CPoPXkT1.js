import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-Djb2J1r2.js";
import { r as loadCrestodianOverview } from "./overview-C4xmbcIz.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-8XUnV4c4.js")).planCrestodianCommand)({
		input,
		overview
	});
