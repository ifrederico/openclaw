...
import { Do as defaultRuntime, Ja as shortenHomePath, L as writeConfigFile, O as loadConfig, qa as shortenHomeInString, zt as resolvePluginSourceRoots } from "./env-D1ktUnAV.js";
...
import { u as promptYesNo } from "./tailscale-FHZADwLL.js";
...
import { n as enablePluginInConfig, r as setPluginEnabledInConfig } from "./provider-web-search-B2TRQt7q.js";
...
import "./frontmatter-rE5Boszh.js";
import "./install-source-utils-VvZgYxxl.js";
import "./plugins-install-persist-BEAuPi2c.js";
import { s as parseClawHubPluginSpec } from "./clawhub-C6rl6jLW.js";
import "./install-BFA6-ieA.js";
import "./clawhub-COg794qc.js";
import { a as buildPluginStatusReport, i as buildPluginInspectReport, n as buildPluginCompatibilityNotices, o as formatPluginCompatibilityNotice, t as buildAllPluginInspectReports } from "./status-DqeSTTLa.js";
import { d as logSlotWarnings, i as createPluginInstallLogger, t as applySlotSelectionForPlugin } from "./plugins-command-helpers-DE67ansY.js";
...
import { i as uninstallPlugin, r as resolveUninstallDirectoryTarget } from "./matrix-Cdf6B9z_.js";
import { n as runPluginInstallCommand, t as runPluginUpdateCommand } from "./plugins-update-command-bt8VJRtZ.js";
import { o as listMarketplacePlugins } from "./update-BRj1oYkw.js";
import "./plugin-install-config-policy-CBFBd4bX.js";
...
function registerPluginsCli(program) {
	...
	plugins.command("install").description("Install a plugin or hook pack (path, archive, npm spec, clawhub:package, or marketplace entry)").argument("<path-or-spec-or-plugin>", "Path (.ts/.js/.zip/.tgz/.tar.gz), npm package spec, or marketplace plugin name").option("-l, --link", "Link a local path instead of copying", false).option("--pin", "Record npm installs as exact resolved <name>@<version>", false).option("--marketplace <source>", "Install a Claude marketplace plugin from a local repo/path or git/GitHub source").action(async (raw, opts) => {
