...
import { h as stringifyRouteThreadId, o as channelRouteTargetsMatchExact } from "./channel-route-clbSK-46.js";
import { n as isSingleUseReplyToMode } from "./reply-reference-CNTiiz-8.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-CJRBysvf.js";
import { f as readNumberParam, g as readStringParam } from "./common-CA61yuMe.js";
import { c as normalizeMessagePresentation, s as normalizeInteractiveReply } from "./payload-Ojv8hlch.js";
import { n as resolveOutboundSendDep } from "./send-deps-CX8OwJjk.js";
import { t as adaptScopedAccountAccessor } from "./channel-config-helpers-C3YAiGHo.js";
import { t as buildOutboundBaseSessionKey } from "./base-session-key-Dzgj8Jq9.js";
import "./text-runtime-BMYQWTAu.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute } from "./core-DHPyYUWl.js";
import "./channel-core-DqHfnd3q.js";
import "./routing-D5xKv1Mn.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-CiTSiN-o.js";
import { t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-yJMo07fK.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-Do4-RkMj.js";
import { i as createPairingPrefixStripper } from "./channel-pairing-D3GB9vDi.js";
import { d as createDefaultChannelRuntimeState, u as createComputedAccountStatusAdapter } from "./status-helpers-EbdaWWKh.js";
import { t as resolveApprovalApprovers } from "./approval-approvers-BOPG70Fc.js";
import { t as createResolvedApproverActionAuthAdapter } from "./approval-auth-helpers-LjJBTdJT.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-CSChf1Eb.js";
import "./approval-delivery-runtime-DFQmXJgT.js";
import { n as createLazyChannelApprovalNativeRuntimeAdapter } from "./approval-handler-adapter-runtime-C4LfXWZC.js";
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-QcUjF88a.js";
import { n as createChannelNativeOriginTargetResolver, t as createChannelApproverDmTargetResolver } from "./approval-native-helpers-JRKDaSq0.js";
import "./approval-native-runtime-B2PvmXES.js";
import { o as resolveConfiguredFromRequiredCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-BTb9Sd0S.js";
import "./reply-reference-Cl6sYtC4.js";
import { o as createAccountScopedAllowlistNameResolver, r as buildLegacyDmAccountAllowlistAdapter, s as createFlatAllowlistOverrideResolver } from "./allowlist-config-edit-DAITfIEv.js";
import "./param-readers-CT-PdOQa.js";
import { a as resolveSlackAccount, i as resolveDefaultSlackAccountId, l as resolveSlackReplyToMode, n as listSlackAccountIds, o as resolveSlackAccountAllowFrom } from "./accounts-BL518s3M.js";
import { i as resolveSlackChannelId, n as normalizeSlackMessagingTarget, r as parseSlackTarget, t as looksLikeSlackTargetId } from "./target-parsing-WE4Kvnq9.js";
import { a as normalizeSlackApproverId, c as shouldSuppressLocalSlackExecApprovalPrompt, i as isSlackExecApprovalClientEnabled, o as resolveSlackExecApprovalTarget, r as isSlackExecApprovalAuthorizedSender, s as shouldHandleSlackExecApprovalRequest, t as getSlackExecApprovalApprovers } from "./exec-approvals-DLmIP2LE.js";
import { n as buildSlackPresentationBlocks, r as resolveSlackInteractiveBlockOffsets, t as buildSlackInteractiveBlocks } from "./blocks-render-ByHd7mpd.js";
import { n as resolveSlackThreadTsValue, r as SLACK_TEXT_LIMIT, t as normalizeSlackThreadTsCandidate } from "./thread-ts-Bs1WzpW9.js";
import { n as extractSlackToolSend, t as describeSlackMessageTool } from "./message-tool-api-BbgbNpdB.js";
import { n as isSlackInteractiveRepliesEnabled, t as compileSlackInteractiveReplies } from "./interactive-replies-BoZyT6bY.js";
import "./channel-api-Bbp3cw9-.js";
import { r as createSlackWebClient } from "./client-CyKlul8Z.js";
import { r as normalizeAllowListLower } from "./allow-list-DRNDm6bX.js";
import { n as resolveSlackGroupToolPolicy, t as resolveSlackGroupRequireMention } from "./group-policy-HelMEvId.js";
import { t as resolveSlackReplyBlocks } from "./reply-blocks-CaeG_p1e.js";
import { t as getOptionalSlackRuntime } from "./runtime-Bz5U02pE.js";
import { i as slackSecurityAdapter, n as isSlackPluginAccountConfigured, r as slackConfigAdapter, t as createSlackPluginBase } from "./shared-DYsV_xf6.js";
import { i as SLACK_CHANNEL, n as createSlackSetupWizardProxy, r as slackSetupAdapter } from "./setup-core-DlXoQQp0.js";
...
const slackApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-DZ_O46Ni.js")).slackApprovalNativeRuntime
	})
});
...
const loadSlackSetupSurfaceModule = createLazyRuntimeModule(() => import("./setup-surface-BFcoYQCF.js"));
const loadSlackScopesModule = createLazyRuntimeModule(() => import("./scopes-DXvYi2j9.js"));
const loadSlackOutboundAdapterModule = createLazyRuntimeModule(() => import("./outbound-adapter-DRlF1oTO.js"));
...
const loadSlackDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-B-rkbaMD.js"));
const loadSlackResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-Ddw99nFD.js"));
const loadSlackResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CMqG4avU.js"));
async function loadSlackActionRuntime() {
	slackActionRuntimePromise ??= import("./action-runtime.runtime.js");
	return await slackActionRuntimePromise;
}
async function loadSlackSendRuntime() {
	slackSendRuntimePromise ??= import("./send.runtime-B_3wyvRy.js");
	return await slackSendRuntimePromise;
}
async function loadSlackProbeModule() {
	slackProbeModulePromise ??= import("./probe-ju_cl4bO.js");
	return await slackProbeModulePromise;
}
async function loadSlackMonitorModule() {
	slackMonitorModulePromise ??= import("./monitor-DtgF-ySu.js");
	return await slackMonitorModulePromise;
}
async function loadSlackDirectoryLiveModule() {
	slackDirectoryLiveModulePromise ??= import("./directory-live-BRTv6RDg.js");
