export declare const GENERATED_BASE_CONFIG_SCHEMA: {
                ...
                readonly properties: {
                    ...
                    readonly cooldowns: {
                        ...
                        readonly properties: {
                            ...
                            readonly overloadedProfileRotations: {
                                readonly type: "integer";
                                readonly minimum: 0;
                                readonly maximum: 9007199254740991;
                            };
                            readonly overloadedBackoffMs: {
                                readonly type: "integer";
                                readonly minimum: 0;
                                readonly maximum: 9007199254740991;
                            };
                            readonly rateLimitedProfileRotations: {
                                readonly type: "integer";
                                readonly minimum: 0;
                                readonly maximum: 9007199254740991;
                            };
                    ...
                    readonly providers: {
                        ...
                        readonly additionalProperties: {
                            ...
                            readonly properties: {
                                ...
                                readonly api: {
                                    readonly type: "string";
                                    readonly enum: readonly ["openai-completions", "openai-responses", "openai-codex-responses", "anthropic-messages", "google-generative-ai", "github-copilot", "bedrock-converse-stream", "ollama", "azure-openai-responses"];
                                };
                    ...
                    readonly defaults: {
                        ...
                        readonly properties: {
                                            ...
                                            readonly fts: {
                                                ...
                                                readonly properties: {
                                                    readonly tokenizer: {
                                                        readonly anyOf: readonly [{
                                                            readonly type: "string";
                                                            readonly const: "unicode61";
                                                        }, {
                                                            readonly type: "string";
                                                            readonly const: "trigram";
                                                        }];
                                                    };
                                                };
                                                readonly additionalProperties: false;
                            ...
                            readonly llm: {
                                readonly type: "object";
                                readonly properties: {
                                    readonly idleTimeoutSeconds: {
                                        readonly description: "Idle timeout for LLM streaming responses in seconds. If no token is received within this time, the request is aborted. Set to 0 to disable. Default: 60 seconds.";
                                        readonly type: "integer";
                                        readonly minimum: 0;
                                        readonly maximum: 9007199254740991;
                                    };
                                    ...
                                    readonly properties: {
                                        ...
                                        readonly exec: {
                                            ...
                                            readonly properties: {
                                                readonly host: {
                                                    readonly type: "string";
                                                    readonly enum: readonly ["auto", "sandbox", "gateway", "node"];
                                                };
                                                readonly security: {
                                                    readonly type: "string";
            ...
            readonly gateway: {
                ...
                readonly properties: {
                    ...
                    readonly webchat: {
                        readonly type: "object";
                        readonly properties: {
                            readonly chatHistoryMaxChars: {
                                readonly type: "integer";
                                readonly exclusiveMinimum: 0;
                                readonly maximum: 500000;
                            };
                        };
                        readonly additionalProperties: false;
                    };
    ...
    readonly uiHints: {
        ...
        readonly "tools.exec.host": {
            readonly label: "Exec Target";
            readonly help: "Selects execution target strategy for shell commands. Use \"auto\" for runtime-aware behavior (sandbox when available, otherwise gateway), or pin sandbox/gateway/node explicitly when you need a fixed surface.";
            readonly tags: ["tools"];
        };
        ...
        readonly "tools.web.search.enabled": {
            ...
            readonly help: "Enable managed web_search and optional Codex-native search for eligible models.";
            readonly tags: ["tools"];
        };
        ...
        readonly "tools.web.search.openaiCodex.enabled": {
            readonly label: "Enable Native Codex Web Search";
            readonly help: "Enable native Codex web search for Codex-capable models.";
            readonly tags: ["tools"];
        };
        readonly "tools.web.search.openaiCodex.mode": {
            readonly label: "Codex Web Search Mode";
            readonly help: "Native Codex web search mode: \"cached\" (default) or \"live\".";
            readonly tags: ["tools"];
        };
        readonly "tools.web.search.openaiCodex.allowedDomains": {
            readonly label: "Codex Allowed Domains";
            readonly help: "Optional domain allowlist passed to the native Codex web_search tool.";
            readonly tags: ["access", "tools"];
        };
        readonly "tools.web.search.openaiCodex.contextSize": {
            readonly label: "Codex Search Context Size";
            readonly help: "Native Codex search context size hint: \"low\", \"medium\", or \"high\".";
            readonly tags: ["tools"];
        };
        readonly "tools.web.search.openaiCodex.userLocation.country": {
            readonly label: "Codex User Country";
            readonly help: "Approximate country sent to native Codex web search.";
            readonly tags: ["tools"];
        };
        readonly "tools.web.search.openaiCodex.userLocation.region": {
            readonly label: "Codex User Region";
            readonly help: "Approximate region/state sent to native Codex web search.";
            readonly tags: ["tools"];
        };
        readonly "tools.web.search.openaiCodex.userLocation.city": {
            readonly label: "Codex User City";
            readonly help: "Approximate city sent to native Codex web search.";
            readonly tags: ["tools"];
        };
        readonly "tools.web.search.openaiCodex.userLocation.timezone": {
            readonly label: "Codex User Timezone";
            readonly help: "Approximate timezone sent to native Codex web search.";
            readonly tags: ["tools"];
        };
        readonly "tools.web.search.brave.mode": {
            readonly label: "Brave Search Mode";
            readonly help: "Brave Search mode: \"web\" (URL results) or \"llm-context\" (pre-extracted page content for LLM grounding).";
            readonly tags: ["tools"];
        };
        ...
        readonly "tools.web.fetch.provider": {
            readonly label: "Web Fetch Provider";
            readonly help: "Web fetch fallback provider id.";
            readonly tags: ["tools"];
        };
        ...
        readonly "gateway.push.apns.relay.baseUrl": {
            ...
            readonly tags: ["network", "advanced", "url-secret"];
        };
        ...
        readonly "gateway.webchat.chatHistoryMaxChars": {
            readonly label: "WebChat History Max Chars";
            readonly help: "Max characters per text field in chat.history responses before truncation (default: 12000).";
            readonly tags: ["network", "performance"];
        };
        ...
        readonly "agents.defaults.memorySearch.qmd": {
            readonly label: "Memory Search QMD Collections";
            readonly help: "Use this when one agent should query another agent's transcript collections; QMD-specific extra collections let you opt into cross-agent memory search without flattening everything into one shared namespace.";
            readonly tags: ["advanced"];
        };
        readonly "agents.defaults.memorySearch.qmd.extraCollections": {
            readonly label: "QMD Extra Collections";
            readonly help: "Use this when you need directional transcript search across agents; add collections here to scope QMD recalls without creating a shared global transcript namespace.";
            readonly tags: ["advanced"];
        };
        readonly "agents.defaults.memorySearch.qmd.extraCollections.path": {
            readonly label: "QMD Extra Collection Path";
            readonly help: "Use an absolute or workspace-relative filesystem path for the extra QMD collection; keep it pointed at the transcript directory or note folder you actually want this agent to search.";
            readonly tags: ["storage"];
        };
        readonly "agents.defaults.memorySearch.qmd.extraCollections.name": {
            readonly label: "QMD Extra Collection Name";
            readonly help: "Preserves the configured collection label only when the path points outside the agent workspace; paths inside the workspace stay agent-scoped even if a name is provided. Use this for shared cross-agent transcript roots that live outside the workspace.";
            readonly tags: ["advanced"];
        };
        readonly "agents.defaults.memorySearch.qmd.extraCollections.pattern": {
            readonly label: "QMD Extra Collection Pattern";
            readonly help: "Use a glob pattern to restrict which files inside the collection are indexed; keep the default `**/*.md` unless you need a narrower subset.";
            readonly tags: ["advanced"];
        };
        ...
        readonly "agents.defaults.memorySearch.remote.baseUrl": {
            ...
            readonly tags: ["advanced", "url-secret"];
        };
        ...
        readonly "memory.qmd.searchTool": {
            readonly label: "QMD Search Tool Override";
            readonly help: "Overrides the exact mcporter tool name used for QMD searches while preserving `searchMode` as the semantic retrieval mode. Use this only when your QMD MCP server exposes a custom tool such as `hybrid_search` and keep it unset for the normal built-in tool mapping.";
            readonly tags: ["storage"];
        };
        ...
        readonly "models.providers.*.baseUrl": {
            ...
            readonly tags: ["models", "url-secret"];
        };
        ...
        readonly "auth.cooldowns.overloadedProfileRotations": {
            readonly label: "Overloaded Profile Rotations";
            readonly help: "Maximum same-provider auth-profile rotations allowed for overloaded errors before switching to model fallback (default: 1).";
            readonly tags: ["auth", "access", "storage"];
        };
        readonly "auth.cooldowns.overloadedBackoffMs": {
            readonly label: "Overloaded Backoff (ms)";
            readonly help: "Fixed delay in milliseconds before retrying an overloaded provider/profile rotation (default: 0).";
            readonly tags: ["auth", "access", "reliability", "storage"];
        };
        readonly "auth.cooldowns.rateLimitedProfileRotations": {
            readonly label: "Rate-Limited Profile Rotations";
            readonly help: "Maximum same-provider auth-profile rotations allowed for rate-limit errors before switching to model fallback (default: 1).";
            readonly tags: ["auth", "access", "performance", "storage"];
        };
        ...
        readonly "agents.defaults.compaction.notifyUser": {
            readonly label: "Compaction Notify User";
            readonly help: "When enabled, sends a brief compaction notice to the user (e.g. '🧹 Compacting context...') when compaction starts. Disabled by default to keep compaction silent and non-intrusive.";
            readonly tags: ["advanced"];
        };
        ...
        readonly "plugins.installs.*.installPath": {
            ...
            readonly help: "Resolved install directory for the installed plugin bundle.";
            readonly tags: ["storage"];
        };
        ...
        readonly "mcp.servers.*.headers.*": {
            readonly sensitive: true;
            readonly tags: ["security"];
        };
        readonly "skills.entries.*.apiKey": {
            readonly sensitive: true;
            readonly tags: ["security", "auth"];
        };
        readonly "agents.list[].memorySearch.remote.baseUrl": {
            readonly tags: ["advanced", "url-secret"];
        };
        readonly "tools.web.fetch.firecrawl.baseUrl": {
            readonly tags: ["tools", "url-secret"];
        };
        readonly "tools.media.models[].baseUrl": {
            readonly tags: ["media", "tools", "url-secret"];
        };
        readonly "tools.media.image.baseUrl": {
            readonly tags: ["media", "tools", "url-secret"];
        };
        readonly "tools.media.image.models[].baseUrl": {
            readonly tags: ["media", "tools", "url-secret"];
        };
        readonly "tools.media.audio.baseUrl": {
            readonly tags: ["media", "tools", "url-secret"];
        };
        readonly "tools.media.audio.models[].baseUrl": {
            readonly tags: ["media", "tools", "url-secret"];
        };
        readonly "tools.media.video.baseUrl": {
            readonly tags: ["media", "tools", "url-secret"];
        };
        readonly "tools.media.video.models[].baseUrl": {
            readonly tags: ["media", "tools", "url-secret"];
        };
        readonly "mcp.servers.*.url": {
            readonly tags: ["advanced", "url-secret"];
        };
    };
