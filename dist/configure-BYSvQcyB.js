...
import { _ as shortenHomePath, m as resolveUserPath } from "./utils-ms6h9yny.js";
import { n as ensureAuthProfileStore } from "./store-HF_Z-jKz.js";
import "./auth-profiles-gRFfbuWd.js";
import { t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-yyDPxM31.js";
import { g as resolveDefaultAgentWorkspaceDir } from "./workspace-DLW8_PFX.js";
import { a as loadConfig, l as readConfigFileSnapshot } from "./io-CS2J_l4V.js";
...
import { o as isSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-BZdSA8i7.js";
...
import { a as findTailscaleBinary } from "./tailscale-BJXc86oW.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, d as randomToken, h as waitForGatewayReachable, m as validateGatewayPasswordInput, n as applyWizardMetadata, p as summarizeExistingConfig, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-CiVaZSUb.js";
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-ByeaoXxy.js";
...
import { t as WizardCancelledError } from "./prompts-BAZEOuSx.js";
import { n as logConfigUpdated } from "./logging-BqZycju2.js";
import { n as resolveProviderPluginChoice } from "./provider-wizard-D63EercM.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DQVjofXa.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-w6GM1hkj.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-DyMEem1L.js";
import { n as applyAuthChoice } from "./auth-choice-BAk-vi0n.js";
import { i as noteChannelStatus, o as shouldShowChannelInSetup, r as setupChannels } from "./onboard-channels-HN9QiYek.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-CLHOie1w.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B_LExwK4.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-C_JhHqFX.js";
import { i as promptCustomApiConfig } from "./onboard-custom-dW5rMZE2.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-DiB4OHe7.js";
import { t as formatHealthCheckFailure } from "./health-format-Cmbq1Yyd.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CxECg-yU.js";
import { t as setupSkills } from "./onboard-skills-CZyWT6Iw.js";
...
async function removeChannelConfigWizard(cfg, runtime) {
	let next = { ...cfg };
	const listConfiguredChannels = () => listChannelPlugins().map((plugin) => plugin.meta).filter((meta) => shouldShowChannelInSetup(meta)).filter((meta) => next.channels?.[meta.id] !== void 0);
	while (true) {
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-CyJUB0oM.js");
	const { describeCodexNativeWebSearch, isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-DIaG2HXL.js");
	...
	try {
		...
		if (opts.sections) {
			...
			if (selected.includes("plugins")) {
				const { configurePluginConfig } = await import("./setup.plugin-config-CqjiNY9Q.js");
