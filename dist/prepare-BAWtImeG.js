...
import { a as resolveChannelEntryMatchWithFallback, n as buildChannelKeyCandidates, t as applyChannelMatchMeta } from "./channel-config-DH9ug5w9.js";
...
import { t as evaluateGroupRouteAccessForPolicy } from "./group-access-agsrqQrw.js";
import { c as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy } from "./dm-policy-shared-CWGTUVOf.js";
...
import { t as buildUntrustedChannelMetadata } from "./security-runtime-DoGZwxD5.js";
...
import { o as resolveSlackReplyToMode } from "./accounts-Tmnle4cm.js";
import { a as normalizeSlackSlug, i as normalizeSlackAllowOwnerEntry, n as normalizeAllowList, o as resolveSlackAllowListMatch, r as normalizeAllowListLower, s as resolveSlackUserAllowed, t as allowListMatches } from "./allow-list-D3VALcs1.js";
import { t as sendMessageSlack } from "./send-BBuMxCSd.js";
import { _ as resolveSlackThreadHistory, g as resolveSlackMedia, h as resolveSlackAttachmentContent, l as reactSlackMessage, v as resolveSlackThreadStarter } from "./actions-Bnv3ePNo.js";
import { n as hasSlackThreadParticipation } from "./sent-thread-cache-CX8Zgp0H.js";
...
async function resolveSlackThreadContextData(params) {
	...
	const includeStarterContext = !starter || shouldIncludeSupplementalContext({
	...
	if (starter?.text && !includeStarterContext) logVerbose(`slack: omitted thread starter from context (mode=${params.contextVisibilityMode}, sender_allowed=${starterAllowed ? "yes" : "no"})`);
	...
	if (threadInitialHistoryLimit > 0 && !threadSessionPreviousTimestamp) {
		...
		if (threadHistory.length > 0) {
			...
			if (omittedHistoryCount > 0) logVerbose(`slack: omitted ${omittedHistoryCount} thread message(s) from context (mode=${params.contextVisibilityMode})`);
			const historyParts = [];
