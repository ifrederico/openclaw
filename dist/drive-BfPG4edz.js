import { a as createFeishuClient, c as listEnabledFeishuAccounts, d as resolveFeishuAccount, f as resolveFeishuRuntimeAccount, l as listFeishuAccountIds } from "./probe-wHoF6aaT.js";
...
function extractCommentElementText(element) {
	...
	if (type === "text_run" && isRecord(element.text_run)) return readString(element.text_run.content)?.trim() || readString(element.text_run.text)?.trim() || void 0;
	if (type === "mention") {
...
function formatDriveApiError(error) {
	...
	return JSON.stringify({
		...
		method: readString(isRecord(error.config) ? error.config.method : void 0),
		url: readString(isRecord(error.config) ? error.config.url : void 0),
		params: isRecord(error.config) ? error.config.params : void 0,
...
//#endregion
export { normalizeCommentFileType as a, toolExecutionErrorResult as c, resolveAnyEnabledFeishuToolsConfig as d, resolveFeishuToolAccount as f, resolveReceiveIdType as g, normalizeFeishuTarget as h, buildFeishuCommentTarget as i, unknownToolActionResult as l, looksLikeFeishuId as m, registerFeishuDriveTools as n, parseFeishuCommentTarget as o, resolveToolsConfig as p, replyComment as r, jsonToolResult as s, deliverCommentThreadText as t, createFeishuToolClient as u };
