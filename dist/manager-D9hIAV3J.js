...
import { b as isAcpSessionKey, c as normalizeAgentId, l as normalizeMainKey, w as parseAgentSessionKey } from "./session-key-BR3Z-ljs.js";
import { r as logVerbose } from "./globals-B43CpcZo.js";
import { i as resolveMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-D-BGz7Y3.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, r as completeTaskRunByRunId, u as startTaskRunByRunId } from "./task-executor-BBHnA_uB.js";
import { t as resolveAgentTimeoutMs } from "./timeout-C9RIx1qJ.js";
import { a as isSessionIdentityPending, c as resolveRuntimeResumeSessionId, d as AcpRuntimeError, i as identityEquals, l as resolveSessionIdentityFromMeta, m as withAcpRuntimeErrorBoundary, n as createIdentityFromHandleEvent, o as mergeSessionIdentity, p as toAcpRuntimeError, r as createIdentityFromStatus, s as resolveRuntimeHandleIdentifiersFromIdentity, t as createIdentityFromEnsure, u as ACP_ERROR_CODES } from "./session-identity-DQtM7u0c.js";
import { i as upsertAcpSessionMeta, n as readAcpSessionEntry, t as listAcpSessionEntries } from "./session-meta-88rJ-9mM.js";
...
var AcpSessionManager = class {
	...
	resolveBackgroundTaskContext(params) {
		...
		const requesterSessionKey = normalizeText(childEntry?.spawnedBy) ?? normalizeText(childEntry?.parentSessionKey);
