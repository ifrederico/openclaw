...
import { a as shouldLogVerbose, r as logVerbose, t as danger } from "./globals-B43CpcZo.js";
import { t as logDebug } from "./logger-DC8YwEpM.js";
...
import { i as resolveHumanDelayConfig, t as resolveAckReaction } from "./identity-BnWdHPUW.js";
...
import { n as stripInlineDirectiveTagsForDelivery } from "./directive-tags-D22CKjc1.js";
import { n as resolveBatchedReplyThreadingPolicy } from "./reply-threading-B6KmGqp6.js";
...
import { t as KeyedAsyncQueue } from "./keyed-async-queue-C2sMQqNB.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-VwLi93im.js";
...
import { i as createFinalizableDraftLifecycle, n as createRunStateMachine } from "./channel-lifecycle-3hD3I66y.js";
import { a as resolveDefaultDiscordAccountId, c as resolveDiscordMaxLinesPerMessage } from "./accounts-CNVeps3i.js";
import { o as Routes } from "./v10-FULzL-xS.js";
import { h as editMessageDiscord, i as removeReactionDiscord, it as createDiscordRuntimeAccountContext, n as reactMessageDiscord, ut as chunkDiscordTextWithMode } from "./send-Czq8YV5S.js";
import { i as resolveTimestampMs, n as formatDiscordUserTag, r as resolveDiscordSystemLocation } from "./format-Cb0sTcF2.js";
import { d as resolveDiscordMemberAccessState, g as resolveGroupDmAllow, h as resolveDiscordShouldRequireMention, i as normalizeDiscordSlug, n as isDiscordGroupAllowedByPolicy, p as resolveDiscordOwnerAccess, s as resolveDiscordChannelConfigWithFallback, u as resolveDiscordGuildEntry } from "./allow-list-BZ4s_laU.js";
import { l as isRecentlyUnboundThreadWebhookMessage } from "./thread-bindings.state-CN6OImuT.js";
import { t as resolveDiscordPreviewStreamMode } from "./preview-streaming-xC5hP6km.js";
import "./thread-bindings-B7C9WQyD.js";
import { l as runDiscordTaskWithTimeout, n as DISCORD_ATTACHMENT_TOTAL_TIMEOUT_MS, s as normalizeDiscordInboundWorkerTimeoutMs, t as DISCORD_ATTACHMENT_IDLE_TIMEOUT_MS } from "./timeouts-CVZiQUc8.js";
import { _ as resolveMediaList, a as resolveDiscordReplyDeliveryPlan, d as buildDiscordMediaPayload, f as hasDiscordMessageStickers, g as resolveForwardedMediaList, h as resolveDiscordMessageText, i as resolveDiscordAutoThreadReplyPlan, l as resolveDiscordThreadStarter, m as resolveDiscordMessageChannelId, p as resolveDiscordChannelInfo } from "./threading-DlksANJ2.js";
import { t as DISCORD_TEXT_CHUNK_LIMIT } from "./outbound-adapter-8nmRb6PX.js";
import { n as buildDiscordInboundAccessContext, r as createDiscordSupplementalContextAccessChecker } from "./inbound-context-DfqX-Xhh.js";
import { a as handleDiscordDmCommandDecision, c as buildDirectLabel, d as resolveDiscordSenderIdentity, f as resolveDiscordWebhookId, i as resolveDiscordEffectiveRoute, l as buildGuildLabel, o as resolveDiscordDmCommandAccess, r as resolveDiscordConversationRoute, s as deliverDiscordReply, t as buildDiscordRoutePeer, u as resolveReplyContext } from "./route-resolution-BlrRIzzd.js";
import { t as sendTyping } from "./typing-dML5iiAF.js";
	...
	const { dispatcher, replyOptions, markDispatchIdle, markRunComplete } = createReplyDispatcherWithTyping({
		...
		deliver: async (payload, info) => {
			...
			if (draftStream && isFinal) {
				...
				if (!finalizedViaPreviewMessage && !hasMedia && typeof previewFinalText === "string" && typeof previewMessageId === "string" && !hasExplicitReplyDirective && !payload.isError) {
				...
				if (!finalizedViaPreviewMessage) {
					...
					if (typeof messageIdAfterStop === "string" && typeof previewFinalText === "string" && !hasMedia && !hasExplicitReplyDirective && !payload.isError) try {
						notifyFinalReplyStart();
...
async function loadPluralKitRuntime() {
	pluralkitRuntimePromise ??= import("./pluralkit-BmDizIM4.js");
	return await pluralkitRuntimePromise;
}
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-DZA0-x__.js");
	return await discordSendRuntimePromise;
}
async function loadPreflightAudioRuntime() {
	preflightAudioRuntimePromise ??= import("./preflight-audio-2rRiSLT-.js");
	return await preflightAudioRuntimePromise;
}
async function loadSystemEventsRuntime() {
	systemEventsRuntimePromise ??= import("./system-events-C4kQfXs6.js");
	return await systemEventsRuntimePromise;
}
async function loadDiscordThreadingRuntime() {
	discordThreadingRuntimePromise ??= import("./threading-hCEGMPRG.js");
...
function resolveDiscordMentionState(params) {
	...
	return {
		implicitMention: Boolean(params.botId && params.referencedAuthorId && params.referencedAuthorId === params.botId),
		wasMentioned
	};
}
...
function shouldIgnoreBoundThreadWebhookMessage(params) {
	...
	const boundWebhookId = typeof params.threadBinding?.webhookId === "string" ? params.threadBinding.webhookId.trim() : typeof params.threadBinding?.metadata?.webhookId === "string" ? params.threadBinding.metadata.webhookId.trim() : "";
	if (!boundWebhookId) {
