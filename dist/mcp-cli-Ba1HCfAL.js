...
import { i as extractFirstTextBlock } from "./chat-message-content-DY2n5MJD.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-DqFs1EhP.js"),
			import("./client-SazYAj8P.js"),
			import("./client-start-readiness-qQyX79dR.js"),
			import("./method-scopes-B5-_OxZl.js"),
			import("./client-info-DtRZ0t7u.js")
		]);
