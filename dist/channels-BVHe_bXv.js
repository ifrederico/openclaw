...
import { Do as defaultRuntime, L as writeConfigFile, M as readConfigFileSnapshot, O as loadConfig, Oo as writeRuntimeJson, bi as resolveDefaultAgentId, eo as danger, fo as getResolvedLoggerSettings, yi as resolveAgentWorkspaceDir } from "./env-D1ktUnAV.js";
...
import { l as loadAuthProfileStore } from "./profiles-CRvutsjq.js";
...
import { c as listChannelPlugins, l as normalizeChannelId, s as getChannelPlugin } from "./plugins-h0t63KQW.js";
...
import { n as withProgress } from "./progress-DkYkfG5d.js";
...
import { Jh as resolveCommandSecretRefsViaGateway, Wh as resolveMessageChannelSelection, bv as createMessageActionDiscoveryContext, dc as formatUsageReportLines, uc as loadProviderUsageSummary, xv as resolveMessageActionDiscoveryForPlugin } from "./pi-embedded-DhFkhMap.js";
...
import { o as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CLiDrlXo.js";
import "./config-schema-BoeEl_gh.js";
import "./channel-plugin-common-Bw5e9GHM.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-DpK6TeKz.js";
...
import { n as formatTimeAgo } from "./format-relative-DcFuL9QS.js";
...
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-DLWtCRDE.js";
...
import "./status-DqeSTTLa.js";
import "./installs-CRyECh_H.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-DUUHgoXi.js";
import "./note-ChRKyaEb.js";
import { t as createClackPrompter } from "./clack-prompter-Co6OZb8y.js";
import "./plugin-install-plan-DorNBEJ6.js";
import "./bundled-sources-CntqGBhp.js";
import "./plugin-install-F8t6CEXi.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CwTpsat_.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-BPKJG_i0.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BZUlhLV2.js";
import { t as parseLogLine } from "./parse-log-line-B45HJbIX.js";
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-DIQ65H9l.js";
import { a as isCatalogChannelInstalled, r as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-Cus-crZT.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-CIDUskIv.js"), import("./onboard-channels-BOFQ1YJ-.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-Cmt4WoYJ.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-Cmt4WoYJ.js");
			const prompter = createClackPrompter();
