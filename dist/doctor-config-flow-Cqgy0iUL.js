...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-CL51SR4g.js";
...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-E69J4lLI.js";
import { n as formatConfigIssueLines } from "./issue-format-CEIVxsoT.js";
import { r as normalizeTalkSection } from "./talk-umkNj9Rb.js";
import { n as collectConfiguredModelRefs } from "./model-refs-DDcinLNL.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-CtGPNXes.js";
import { n as getBundledChannelPlugin, o as hasBundledChannelPackageSetupFeature } from "./bundled-DEq7iy1i.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-DSA33nXk.js";
import { n as getLoadedChannelPlugin } from "./registry-BkuUNjzB.js";
import { i as migrateLegacyRuntimeModelRef } from "./model-runtime-aliases-CN0ccyIq.js";
import { i as listRouteBindings } from "./bindings-DF2SAWWF.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-eMLRSy7s.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-CphMh5Y0.js";
import { t as note } from "./note-LfE3_jlk.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-j2K-IhiK.js";
import { a as mergeMissing, i as migrateLegacyXSearchConfig, r as migrateLegacyWebSearchConfig } from "./legacy-config-migrations-DMwlWTca.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-DahcHRHD.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-DhGfm5xB.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-Bk2KcZLH.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-C5upzEJ2.js";
import { t as asObjectRecord } from "./object-Dr4gMkYo.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { findDoctorLegacyConfigIssues } = await import("./legacy-config-issues-DgaYUYns.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-BXUVwplT.js");
	...
	const { collectBundledProviderAllowlistPolicyWarnings, collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-DYLE6EZ4.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BRUcgL_l.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-D9SBr_25.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-PzWvRm_d.js");
		emitDoctorNotes({
			note,
