import { O as loadConfig, Qa as truncateUtf16Safe, Yi as logDebug, br as resolveDiscordPreviewStreamMode, eo as danger, io as shouldLogVerbose, no as logVerbose, uo as getChildLogger } from "./env-D1ktUnAV.js";
import { _ as normalizeAccountId, d as resolveThreadSessionKeys } from "./session-key-CYZxn_Kd.js";
import { t as resolveAccountEntry } from "./account-lookup-Bk6bR-OE.js";
import { h as readSessionUpdatedAt } from "./sessions-uRDRs4f-.js";
...
import { $n as buildDiscordInteractiveComponents, An as reactMessageDiscord, EC as resolveDiscordMaxLinesPerMessage, Hv as formatInboundEnvelope, In as sendDiscordComponentMessage, Mn as removeReactionDiscord, Mv as createChannelInboundDebouncer, Nv as shouldDebounceTextInbound, Pv as hasControlCommand, Qr as resolveDiscordChannelConfigWithFallback, Sb as recordChannelActivity, Wv as resolveEnvelopeFormatOptions, Xi as ChannelType, Yr as normalizeDiscordSlug, Zv as dispatchInboundMessage, ai as resolveGroupDmAllow, ci as formatDiscordUserTag, ea as MessageType, ei as resolveDiscordGuildEntry, ia as Routes, ii as resolveDiscordShouldRequireMention, jv as resolveMentionGatingWithBypass, li as resolveDiscordSystemLocation, ni as resolveDiscordOwnerAccess, nr as sendMessageDiscord, ny as createReplyDispatcherWithTyping, or as sendWebhookMessageDiscord, pn as normalizeDiscordOutboundTarget, qr as isDiscordGroupAllowedByPolicy, rr as sendPollDiscord, tC as EmbeddedBlockChunker, ti as resolveDiscordMemberAccessState, ui as resolveTimestampMs, un as fetchPluralKitMessageInfo, ur as editMessageDiscord, xi as chunkDiscordTextWithMode } from "./pi-embedded-DhFkhMap.js";
...
import { E as resolveTextChunkLimit, T as resolveChunkMode, k as stripReasoningTagsFromText, m as convertMarkdownTables } from "./text-runtime-Cbjdi5n6.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-CutMp1Uo.js";
import { i as resolveOpenProviderRuntimeGroupPolicy } from "./runtime-group-policy-D9hbk91w.js";
import { W as getSessionBindingService, c as ensureConfiguredBindingRouteReady, j as isPluginOwnedSessionBindingRecord, l as resolveConfiguredBindingRoute, s as recordInboundSession } from "./conversation-runtime-BfLWHgdb.js";
...
import { a as createStatusReactionController, c as logInboundDrop, l as logTypingFailure, r as DEFAULT_TIMING, s as logAckFailure } from "./channel-feedback-CrvZHxrZ.js";
...
import { b as sendTextMediaPayload, f as resolvePayloadMediaUrls, p as resolveSendableOutboundReplyParts, v as sendPayloadMediaSequenceOrFallback } from "./reply-payload-DgkHZodm.js";
...
import { n as shouldAckReaction } from "./ack-reactions-C142ljS_.js";
import { c as createFinalizableDraftLifecycle, o as createRunStateMachine } from "./channel-lifecycle-CDODjVG7.js";
import { C as buildDiscordMediaPayload, D as resolveDiscordMessageText, E as resolveDiscordMessageChannelId, O as resolveForwardedMediaList, S as buildDiscordInboundAccessContext, T as resolveDiscordChannelInfo, _ as buildGuildLabel, a as handleDiscordDmCommandDecision, b as resolveDiscordWebhookId, c as resolveDiscordAutoThreadReplyPlan, d as resolveDiscordThreadChannel, f as resolveDiscordThreadParentInfo, g as buildDirectLabel, h as deliverDiscordReply, i as resolveDiscordEffectiveRoute, k as resolveMediaList, l as resolveDiscordReplyDeliveryPlan, o as resolveDiscordDmCommandAccess, p as resolveDiscordThreadStarter, r as resolveDiscordConversationRoute, s as sendTyping, t as buildDiscordRoutePeer, v as resolveReplyContext, w as hasDiscordMessageStickers, y as resolveDiscordSenderIdentity } from "./route-resolution-CpcM0TAI.js";
import { g as isRecentlyUnboundThreadWebhookMessage } from "./thread-bindings.messages-c9E7_yjo.js";
import { a as normalizeDiscordInboundWorkerTimeoutMs, s as runDiscordTaskWithTimeout } from "./timeouts-BITLzPy1.js";
import { d as getThreadBindingManager } from "./thread-bindings-Ct7f79cV.js";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./preflight-audio.runtime-CMn1114T.js");
			if (params.abortSignal?.aborted) return {
				hasAudioAttachment,
				hasTypedText
			};
