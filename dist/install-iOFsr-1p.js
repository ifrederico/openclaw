...
import { a as safePathSegmentHashed, i as safeDirName, n as packageNameMatchesId, o as unscopedPackageName, r as resolveSafeInstallDir } from "./install-safe-path-BDonx5yF.js";
import path from "node:path";
import fs from "node:fs/promises";
//#region src/plugins/install.ts
let pluginInstallRuntimePromise;
async function loadPluginInstallRuntime() {
	pluginInstallRuntimePromise ??= import("./install.runtime-CrZOJC8K.js");
