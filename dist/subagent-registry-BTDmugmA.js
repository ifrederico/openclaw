...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-CSgsEl_z.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-CRTEGt5u.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-CoplUDPn.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-CRTEGt5u.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-M8qfuGL9.js").then(({ scheduleOrphanRecovery }) => {
	...
	try {
		...
		for (const [runId, entry] of subagentRuns.entries()) {
			...
			if (!entry.archiveAtMs) {
				if (typeof sessionRetentionMs === "number" && typeof entry.cleanupCompletedAt === "number" && now - entry.cleanupCompletedAt > sessionRetentionMs) {
