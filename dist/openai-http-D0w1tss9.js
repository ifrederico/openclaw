...
import { i as hasNonzeroUsage, o as normalizeUsage, s as toOpenAiChatCompletionsUsage } from "./usage-BuLR-O0A.js";
import { a as extractImageContentFromSource, n as DEFAULT_INPUT_IMAGE_MIMES, o as normalizeMimeList, r as DEFAULT_INPUT_TIMEOUT_MS, t as DEFAULT_INPUT_IMAGE_MAX_BYTES } from "./input-files-VGDL8p1G.js";
...
import { a as getHeader, l as resolveOpenAiCompatibleHttpOperatorScopes, u as resolveOpenAiCompatibleHttpSenderIsOwner } from "./http-auth-utils-stNI7HTF.js";
import { a as resolveGatewayRequestContext, o as resolveOpenAiCompatModelOverride } from "./http-utils-3xCgv22F.js";
...
async function handleOpenAiHttpRequest(req, res, opts) {
	...
	const runId = getHeader(req, "x-request-id")?.trim() || `chatcmpl_${randomUUID()}`;
