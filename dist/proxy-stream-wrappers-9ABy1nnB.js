...
import { i as resolveProviderRequestPolicy } from "./provider-attribution-DaSNL9Cf.js";
import { l as resolveProviderRequestPolicyConfig } from "./provider-request-config-Bfgay7t4.js";
import { C as resolveOpenAIReasoningEffortForModel, a as applyOpenAIResponsesPayloadPolicy, i as createOpenAIResponsesTransportStreamFn, o as resolveOpenAIResponsesPayloadPolicy, s as flattenCompletionMessagesToStringContent } from "./openai-transport-stream-BkI6rJ3U.js";
import { t as log } from "./logger-DTkbPI2k.js";
import { t as applyAnthropicEphemeralCacheControlMarkers } from "./anthropic-payload-policy-BzdBko0b.js";
import { g as streamWithPayloadPatch } from "./provider-model-shared-DMDlhIax.js";
import { a as resolveCodexNativeSearchActivation, i as patchCodexNativeWebSearchPayload } from "./codex-native-web-search-core-CIRHQy6o.js";
import { O as isAnthropicModelRef } from "./provider-stream-shared-BUAWmRcw.js";
...
function createOpenAITextVerbosityWrapper(baseStreamFn, verbosity) {
	...
	return (model, context, options) => {
		...
		const shouldOverrideExistingVerbosity = model.api === "openai-codex-responses" || resolvedVerbosity !== verbosity;
		const originalOnPayload = options?.onPayload;
		return underlying(model, context, {
			...options,
			onPayload: (payload) => {
