...
import { X as resolveOwnerDisplaySetting, i as getRuntimeConfig } from "./io-E69J4lLI.js";
import "./defaults-Cbe87E7A.js";
import "./config-Dq84uU6c.js";
import { u as normalizeMessageChannel } from "./message-channel-B1O_CztY.js";
import { i as ensureGlobalUndiciStreamTimeouts, r as ensureGlobalUndiciEnvProxyDispatcher, t as DEFAULT_UNDICI_STREAM_TIMEOUT_MS } from "./undici-global-dispatcher-Bb3wFVad.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-DyAc2t0f.js";
import { i as createStreamIteratorWrapper, r as wrapStreamFnTextTransforms } from "./plugin-text-transforms-B2rjO5xY.js";
import { t as resolveAgentRuntimePolicy } from "./agent-runtime-policy-COQbqCOp.js";
import { C as listRegisteredAgentHarnesses } from "./loader-B-GXgDrk.js";
import { O as listRegisteredPluginAgentPromptGuidance } from "./types-CdFhLeaX.js";
import { c as fireAndForgetBoundedHook, t as getGlobalHookRunner } from "./hook-runner-global-CCAcWVdN.js";
import { a as getActivePluginRegistry, u as listImportedRuntimePluginIds } from "./runtime-B0MMVyKh.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-CSgsEl_z.js";
import { c as resolveAssistantMessagePhase, o as parseAssistantTextSignature } from "./chat-message-content-DY2n5MJD.js";
import { c as resolveSessionWriteLockAcquireTimeoutMs, r as acquireSessionWriteLock, s as resolveSessionLockMaxHoldFromTimeout } from "./session-write-lock-DCnT4uf1.js";
import { F as resolveProviderTextTransforms, K as transformProviderSystemPrompt, P as resolveProviderSystemPromptContribution } from "./provider-runtime-Cl9AEOGH.js";
...
import { f as setActiveEmbeddedRun, p as updateActiveEmbeddedRunSnapshot, r as clearActiveEmbeddedRun } from "./runs-7EMiaNjW.js";
import { t as resolveAgentTimeoutMs } from "./timeout-XT_E4tFL.js";
import { l as stripHistoricalRuntimeContextCustomMessages } from "./internal-runtime-context-BJV0cFbB.js";
import { n as extractTextFromChatContent, t as coerceChatContentText } from "./chat-content-DT1PmzwJ.js";
import { a as stripDowngradedToolCallText, l as hasOrphanReasoningCloseBoundary } from "./assistant-visible-text-DWECa3ch.js";
import { f as stableStringify$1, h as parseExecApprovalResultText } from "./sanitize-user-facing-text-DuH1jYXX.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-Z16zBgUU.js";
import { b as stripProviderPrefix, s as resolveToolLoopDetectionConfig, x as isEmbeddedMode, y as isStrictAgenticSupportedProviderModel } from "./openclaw-tools-0ftkmYS3.js";
import { t as isCliRuntimeAlias } from "./model-runtime-aliases-CN0ccyIq.js";
import { n as resolveEmbeddedAgentRuntime, t as normalizeEmbeddedAgentRuntime } from "./runtime-D6wsMYRa.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-CmpKr0jO.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, r as isSilentReplyPayloadText, s as stripLeadingSilentToken } from "./tokens-CFhtbDek.js";
import { t as filterHeartbeatPairs } from "./heartbeat-filter-HW__-ohD.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-DONq87p3.js";
import { t as getMachineDisplayName } from "./machine-name-hkbhQ6uE.js";
import { m as MAX_IMAGE_BYTES } from "./mime-DOdi-EcR.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-6lUlFKFN.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-DaSNL9Cf.js";
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-CVyieb3F.js";
import { i as normalizeToolName, n as expandToolGroups } from "./tool-policy-shared-Ce8ZI4la.js";
import { c as expandPolicyWithPluginGroups, i as buildPluginToolGroups } from "./tool-policy-BIonMcm-.js";
import { i as getPluginToolMeta } from "./tools-CIiGJzcD.js";
import { n as redactConfigObject } from "./redact-snapshot-BS55lNZ2.js";
import { n as resolveCommitHash } from "./git-commit-DKLCWlAe.js";
import { t as resolveOsSummary } from "./os-summary-Bt06furI.js";
import { a as sanitizeSupportSnapshotValue, t as redactPathForSupport } from "./diagnostic-support-redaction-CKQ4ywb2.js";
import { n as sanitizeDiagnosticPayload, t as safeJsonStringify } from "./safe-json-PPRGpEmH.js";
import { n as toTrajectoryToolDefinitions, r as getQueuedFileWriter, t as createTrajectoryRuntimeRecorder } from "./runtime-Bv2dds36.js";
import { t as parseBooleanValue } from "./boolean-BaPPAuWU.js";
import { n as buildTtsSystemPromptHint } from "./tts-runtime-Btvk-HT-.js";
import "./tts-B4VxOis2.js";
import { t as isReasoningTagProvider } from "./provider-utils-ATctBs_q.js";
import { a as buildBootstrapPromptWarningNotice, i as buildBootstrapPromptWarning, o as buildBootstrapTruncationReportMeta, r as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-Czlzs1mB.js";
import { d as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-Caf7L7oC.js";
import { c as resolveHeartbeatPromptForSystemPrompt, i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DsxWWYvi.js";
...
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-C4CPXsLY.js";
import { a as formatAssistantErrorText, l as isCloudCodeAssistFormatError, t as classifyFailoverReason } from "./errors-BqFqz2qx.js";
import { o as hasUnredactedSessionsSpawnAttachments, r as sanitizeToolCallIdsForCloudCodeAssist, t as extractToolCallsFromAssistant } from "./tool-call-id-bwK9vRSQ.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-DC32BHLQ.js";
import { g as resolveChannelReactionGuidance, m as resolveChannelMessageToolHints, p as listChannelSupportedActions } from "./pi-tools.before-tool-call-D0Kb8Xtm.js";
import { i as resolveOpenClawReferencePaths } from "./docs-path-BWTx5yRn.js";
import { a as isTimeoutError } from "./failover-error-BCSVecGt.js";
import { t as buildModelAliasLines } from "./model-alias-lines-BITHM3yr.js";
import { t as sanitizeForConsole } from "./console-sanitize-DW1DgTZe.js";
import { u as resolveModelAuthMode } from "./model-auth-CunBH4hV.js";
import { n as resolveTranscriptPolicy, o as supportsModelTools, r as shouldAllowProviderOwnedThinkingReplay } from "./tool-result-middleware-e9V2iK5s.js";
import { g as sanitizeTransportPayloadText, p as mergeTransportHeaders, v as buildGuardedModelFetch } from "./openai-transport-stream-BkI6rJ3U.js";
import { t as log$4 } from "./logger-DTkbPI2k.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-B8XZXxCi.js";
import { B as collectRuntimeChannelCapabilities, C as sanitizeSessionHistory, D as limitHistoryTurns, E as getHistoryLimitFromSessionKey, F as resolveCompactionTimeoutMs, G as releaseWsSession, H as dropReasoningFromHistory, I as isCacheTtlEligibleProvider, K as buildStreamErrorAssistantMessage, L as readLastCacheTtlTimestamp, O as buildEmbeddedExtensionFactories, R as guardSessionManager, S as normalizeAssistantReplayContent, T as buildEmbeddedMessageActionDiscoveryInput, U as dropThinkingBlocks, V as assessLastAssistantMessage, W as isZeroUsageEmptyStopAssistantTurn, _ as resolveEmbeddedAgentBaseStreamFn, a as flushPendingToolResultsAfterIdle, b as prewarmSessionFile, c as PI_RESERVED_TOOL_NAMES, d as toSessionToolAllowlist, f as applySystemPromptOverrideToSession, g as resolveEmbeddedAgentApiKey, h as describeEmbeddedAgentStreamStrategy, l as collectAllowedToolNames, m as createSystemPromptOverride, o as mapThinkingLevel, p as buildEmbeddedSystemPrompt, r as shouldRotateCompactionTranscript, s as splitSdkTools, t as rotateTranscriptAfterCompaction, u as collectRegisteredToolNames, v as resolveEmbeddedAgentStreamFn, w as validateReplayTurns, x as trackSessionManagerAccess, y as resolveEmbeddedRunSkillEntries, z as repairSessionFileIfNeeded } from "./compaction-successor-transcript-wqwbZ6Ul.js";
import { a as makeZeroUsageSnapshot, i as hasNonzeroUsage, o as normalizeUsage } from "./usage-BuLR-O0A.js";
import { g as streamWithPayloadPatch } from "./provider-model-shared-DMDlhIax.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-DMsivGkx.js";
import { t as registerProviderStreamForModel } from "./provider-stream-CdoVdz4F.js";
import { t as createBundleLspToolRuntime } from "./pi-bundle-lsp-runtime-BdBibzLw.js";
import { o as getOrCreateSessionMcpRuntime } from "./pi-bundle-mcp-runtime-CIPs13HF.js";
import { n as materializeBundleMcpToolsForRun } from "./pi-bundle-mcp-materialize-C94DY4UJ.js";
import "./pi-bundle-mcp-tools-DcT-9yA9.js";
import { o as normalizeHeartbeatToolResponse } from "./heartbeat-tool-response-Cq6IFZui.js";
import { S as isMessagingToolSendAction, _ as isToolResultError, b as sanitizeToolResult, d as runAgentCleanupStep, f as extractMessagingToolSend, g as filterToolResultMediaUrls, h as extractToolResultText, l as logAgentRuntimeToolDiagnostics, m as extractToolResultMediaArtifact, n as assembleHarnessContextEngine, o as finalizeHarnessContextEngineTurn, p as extractToolErrorMessage, r as bootstrapHarnessContextEngine, t as buildEmbeddedAttemptToolRunContext, u as normalizeAgentRuntimeTools, v as isToolResultTimedOut, x as isMessagingTool, y as sanitizeToolArgs } from "./attempt.tool-run-context-DWgSdeV1.js";
import { r as parseFenceSpans } from "./fences-BUtkNeTa.js";
import { t as parseInlineDirectives } from "./directive-tags-Cpt-7mIp.js";
import { r as splitMediaFromOutput } from "./parse-BMGw6R5F.js";
import { t as collectTextContentBlocks } from "./content-blocks-68IZV7Mg.js";
...
import { i as isSameToolMutationAction, n as isLikelyMutatingToolName, t as buildToolMutationState } from "./tool-mutation-3MDRu0z2.js";
import { i as setReplyPayloadMetadata } from "./reply-payload-CK0pmGzM.js";
import { d as parseReplyDirectives } from "./deliver-ByxJCZw_.js";
import { t as formatToolAggregate } from "./tool-meta-Dko5Q20H.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-B4G7Ez5P.js";
import { n as hasCommittedMessagingToolDeliveryEvidence, r as hasMessagingToolDeliveryEvidence } from "./delivery-evidence-CGssF8iH.js";
import { o as buildApiErrorObservationFields, s as buildTextObservationFields } from "./model-fallback-DIXhOaxb.js";
import { g as createPreparedEmbeddedPiSettingsManager, h as formatContextLimitTruncationNotice, p as truncateOversizedToolResultsInSessionManager, u as resolveLiveToolResultMaxChars } from "./compaction-BxhK_yKO.js";
import { i as isSilentOverflowProneModel, n as applyPiAutoCompactionGuard, r as applyPiCompactionSettingsFromConfig } from "./pi-settings-DjLBMmOQ.js";
import { i as diagnosticProviderRequestIdHash, n as diagnosticErrorFailureKind, t as diagnosticErrorCategory } from "./diagnostic-error-metadata-_IqRobKa.js";
import { i as toClientToolDefinitions, n as findClientToolNameConflicts, t as createClientToolNameConflictError } from "./pi-tool-definition-adapter-B1yqvP_o.js";
import { t as createOpenClawCodingTools } from "./pi-tools-DepR0oGW.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-BsidlL7H.js";
import { i as resolveSubagentCapabilityStore, t as isSubagentEnvelopeSession } from "./subagent-capabilities-jxy1otsc.js";
import { i as resolveSubagentToolPolicyForSession, n as resolveEffectiveToolPolicy, r as resolveGroupToolPolicy } from "./pi-tools.policy-D0sdiUGK.js";
import { o as resolveSandboxContext } from "./sandbox-3jZ6YsoT.js";
import { t as detectRuntimeShell } from "./shell-utils-DHuiaGSw.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-BvowvPTk.js";
import { s as resolveSkillsPromptForRun } from "./workspace-B4eaH2KK.js";
import "./skills-Z6LDXFJX.js";
import { t as resolveSystemPromptOverride } from "./system-prompt-override-DgzMAQkr.js";
import { t as buildSystemPromptParams } from "./system-prompt-params-B7yqo2EO.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-DN9b6eRr.js";
import "./tool-loop-detection-DzUPSHZn.js";
import { T as visitObjectContentBlocks, o as createHtmlEntityToolCallArgumentDecodingWrapper } from "./provider-stream-shared-BUAWmRcw.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-nvDof5py.js";
import { t as runContextEngineMaintenance } from "./context-engine-maintenance-BQCJ9GdU.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-DQTaoezb.js";
import { t as appendAgentBootstrapSystemPromptSupplement } from "./system-prompt-BIKbdIsV.js";
import { t as parseGeminiAuth } from "./gemini-auth-Bl6u9b7Y.js";
import { n as normalizeGoogleApiBaseUrl } from "./google-api-base-url-eMLRSy7s.js";
import { t as buildEmbeddedSandboxInfo } from "./sandbox-info-DnPNtpdy.js";
import { n as shouldPreemptivelyCompactBeforePrompt, t as PREEMPTIVE_OVERFLOW_ERROR_TEXT } from "./preemptive-compaction-Di9PZNgn.js";
...
import { t as resolveBootstrapMode } from "./bootstrap-mode-CXCdG1JF.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, o as shouldUseOpenAIWebSocketTransportForAttempt, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-x9cF2syS.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-CiEy545G.js";
import { t as detectAndLoadPromptImages } from "./images-BeCCsXT0.js";
import { a as resolveRuntimeContextPromptParts, i as queueRuntimeContextForNextTurn, t as buildCurrentTurnPromptContextSuffix } from "./runtime-context-prompt-E3igHVA3.js";
...
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-C_Uc5QjJ.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./hook-runner-global-BMiiOjOf.js"));
const mediaParseModuleLoader = createLazyImportLoader(() => import("./parse-BRcw0dJG.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./pi-tools.before-tool-call-B6k6J-IH.js"));
...
function limitLiveCommandOutput(output) {
	if (output.length <= LIVE_COMMAND_OUTPUT_MAX_CHARS) return output;
	const tail = truncateUtf16Safe(output.slice(-LIVE_COMMAND_OUTPUT_MAX_CHARS), LIVE_COMMAND_OUTPUT_MAX_CHARS);
	return `[openclaw: live command output truncated to last ${tail.length} of ${output.length} chars]\n${tail}`;
}
function limitExecToolResultForLiveEvent(result) {
	const details = readToolResultDetailsRecord(result);
	if (!details || typeof details.aggregated !== "string") return result;
	return {
		...result,
		details: {
			...details,
...
function handleToolExecutionUpdate(ctx, evt) {
	...
	const liveEventPartial = isExecToolName(toolName) ? limitExecToolResultForLiveEvent(sanitized) : sanitized;
	emitAgentEvent({
		runId: ctx.params.runId,
		stream: "tool",
		data: {
...
function installContextEngineLoopHook(params) {
	...
	mutableAgent.transformContext = (async (messages, signal) => {
		...
		if (lastAssembledFromSourceLength !== null && sourceMessages.length < lastAssembledFromSourceLength) {
			clearAssembledCache();
			lastSeenLength = null;
		}
