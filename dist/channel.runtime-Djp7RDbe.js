...
import "./accounts-DJaFY3ou.js";
import "./runtime-api-B1J11HiR.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CfDHU2MR.js";
import { t as sendMessageZalo } from "./send-BwgeChEw.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-Bq9HVDPY.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-DdNhzYnj.js");
