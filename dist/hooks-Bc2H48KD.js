	...
	const dispatchAgentHook = (value) => {
		...
		(async () => {
			try {
				...
				const { runCronIsolatedAgentTurn } = await import("./isolated-agent-BW6q06vT.js");
