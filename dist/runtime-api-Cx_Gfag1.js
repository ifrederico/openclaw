...
import { A as resolveBrowserConfig, B as DEFAULT_UPLOAD_DIR, K as normalizeBrowserFormField, M as DEFAULT_AI_SNAPSHOT_MAX_CHARS, V as resolveExistingPathsWithinRoot, W as getBrowserProfileCapabilities, f as redactCdpUrl, g as createBrowserControlContext, h as createBrowserRouteDispatcher, j as resolveProfile, q as normalizeBrowserFormFieldValue, v as startBrowserControlServiceFromConfig } from "./routes--v47AKgQ.js";
import { C as browserConsoleMessages, D as browserArmFileChooser, E as browserArmDialog, O as browserNavigate, S as browserTabs, T as browserAct, _ as browserSnapshot, b as browserStop, c as persistBrowserProxyFiles, h as browserProfiles, i as isPersistentBrowserProfileMutation, k as browserScreenshotAction, m as browserOpenTab, n as trackSessionBrowserTab, o as resolveRequestedBrowserProfile, p as browserFocusTab, r as untrackSessionBrowserTab, s as applyBrowserProxyPaths, u as browserCloseTab, v as browserStart, w as browserPdfSave, y as browserStatus } from "./core-api-CLWp9HNQ.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BAYBVqob.js"),
