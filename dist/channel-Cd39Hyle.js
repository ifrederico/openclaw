...
import { Zx as createAllowlistProviderOpenWarningCollector, _x as createScopedDmSecurityResolver, cx as stripTargetKindPrefix, dx as adaptScopedAccountAccessor, hx as createScopedChannelConfigAdapter, iS as projectAccountConfigWarningCollector, ix as createChatChannelPlugin, nx as buildChannelOutboundSessionRoute, sx as stripChannelTargetPrefix } from "./pi-embedded-DhFkhMap.js";
...
import { r as buildTrafficStatusSummary } from "./extension-shared-YEd0rhVx.js";
import { a as getMatrixRuntime } from "./credentials-read-Dq0zwNHp.js";
import { A as normalizeMatrixMessagingTarget, I as resolveDefaultMatrixAccountId, L as resolveMatrixAccount, M as resolveMatrixDirectUserId, N as resolveMatrixTargetIdentity, P as listMatrixAccountIds, R as resolveMatrixAccountConfig, j as normalizeMatrixResolvableTarget } from "./send-WKZDIB9i.js";
import { i as resolveMatrixRoomConfig, n as normalizeMatrixUserId, t as normalizeMatrixAllowList } from "./allowlist-CLH180zZ.js";
import { n as matrixSetupAdapter } from "./setup-core-X4L1squC.js";
import { z } from "zod";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-DreG9z0O.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-9BsbDAN1.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-DNPB3snt.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
