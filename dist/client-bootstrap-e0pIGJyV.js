...
import { t as getActiveMatrixClient } from "./active-client-B6kYsiC_.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-DlSopc3A.js"), import("./shared-BrHTx6uW.js")]).then(([clientModule, sharedModule]) => ({
