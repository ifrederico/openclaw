import { n as CLIENT_ID_KEYS, r as CLIENT_SECRET_KEYS } from "./oauth.shared-DPB5k0YY.js";
...
function resolveGeminiCliDirs(geminiPath, resolvedPath) {
	...
	for (const candidate of candidates) for (const searchDir of resolveGeminiCliSearchDirs(candidate)) {
		const key = process.platform === "win32" ? searchDir.replace(/\\/g, "/").toLowerCase() : searchDir;
