import { Do as defaultRuntime, Ja as shortenHomePath, O as loadConfig, bi as resolveDefaultAgentId, yi as resolveAgentWorkspaceDir } from "./env-D1ktUnAV.js";
import "./paths-CjuwkA2v.js";
import { i as stripAnsi, n as sanitizeForLog } from "./safe-text-K2Nonoo3.js";
...
import "./install-package-dir-ut2UTA5H.js";
import { i as updateSkillsFromClawHub, n as readTrackedClawHubSkillSlugs, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-CyUL1fFN.js";
...
function formatSkillInfo(report, skillName, opts) {
	...
	if (skill.primaryEnv && skill.missing.env.includes(skill.primaryEnv)) {
		...
		lines.push(`  Stored in: ${theme.muted("~/.openclaw/openclaw.json")} ${theme.muted(`(skills.entries.${safeSkillKey}.apiKey)`)}`);
	}
	return appendClawHubHint(lines.join("\n"), opts.json);
}
...
async function loadSkillsStatusReport() {
	...
	const { buildWorkspaceSkillStatus } = await import("./skills-status-BzY6hDst.js");
