...
import { t as require_content_type } from "./content-type-DLtWwJKG.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-Chph-UO4.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-CAjADi0p.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-Chh3cbzw.js";
import { l as toRatio, n as decodeString } from "./Util-DRT067t_.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-bM5fqNuF.js";
import { a as textDecode, t as APEv2Parser } from "./APEv2Parser-D1v6PYhJ.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BrHnk83u.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-QHSLHmRh.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-D3SF7LIn.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-B9vy8YLP.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-BFlJzj7v.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BRJTzzrY.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-XMXR4FD0.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-2HzycX-Q.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-BtZDMHSV.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DTayV9iN.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-BXlzNyo8.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DL696eCJ.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-jhIEavbx.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-Cw8945QN.js")).WaveParser;
	}
};
//#endregion
