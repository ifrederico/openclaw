...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef } from "./types.secrets-CL51SR4g.js";
...
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-DKn-49wv.js";
import { u as readConfigFileSnapshot } from "./io-E69J4lLI.js";
...
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CqvmGn3G.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-Dri-j3D6.js";
import { t as runSetupWizard } from "./setup-DjGgaM15.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-SXa8gVPr.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-Cq5Chr72.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-GVFOXNuw.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DlrinADT.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install--bDk4goG.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-DknD5Azp.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-C8nyQar1.js");
