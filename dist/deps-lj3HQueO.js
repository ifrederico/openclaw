...
function createDefaultDeps() {
	return {
		whatsapp: createLazySender("whatsapp", () => import("./whatsapp-iqcqpo12.js")),
		telegram: createLazySender("telegram", () => import("./telegram-DcxRH3Rb.js")),
		discord: createLazySender("discord", () => import("./discord-Ca8l3ZhG.js")),
		slack: createLazySender("slack", () => import("./slack-BRrabEXw.js")),
		signal: createLazySender("signal", () => import("./signal-B1o0I7pI.js")),
		imessage: createLazySender("imessage", () => import("./imessage-DO1voj8f.js"))
	};
}
