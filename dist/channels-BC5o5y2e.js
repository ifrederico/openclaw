...
import { r as listChannelPluginCatalogEntries } from "./catalog-DV5E77c-.js";
import { t as createClackPrompter } from "./clack-prompter-Ceg-xWSS.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-y_n45ZDV.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-BzNtFRlz.js";
import { t as parseLogLine } from "./parse-log-line-DEdIDeBc.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-CB5YHmT1.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-lRvpVufN.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-TIdgDbDV.js"), import("./onboard-channels-DOTuoE8Q.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-BksgRi0f.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-BksgRi0f.js");
			const prompter = createClackPrompter();
