...
import { s as loadAuthProfileStoreForRuntime } from "./store-CSOk8Bno.js";
import { n as resolvePluginProviders } from "./providers.runtime-hb-uzyUP.js";
import "./model-selection-shared-DOxyWoaQ.js";
...
import { a as upsertAuthProfile, n as promoteAuthProfileInOrder } from "./profiles-CjRHFJUw.js";
import { n as clearAuthProfileCooldown } from "./usage-CQen01xn.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-Cpj6Wq9M.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-CvYCN4Y4.js";
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-D2u5vo_J.js";
import { t as createClackPrompter } from "./clack-prompter-D63QTXRW.js";
import { n as logConfigUpdated } from "./logging-didorrhm.js";
import { a as loadValidConfigOrThrow, s as resolveKnownAgentId, u as updateConfig } from "./shared-yc3l08J1.js";
import { i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-DTbvAZVV.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-Bv84cPG1.js";
import { t as isRemoteEnvironment } from "./remote-env-DVBlmEjW.js";
...
async function runProviderAuthMethod(params) {
	...
	await persistProviderAuthResult({
		result: await params.method.run({
			...
			openUrl: async (url) => {
				const { openUrl } = await import("./onboard-helpers-pdUi8aoB.js");
				await openUrl(url);
			},
