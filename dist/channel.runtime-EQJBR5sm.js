...
import "./accounts-DiE3O-6K.js";
import "./runtime-api-Buzl77c6.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-BQKpeNC_.js";
import { t as sendMessageZalo } from "./send-_xKqxj2g.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-THwBDKY0.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-ZrdSQYi7.js");
