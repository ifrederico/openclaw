...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-pSg7t2-J.js";
...
import { n as openUrl } from "./browser-open-V43j6BYk.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DPcESGUS.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-BSkUyILa.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-DTbvAZVV.js";
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-DgNtxyvJ.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-EcexL9RF.js");
