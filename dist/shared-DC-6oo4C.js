...
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-BsdarDlT.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-BPcknnAL.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-CiqPUZs0.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
