...
import { _ as recoverConfigFromLastKnownGood, g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-E69J4lLI.js";
import { n as formatConfigIssueLines } from "./issue-format-CEIVxsoT.js";
import { t as note } from "./note-LfE3_jlk.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-j2K-IhiK.js";
import { t as findDoctorLegacyConfigIssues } from "./legacy-config-issues-D_HBCxGx.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BmabFl98.js");
