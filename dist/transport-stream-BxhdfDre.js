...
import { _ as transformTransportMessages, c as coerceTransportToolCallArguments, d as failTransportStream, f as finalizeTransportStream, g as sanitizeTransportPayloadText, l as createEmptyTransportUsage, p as mergeTransportHeaders, u as createWritableTransportEventStream, v as buildGuardedModelFetch } from "./openai-transport-stream-BkI6rJ3U.js";
import { i as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-B8XZXxCi.js";
import { a as createProviderHttpError } from "./provider-http-errors-D1NPNIxO.js";
import { d as isGoogleGemini3FlashModel, f as isGoogleGemini3ProModel, g as resolveGoogleGemini3ThinkingLevel, u as isGoogleGemini25ThinkingBudgetModel, v as stripInvalidGoogleThinkingBudget } from "./provider-stream-shared-BUAWmRcw.js";
import "./text-runtime-BMYQWTAu.js";
import "./provider-http-BnwhGORS.js";
import "./provider-transport-runtime-DItd11Pi.js";
import "./thinking-api-CHQulUlg.js";
import { r as normalizeGoogleApiBaseUrl } from "./provider-policy-CQ0zuFb8.js";
import { t as parseGeminiAuth } from "./gemini-auth-DV58h96Y.js";
import { i as resolveGoogleVertexAuthorizedUserHeaders, n as isGoogleVertexCredentialsMarker } from "./vertex-adc-jMwbDmav.js";
...
function convertGoogleMessages(model, context) {
	const contents = [];
	const transformedMessages = transformTransportMessages(context.messages, model, (id) => requiresToolCallId(model.id) ? normalizeToolCallId(id) : id, { preserveCrossModelToolCallThoughtSignature: requiresToolCallThoughtSignature(model.id) });
		...
		if (msg.role === "assistant") {
			...
			for (const block of msg.content) {
				...
				if (block.type === "toolCall") {
					const thoughtSignature = (isSameProviderAndModel ? block.thoughtSignature : void 0) ?? (requiresToolCallThoughtSignature(model.id) ? GEMINI_THOUGHT_SIGNATURE_VALIDATOR_SKIP : void 0);
					parts.push({
						functionCall: {
							name: block.name,
