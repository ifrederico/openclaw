...
import { n as resolveMatrixAuth } from "./config-T3IZ6LWB.js";
import "./client-W3ob5qxk.js";
import { n as listMatrixDirectoryGroupsLive, r as listMatrixDirectoryPeersLive, t as resolveMatrixTargets } from "./resolve-targets-DLMQm0DA.js";
import { a as sendMessageMatrix, o as sendPollMatrix } from "./send-cNX1QgA2.js";
//#region extensions/matrix/src/matrix/probe.ts
let matrixProbeRuntimeDepsPromise;
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./probe.runtime-BM79hMC4.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient }));
