...
import { n as extractToolResultId, t as extractToolCallsFromAssistant } from "./tool-call-id-bwK9vRSQ.js";
import { a as isTimeoutError } from "./failover-error-BCSVecGt.js";
import { t as log$2 } from "./logger-DTkbPI2k.js";
import { a as stripToolResultDetails, n as repairToolUseResultPairing } from "./session-transcript-repair-DMsivGkx.js";
import { t as loadEmbeddedPiMcpConfig } from "./embedded-pi-mcp-CtXIs-BX.js";
import { r as applyPiCompactionSettingsFromConfig } from "./pi-settings-DjLBMmOQ.js";
import { c as readTranscriptFileState, n as rewriteTranscriptEntriesInSessionManager, r as rewriteTranscriptEntriesInState, s as persistTranscriptStateMutation } from "./transcript-rewrite-C3Y3tv6r.js";
...
async function summarizeChunks(params) {
	...
	const modelMaxTokens = params.model.maxTokens ?? 128e3;
	const clampedReserveTokens = Math.min(params.reserveTokens, Math.floor(modelMaxTokens / .8));
	for (const chunk of chunks) summary = await retryAsync(() => generateSummary$1(chunk, params.model, clampedReserveTokens, params.apiKey, params.headers, params.signal, effectiveInstructions, summary), {
		attempts: 3,
		minDelayMs: 500,
		maxDelayMs: 5e3,
		jitter: .2,
