...
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-Dri-j3D6.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-DgNtxyvJ.js");
