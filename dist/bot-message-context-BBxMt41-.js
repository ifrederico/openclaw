...
import { i as resolveConfiguredBindingRoute } from "./conversation-runtime-C9Z1papx.js";
...
async function resolveStickerVisionSupport(params) {
	try {
		const { resolveStickerVisionSupportRuntime } = await import("./sticker-vision.runtime-DR0TM-r3.js");
...
async function resolveTelegramInboundBody(params) {
	...
	if (isGroup && requireMention && hasAudio && !hasUserText && mentionRegexes.length > 0 && !disableAudioPreflight && senderAllowedForAudioPreflight) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-DdxzgE8F.js");
...
async function buildTelegramInboundContextPayload(params) {
	...
	const sessionRuntime = await import("./bot-message-context.session.runtime-ZuW9QEwD.js");
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-BNuV6gvp.js");
