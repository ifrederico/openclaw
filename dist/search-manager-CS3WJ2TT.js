import { Ga as resolveUserPath, lr as splitShellArgs, o as createSubsystemLogger, yi as resolveAgentWorkspaceDir } from "./env-D1ktUnAV.js";
...
function loadManagerRuntime() {
	managerRuntimePromise ??= import("./manager-runtime-CtExycEB.js");
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-CdVu0x02.js");
