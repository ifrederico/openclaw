...
import { $ as resolveProviderRuntimePlugin, p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-Cl9AEOGH.js";
import "./model-selection-u8IQheQP.js";
import { d as isGoogleModelApi, u as isGemma4ModelRequiringReasoningStrip } from "./pi-embedded-helpers-Bk-yxMCZ.js";
import { t as log$1 } from "./logger-DTkbPI2k.js";
import { k as shouldPreserveThinkingBlocks } from "./provider-model-shared-DMDlhIax.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-BJ1TXfIb.js");
