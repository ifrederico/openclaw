...
import { Wb as formatAllowFromLowercase, Xx as createAllowlistProviderGroupPolicyWarningCollector, dx as adaptScopedAccountAccessor, fx as createHybridChannelConfigAdapter, ix as createChatChannelPlugin, nx as buildChannelOutboundSessionRoute, oS as projectConfigAccountIdWarningCollector, sx as stripChannelTargetPrefix } from "./pi-embedded-DhFkhMap.js";
...
import { d as listFeishuAccountIds, f as resolveDefaultFeishuAccountId, h as feishuSetupAdapter, i as createFeishuClient, l as inspectFeishuCredentials, m as resolveFeishuRuntimeAccount, p as resolveFeishuAccount, t as feishuSetupWizard, u as listEnabledFeishuAccounts } from "./setup-surface-C1l40ZK6.js";
import { a as parseFeishuConversationId } from "./api-BYeJbbdV.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-BSYZzZCC.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-DV1GplLY.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-0MeMqwQI.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-yNQHmYqd.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-BDJYOKOa.js");
