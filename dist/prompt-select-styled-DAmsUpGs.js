import { Cn as isTrustedSafeBinPath, Cr as resolveTelegramPreviewStreamMode, Dn as listRiskyConfiguredSafeBins, Do as defaultRuntime, Ei as DEFAULT_AGENTS_FILENAME, Ga as resolveUserPath, Gi as runExec, Hr as getModelRefStatus, Ja as shortenHomePath, L as writeConfigFile, M as readConfigFileSnapshot, Mr as DEFAULT_TALK_PROVIDER, Pr as normalizeTalkSection, Qr as resolveConfiguredModelRef, Sn as getTrustedSafeBinDirs, Sr as resolveSlackStreamingMode, Tn as normalizeTrustedSafeBinDirs, Un as resolveCommandResolutionFromArgv, Wi as runCommandWithTimeout, Ya as sleep, _r as formatSlackStreamModeMigrationMessage, b as parseToolsBySenderTypedKey, bi as resolveDefaultAgentId, br as resolveDiscordPreviewStreamMode, di as resolveAgentDir, ei as resolveHooksGmailModel, fo as getResolvedLoggerSettings, gt as migrateLegacyWebSearchConfig, in as normalizePluginId, jr as resolveNormalizedProviderModelMaxTokens, kt as loadPluginManifestRegistry, t as isTruthyEnvValue$1, vr as formatSlackStreamingBooleanMigrationMessage, x as migrateLegacyConfig, xr as resolveSlackNativeStreaming, yi as resolveAgentWorkspaceDir } from "./env-D1ktUnAV.js";
import { C as resolveRequiredHomeDir, _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-CjuwkA2v.js";
import { n as sanitizeForLog } from "./safe-text-K2Nonoo3.js";
import { E as parseAgentSessionKey, _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId } from "./session-key-CYZxn_Kd.js";
import { o as DEFAULT_MODEL, s as DEFAULT_PROVIDER } from "./configured-provider-fallback-C-XNRUP6.js";
import { r as normalizeProviderId } from "./provider-id-Dub5ZtOv.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-D8b76e4t.js";
import { S as resolveSecretInputRef, g as hasConfiguredSecretInput } from "./ref-contract-BFBhfQKU.js";
import { c as normalizeChatChannelId } from "./registry-bOiEdffE.js";
import "./paths-DJBuCoRE.js";
import { d as resolveProfileUnusableUntilForDisplay, h as repairOAuthProfileIdMismatch, m as resolveApiKeyForProfile } from "./auth-profiles-DLfrJtR9.js";
import { t as describeUnknownError } from "./shared-CasSxSN8.js";
import { c as ensureAuthProfileStore, m as updateAuthProfileStoreWithLock } from "./profiles-CRvutsjq.js";
import { t as formatCliCommand } from "./command-format-CCyUqeuM.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-CJXstBek.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-Du8UajUp.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-C-R4YM7j.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-_44dBgK9.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-DWYw6uyd.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-1LAzWzJc.js";
import { a as resolveGatewayAuth } from "./auth-BC0t_CEl.js";
import { d as readGatewayTokenEnv } from "./credentials-6hokf6e3.js";
import { i as resolveAgentSessionDirs, m as loadSessionStore } from "./sessions-uRDRs4f-.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-DofHqQRD.js";
import { c as listChannelPlugins } from "./plugins-h0t63KQW.js";
import { i as resolveMainSessionKey } from "./main-session-DF6UibWM.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BEHCHyAI.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-B7nwE7de.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-CFi2qbI2.js";
import { d as printWizardHeader, n as applyWizardMetadata, o as guardCancel, p as randomToken } from "./onboard-helpers-1d1tmKDF.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-BFfYpo4i.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-qxNRcnm3.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-ljiqPV9i.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-mdsdTkvr.js";
import { a as inspectPortUsage, c as formatPortDiagnostics } from "./ports-DF41F7NN.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-62-fJtxm.js";
...
import { t as readLastGatewayErrorLine } from "./diagnostics-D2oRumHm.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-DA9Iaje-.js";
import { $S as resolveBootstrapTotalMaxChars, $o as resolveBootstrapContextForRun, F as hasConfiguredMemorySecretInput, H as resolveApiKeyForProvider, Jh as resolveCommandSecretRefsViaGateway, Mh as resolveTelegramAccount, Oh as listTelegramAccountIds, QS as resolveBootstrapMaxChars, Th as inspectTelegramAccount, dC as loadModelCatalog, db as applyPluginAutoEnable, es as analyzeBootstrapBudget, gt as loadOpenClawPlugins, ht as resolvePluginProviders, ts as buildBootstrapInjectionStats, xh as lookupTelegramChatId } from "./pi-embedded-DhFkhMap.js";
import { t as resolveMemorySearchConfig } from "./memory-search-B5CuuJZB.js";
import { i as listRouteBindings } from "./bindings-CDSjsxVK.js";
import { a as formatSetExplicitDefaultToConfiguredInstruction, i as formatSetExplicitDefaultInstruction, r as formatChannelAccountsDefaultPath } from "./routing-DA_79T-X.js";
import { n as DEFAULT_GOOGLE_API_BASE_URL } from "./provider-google-BqSdiGDI.js";
import { D as resolveSandboxScope, U as DEFAULT_SANDBOX_IMAGE, V as DEFAULT_SANDBOX_BROWSER_IMAGE } from "./docker-BrzH-NvE.js";
import { l as shouldMoveSingleAccountChannelKey } from "./setup-helpers-CLiDrlXo.js";
import { a as readChannelAllowFromStore } from "./pairing-store-Ci8ZfuL6.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-3Jdbvvlm.js";
import { n as logConfigUpdated } from "./logging-B3tLYQAZ.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./config-runtime-BMqUsOKJ.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-B_yjeCXW.js";
import { a as listInterpreterLikeSafeBins, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-CAjjj6oR.js";
import { F as readBrowserVersion, I as resolveGoogleChromeExecutableForPlatform, P as parseBrowserMajorVersion, rt as resolveConfiguredSecretInputWithFallback } from "./client-fetch-BpnVLZgl.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CiFc3JN3.js";
import { n as normalizeTelegramAllowFromEntry, t as isNumericTelegramUserId } from "./allow-from-DiU9dMhv.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-CS3WJ2TT.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-HNaP_NJI.js";
import { r as buildPluginCompatibilityWarnings } from "./status-DqeSTTLa.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CrkmujzU.js";
import { t as note$1 } from "./note-ChRKyaEb.js";
import { r as healthCommand } from "./health-CaMkl62U.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-BNTuYBtE.js";
import { g as normalizeStoredCronJobs, n as runGatewayUpdate, t as runStartupMatrixMigration } from "./server-startup-matrix-migration-DqAbtBLp.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-BZUlhLV2.js";
import { n as runMatrixDoctorSequence, t as cleanStaleMatrixPluginConfig } from "./matrix-Cdf6B9z_.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-rMrPpET-.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BQO77WZ1.js";
import { t as formatHealthCheckFailure } from "./health-format-DWNkYk6-.js";
import { n as doctorShellCompletion } from "./doctor-completion-DIgIJi-u.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-BE1lzp8j.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-Co9eCtK8.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-mo6sB54J.js";
import { i as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./doctor-state-migrations-BrMe_wGv.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-C-Ne0u7U.js";
...
async function doctorCommand(runtime = defaultRuntime, options = {}) {
	...
	if (resolveMode(cfg) === "local" && sourceConfigValid) {
		...
		if (auth.mode !== "password" && (auth.mode !== "token" || !auth.token)) if (gatewayTokenRef) note$1([
			...
			if (options.generateGatewayToken === true ? true : options.nonInteractive === true ? false : await prompter.confirmAutoFix({
