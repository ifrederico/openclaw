...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BpCAHD29.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-BpCAHD29.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-BpCAHD29.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
