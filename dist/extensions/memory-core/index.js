...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-TKZ_y5mC.js";
import { i as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-BiSZz_p3.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-B3jFTrn6.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-DtJTN3aR.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-CTTFGgxG.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-zr1MN3Vn.js");
				return await handleDreamingCommand(api, ctx);
			}
		});
		api.registerCli(async ({ program }) => {
			const { registerMemoryCli } = await import("../../cli-CoSi8J9J.js");
