...
import { a as createSetupInputPresenceValidator, l as patchScopedAccountConfig, u as prepareScopedSetupConfig } from "../../setup-helpers-BiAtGxsL.js";
...
import { S as projectAccountWarningCollector, v as createOpenGroupPolicyRestrictSendersWarningCollector } from "../../channel-policy-DIVRdPsQ.js";
import { a as createAllowFromSection, d as createPromptParsedAllowFromForAccount, f as createStandardChannelSetupStatus, t as addWildcardAllowFrom } from "../../setup-wizard-helpers-ecC16ic3.js";
...
import { d as createDefaultChannelRuntimeState, h as collectIssuesForEnabledAccounts, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "../../status-helpers-ChR3_7qO.js";
import { t as extractToolSend } from "../../tool-send-C8jvVBdQ.js";
import "../../setup-Dp8bIdbL.js";
import { a as isPrivateNetworkOptInEnabled, o as migrateLegacyFlatAllowPrivateNetworkAlias, r as hasLegacyFlatAllowPrivateNetworkAlias } from "../../ssrf-policy-Cb9w9jMO.js";
...
import "../../thread-bindings-runtime-BifBuaU4.js";
...
import { a as stripChannelTargetPrefix, n as createChatChannelPlugin, t as buildChannelOutboundSessionRoute } from "../../channel-core-BVR4R0_P.js";
import "../../channel-status-45SWZx-g.js";
import "../../secret-input-VDcIlz-s.js";
import { S as normalizeBlueBubblesServerUrl, _ as listBlueBubblesAccountIds, a as looksLikeBlueBubblesExplicitTargetId, c as normalizeBlueBubblesMessagingTarget, f as getCachedBlueBubblesPrivateApiStatus, h as isMacOS26OrHigher, i as isAllowedBlueBubblesSender, l as parseBlueBubblesAllowTarget, o as looksLikeBlueBubblesTargetId, r as inferBlueBubblesTargetChatType, s as normalizeBlueBubblesHandle, t as extractHandleFromChatGuid, u as parseBlueBubblesTarget, v as resolveBlueBubblesAccount, y as resolveDefaultBlueBubblesAccountId } from "../../targets-BanSXUay.js";
import { t as BlueBubblesChannelConfigSchema } from "../../config-schema-eijjJAKd.js";
import { a as resolveBlueBubblesConversationIdFromTarget, i as normalizeBlueBubblesAcpConversationId, o as resolveBlueBubblesInboundConversationId, r as matchBlueBubblesAcpConversation, t as DEFAULT_WEBHOOK_PATH } from "../../webhook-shared-BAXEqw06.js";
import { n as resolveBlueBubblesGroupToolPolicy, t as resolveBlueBubblesGroupRequireMention } from "../../group-policy-Crb3lyER.js";
...
const loadBlueBubblesActionsRuntime = createLazyRuntimeNamedExport(() => import("../../actions.runtime-Cvx-1tE7.js"), "blueBubblesActionsRuntime");
...
function hasLegacyAllowPrivateNetworkInAccounts(value) {
	const accounts = isRecord$1(value) ? value : null;
	return Boolean(accounts && Object.values(accounts).some((account) => hasLegacyFlatAllowPrivateNetworkAlias(isRecord$1(account) ? account : {})));
}
function normalizeBlueBubblesCompatibilityConfig(cfg) {
	const channels = isRecord$1(cfg.channels) ? cfg.channels : null;
	const bluebubbles = isRecord$1(channels?.bluebubbles) ? channels.bluebubbles : null;
	...
	const accounts = isRecord$1(updatedBluebubbles.accounts) ? updatedBluebubbles.accounts : null;
	if (accounts) {
		let accountsChanged = false;
		const nextAccounts = { ...accounts };
		for (const [accountId, accountValue] of Object.entries(accounts)) {
			const account = isRecord$1(accountValue) ? accountValue : null;
			if (!account) continue;
	...
	return {
		config: {
			...
			channels: {
				...cfg.channels,
				bluebubbles: updatedBluebubbles
			}
		},
		changes
	};
...
const bluebubblesDoctor = {
	legacyConfigRules: [{
		...
		message: "channels.bluebubbles.allowPrivateNetwork is legacy; use channels.bluebubbles.network.dangerouslyAllowPrivateNetwork instead. Run \"openclaw doctor --fix\".",
		match: (value) => hasLegacyFlatAllowPrivateNetworkAlias(isRecord$1(value) ? value : {})
	}, {
		path: [
			"channels",
			"bluebubbles",
		...
		message: "channels.bluebubbles.accounts.<id>.allowPrivateNetwork is legacy; use channels.bluebubbles.accounts.<id>.network.dangerouslyAllowPrivateNetwork instead. Run \"openclaw doctor --fix\".",
...
const loadBlueBubblesChannelRuntime = createLazyRuntimeNamedExport(() => import("../../channel.runtime-CuJfrAXs.js"), "blueBubblesChannelRuntime");
