...
import { _ as resolveRealtimeVoiceAgentConsultTools, b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, f as buildRealtimeVoiceAgentConsultWorkingResponse, g as resolveRealtimeVoiceAgentConsultToolPolicy, n as resolveConfiguredRealtimeVoiceProvider, t as createRealtimeVoiceBridgeSession, v as resolveRealtimeVoiceAgentConsultToolsAllow, y as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ } from "../../session-runtime-pKRTzlWC.js";
import { o as consultRealtimeVoiceAgent } from "../../realtime-voice-faqTPUPv.js";
import { a as fetchGoogleMeetSpace, i as fetchGoogleMeetAttendance, o as fetchLatestGoogleMeetConferenceRecord, r as fetchGoogleMeetArtifacts, t as buildGoogleMeetPreflightReport } from "../../meet-DTrZjq4w.js";
import { n as findGoogleMeetCalendarEvent, r as listGoogleMeetCalendarEvents, t as buildGoogleMeetCalendarDayWindow } from "../../calendar-CBpRubr3.js";
import { a as isSameMeetUrlForReuse, c as resolveChromeNode, i as callBrowserProxyOnNode, l as resolveChromeNodeInfo, n as isGoogleMeetBrowserManualActionError, o as normalizeMeetUrlForReuse, r as asBrowserTabs, s as readBrowserTab, t as createMeetWithBrowserProxyOnNode } from "../../chrome-create-CWYCVRyy.js";
...
function collectChromeAudioCommands(config) {
	const commands = config.chrome.audioBridgeCommand ? [config.chrome.audioBridgeCommand[0]] : [config.chrome.audioInputCommand?.[0], config.chrome.audioOutputCommand?.[0]];
...
var GoogleMeetRuntime = class {
	...
	async join(request) {
		...
		return {
			session,
			spoken: mode === "realtime" && speechInstructions ? (await this.speak(session.id, speechInstructions)).spoken : false
		};
	}
...
const googleMeetToolDeps = { callGatewayFromCli };
const __testing = { setCallGatewayFromCliForTests(next) {
...
async function createMeetFromParams(params) {
	return (await import("../../create-DKkIH9R2.js")).createMeetFromParams(params);
}
async function createAndJoinMeetFromParams(params) {
	return (await import("../../create-DKkIH9R2.js")).createAndJoinMeetFromParams(params);
}
async function resolveGoogleMeetTokenFromParams(config, raw) {
	const { resolveGoogleMeetAccessToken } = await import("../../oauth-DNOkoQ4L.js");
...
async function exportGoogleMeetBundleFromParams(config, raw) {
	...
	const { buildGoogleMeetExportManifest, googleMeetExportFileNames, writeMeetExportBundle } = await import("../../cli-COSKPw3B.js");
...
var google_meet_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerCli(async ({ program }) => {
			const { registerGoogleMeetCli } = await import("../../cli-COSKPw3B.js");
