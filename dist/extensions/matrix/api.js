...
import { D as mergeAllowFromEntries, L as promptAccountId, u as addWildcardAllowFrom } from "../../setup-wizard-proxy-3tbzVvIf.js";
...
import { d as requiresExplicitMatrixDefaultAccount } from "../../helper-api-C98jB0d0.js";
import { n as getMatrixThreadBindingManager, o as resetMatrixThreadBindingsForTests } from "../../thread-bindings-runtime-lLy617z-.js";
import { t as promptChannelAccessConfig } from "../../setup-group-access-CjgPGESg.js";
...
import "../../verification-BROSKGtW.js";
import { i as runMatrixSetupBootstrapAfterConfigWrite, n as matrixSetupAdapter, t as buildMatrixConfigUpdate } from "../../setup-core-X4L1squC.js";
import { n as listMatrixDirectoryGroupsLive, t as resolveMatrixTargets } from "../../resolve-targets-vU0BXQMk.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "../../deps-hQqcavY0.js";
...
async function runMatrixConfigure(params) {
	...
	if (!accessToken && !password) if (await params.prompter.select({
...
//#endregion
export { buildMatrixConfigUpdate, createMatrixThreadBindingManager, getMatrixThreadBindingManager, matrixOnboardingAdapter, matrixOnboardingAdapter as matrixSetupWizard, matrixSetupAdapter, resetMatrixThreadBindingsForTests };
