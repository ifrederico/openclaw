...
import { ax as defineChannelPluginEntry } from "../../pi-embedded-DhFkhMap.js";
...
import "../../matrix-runtime-heavy-CdMW6pP-.js";
import "../../diagnostics-otel-DTQ5l1uf.js";
import "../../extension-shared-YEd0rhVx.js";
import { a as getMatrixRuntime, o as setMatrixRuntime } from "../../credentials-read-Dq0zwNHp.js";
import { $ as resolveMatrixRoomKeyBackupIssue, L as resolveMatrixAccount, R as resolveMatrixAccountConfig, W as resolveMatrixAuthContext, X as setMatrixSdkLogMode, Y as setMatrixSdkConsoleLogging, c as repairMatrixDirectRooms, nt as updateMatrixAccountConfig, s as inspectMatrixDirectRooms, tt as resolveMatrixConfigPath } from "../../send-WKZDIB9i.js";
import "../../types-Dp0oGi5h.js";
import { t as matrixPlugin } from "../../channel-Cd39Hyle.js";
import "../../allowlist-CLH180zZ.js";
import "../../encryption-guidance-BX1nXp3r.js";
import "../../lib-Chph-UO4.js";
import "../../BasicParser-Chh3cbzw.js";
import "../../APEv2Parser-D1v6PYhJ.js";
import { c as getMatrixRoomKeyBackupStatus, h as restoreMatrixRoomKeyBackup, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, u as getMatrixVerificationStatus, v as verifyMatrixRecoveryKey, x as withStartedActionClient, y as withResolvedActionClient } from "../../verification-BROSKGtW.js";
import { n as matrixSetupAdapter, r as maybeBootstrapNewEncryptedMatrixAccount } from "../../setup-core-X4L1squC.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "../../device-health-BhiEZe5E.js";
import "../../profile-Be0I_hrq.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "../../profile-update-yeGpcIb0.js";
...
var matrix_default = defineChannelPluginEntry({
	...
	registerFull(api) {
		import("../../plugin-entry.runtime-B31Y7_Fe.js").then(({ ensureMatrixCryptoRuntime }) => ensureMatrixCryptoRuntime({ log: api.logger.info }).catch((err) => {
		...
		api.registerGatewayMethod("matrix.verify.recoveryKey", async (ctx) => {
			const { handleVerifyRecoveryKey } = await import("../../plugin-entry.runtime-B31Y7_Fe.js");
			await handleVerifyRecoveryKey(ctx);
		});
		api.registerGatewayMethod("matrix.verify.bootstrap", async (ctx) => {
			const { handleVerificationBootstrap } = await import("../../plugin-entry.runtime-B31Y7_Fe.js");
			await handleVerificationBootstrap(ctx);
		});
		api.registerGatewayMethod("matrix.verify.status", async (ctx) => {
			const { handleVerificationStatus } = await import("../../plugin-entry.runtime-B31Y7_Fe.js");
