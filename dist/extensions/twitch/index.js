...
import { ax as defineChannelPluginEntry, ix as createChatChannelPlugin, rf as require_retry } from "../../pi-embedded-DhFkhMap.js";
		...
		base: {
			...
			gateway: {
				startAccount: async (ctx) => {
					...
					const { monitorTwitchProvider } = await import("../../monitor-DlLqm0j-.js");
