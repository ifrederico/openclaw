...
import { a as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "../../channel-config-helpers-CWYUF2eN.js";
...
import { C as projectConfigAccountIdWarningCollector, p as createAllowlistProviderGroupPolicyWarningCollector } from "../../channel-policy-DIVRdPsQ.js";
...
import { a as createFeishuClient, c as listEnabledFeishuAccounts, d as resolveFeishuAccount, f as resolveFeishuRuntimeAccount, l as listFeishuAccountIds, s as inspectFeishuCredentials, u as resolveDefaultFeishuAccountId } from "../../probe-wHoF6aaT.js";
import { c as toolExecutionErrorResult, d as resolveAnyEnabledFeishuToolsConfig, f as resolveFeishuToolAccount, h as normalizeFeishuTarget, l as unknownToolActionResult, m as looksLikeFeishuId, n as registerFeishuDriveTools, s as jsonToolResult, u as createFeishuToolClient } from "../../drive-BfPG4edz.js";
import { i as resolveFeishuGroupToolPolicy } from "../../policy-BbZ0sNad.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "../../conversation-id-Cm8_PasL.js";
import { a as listFeishuDirectoryGroups, i as registerFeishuChatTools, o as listFeishuDirectoryPeers } from "../../chat-cYVUYftJ.js";
import { n as secretTargetRegistryEntries, r as messageActionTargetAliases, t as collectRuntimeConfigAssignments } from "../../secret-contract-DBu8_rMm.js";
import { t as resolveFeishuSessionConversation } from "../../session-conversation-BoZcm7Dh.js";
import { n as feishuSetupAdapter, r as setFeishuNamedAccountEnabled, t as feishuSetupWizard } from "../../setup-surface-CzC8Vjxm.js";
import { t as getFeishuRuntime } from "../../runtime-D4g2Cem8.js";
import { n as createFeishuThreadBindingManager, r as getFeishuThreadBindingManager, t as __testing } from "../../thread-bindings-D4RQSZj-.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("../../channel.runtime-DHMpTgwU.js"), "feishuChannelRuntime");
	...
	base: {
		...
		config: {
			...
			setAccountEnabled: ({ cfg, accountId, enabled }) => {
				...
				return setFeishuNamedAccountEnabled$1(cfg, accountId, enabled);
			},
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("../../monitor-Hbuboun0.js");
				...
				async execute(_toolCallId, params) {
					...
					try {
						...
						switch (p.action) {
							...
							case "upload_image": return json$1(await uploadImageBlock(client, p.doc_token, getMediaMaxBytes(p, defaultAccountId), p.url, p.file_path, p.parent_block_id, p.filename, p.index, p.image));
							case "upload_file": return json$1(await uploadFileBlock(client, p.doc_token, getMediaMaxBytes(p, defaultAccountId), p.url, p.file_path, p.parent_block_id, p.filename));
