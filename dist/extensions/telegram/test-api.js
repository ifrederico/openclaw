...
import { r as listTelegramAccountIds, s as resolveTelegramAccount } from "../../accounts-CRCn-CcD.js";
import { i as telegramOutbound } from "../../status-issues-CUAr2aPu.js";
import { n as resolveTelegramFetch } from "../../fetch-BIOFV07p.js";
import { _ as sendPollTelegram, g as sendMessageTelegram } from "../../sticker-cache-D5HWZe_u.js";
import { i as handleTelegramAction, n as telegramMessageActionRuntime } from "../../monitor-DvfI3Jht.js";
import { n as setTelegramRuntime, t as telegramPlugin } from "../../channel-CUnlqxoT.js";
import { r as resetTelegramThreadBindingsForTests } from "../../thread-bindings-Cbz2P7eN.js";
...
async function loadBuildTelegramMessageContext() {
	...
	if (!buildTelegramMessageContextLoader) ({buildTelegramMessageContext: buildTelegramMessageContextLoader} = await import("../../bot-message-context-DUbL0YXp.js"));
	return buildTelegramMessageContextLoader;
}
async function loadVitestModule() {
	vitestModuleLoader ??= import("../../dist-DToe9ym2.js");
