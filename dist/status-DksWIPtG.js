...
import { n as resolvePreferredOpenClawTmpDir, t as POSIX_OPENCLAW_TMP_DIR } from "./tmp-openclaw-dir-BobVQuve.js";
import { n as isRich, r as theme, t as colorize } from "./theme-BeexRN7S.js";
import { _ as resolveStateDir, o as resolveConfigPath, u as resolveGatewayPort } from "./paths-yyDPxM31.js";
import { r as createConfigIO } from "./io-CS2J_l4V.js";
import "./config-dzPpvDz6.js";
import { t as formatCliCommand } from "./command-format-D6RJqoCJ.js";
import { d as resolveGatewayLaunchAgentLabel, p as resolveGatewaySystemdServiceName } from "./paths-DRWfIhrn.js";
...
import { r as resolveBestEffortGatewayBindHostForDisplay, t as inspectBestEffortPrimaryTailnetIPv4 } from "./network-discovery-display-Noqt172f.js";
...
import { p as classifySystemdUnavailableDetail } from "./systemd-ByeaoXxy.js";
import { r as resolveGatewayService } from "./service-DO4b04e2.js";
import { a as filterDaemonEnv, c as pickProbeHostForBind, d as resolveRuntimeStatusColor, f as safeDaemonEnv, o as normalizeListenerAddress, s as parsePortFromArgs, t as createCliStatusTextStyles, u as renderRuntimeHints } from "./shared-DbEFE2sP.js";
import { a as formatRuntimeStatus, n as renderSystemdUnavailableHints, o as resolveDaemonContainerContext, t as isSystemdUnavailableDetail } from "./systemd-hints-bQAQjsZ9.js";
...
import { r as renderGatewayServiceCleanupHints } from "./inspect-D5Z5KB7P.js";
...
function loadGatewayProbeAuthModule() {
	gatewayProbeAuthModulePromise ??= import("./probe-auth-DKWNWH8y.js");
	return gatewayProbeAuthModulePromise;
}
function loadDaemonInspectModule() {
	daemonInspectModulePromise ??= import("./inspect-CNwyGUEm.js");
	return daemonInspectModulePromise;
}
function loadServiceAuditModule() {
	serviceAuditModulePromise ??= import("./service-audit-DfZ_HGrl.js");
	return serviceAuditModulePromise;
}
function loadGatewayTlsModule() {
	gatewayTlsModulePromise ??= import("./gateway-BekON8kb.js");
	return gatewayTlsModulePromise;
}
function loadDaemonProbeModule() {
	daemonProbeModulePromise ??= import("./probe-CGAbYGac.js");
	return daemonProbeModulePromise;
}
function loadRestartHealthModule() {
	restartHealthModulePromise ??= import("./restart-health-Dnjw2l-J.js");
...
async function gatherDaemonStatus(opts) {
	...
	if (opts.probe) {
		...
		try {
			...
			if (!parseGatewaySecretRefPathFromError(error)) throw error;
			try {
				daemonProbeAuth = await loadGatewayProbeAuthModule().then(({ resolveGatewayProbeAuthWithSecretInputs }) => resolveGatewayProbeAuthWithSecretInputs({
					cfg: daemonCfg,
					mode: probeMode,
					env: mergedDaemonEnv,
					explicitAuth: {
				...
				if (!fallbackRefPath) throw fallbackError;
	...
	const health = opts.probe && loaded ? await loadRestartHealthModule().then(({ inspectGatewayRestart }) => inspectGatewayRestart({
		service,
		port: daemonPort,
		env: serviceEnv
	})).catch(() => void 0) : void 0;
