...
import { t as require_dist_cjs$2 } from "./dist-cjs-DPkdsRpp.js";
import { n as init_client, t as client_exports } from "./client-DtqxW3Xv.js";
import { t as require_dist_cjs$3 } from "./dist-cjs-BULxfh7I.js";
import { t as require_dist_cjs$4 } from "./dist-cjs-BBZzr6Rw.js";
...
var require_dist_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var LoginCredentialsFetcher = class LoginCredentialsFetcher {
		...
		async refresh(token) {
			const { SigninClient, CreateOAuth2TokenCommand } = await import("./signin-CACQWGz4.js");
...
var require_dist_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const resolveCredentialSource = (credentialSource, profileName, logger) => {
		const sourceProvidersMap = {
			EcsContainer: async (options) => {
				...
				const { fromContainerMetadata } = await import("./dist-cjs-CG1sZbyA2.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is EcsContainer");
				return async () => propertyProvider.chain(fromHttp(options ?? {}), fromContainerMetadata(options))().then(setNamedProvider);
			},
			Ec2InstanceMetadata: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Ec2InstanceMetadata");
				const { fromInstanceMetadata } = await import("./dist-cjs-CG1sZbyA2.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				return async () => fromInstanceMetadata(options)().then(setNamedProvider);
			},
			Environment: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
				const { fromEnv } = await import("./dist-cjs-BpdOY8Yt.js").then((m) => /* @__PURE__ */ __toESM(m.default));
	...
	const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
		...
		if (!options.roleAssumer) {
			const { getDefaultRoleAssumer } = await import("./sts-iZJdd_0C.js");
	...
	const resolveProcessCredentials = async (options, profile) => import("./dist-cjs-CjXn3Ymc.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromProcess }) => fromProcess({
		...options,
		profile
	...
	const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => import("./dist-cjs-DR5tMigJ.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromTokenFile }) => fromTokenFile({
