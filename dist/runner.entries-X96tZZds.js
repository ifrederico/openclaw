...
import { t as resolveSystemBin } from "./resolve-system-bin-C_wBXkde.js";
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-Bfgay7t4.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DpUG7RLK.js";
import { t as describeImageWithModel } from "./image-runtime-Dp3baQw5.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-Bb4Dm6jL.js";
import { a as resolvePrompt, n as resolveMaxBytes, r as resolveMaxChars, s as resolveTimeoutMs } from "./resolve-D7XwZuJE.js";
...
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-Cuxly2lK.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-uKXleyaj.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-K7ANcKrf.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio"
		}) || entry.model;
