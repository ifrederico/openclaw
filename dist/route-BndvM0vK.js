...
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-BuTmLVsu.js";
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-Ni_MxXk9.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-EOyEXYW5.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-Bd8iD0bE.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command--uBPqGzM.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-vdIqYQGl.js");
			...
			const { statusCommand } = await import("./status-BOKgZJ9R.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-B0CxK6bR.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-CBDrdIWz.js");
	...
	"agents-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { agentsListCommand } = await import("./agents-G1cPGl37.js");
	...
	"tasks-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { tasksListJsonCommand } = await import("./tasks-json-BMXaPyBV.js");
	...
	"tasks-audit": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { tasksAuditJsonCommand } = await import("./tasks-json-BMXaPyBV.js");
