...
import { t as resolveCliStartupPolicy } from "./command-startup-policy-CHmWJzDS.js";
//#region src/cli/plugin-registry-loader.ts
const pluginRegistryModuleLoader = createLazyImportLoader(() => import("./plugin-registry-O6g0QiGR.js"));
...
const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard-DfnslBPO.js"));
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-Db6rcVNn.js");
	if (params.argv) {
