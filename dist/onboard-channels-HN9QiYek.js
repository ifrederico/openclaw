import { a as getActivePluginRegistryVersion, g as requireActivePluginRegistry } from "./runtime-Dji2WXDE.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-Dm8ff2qI.js";
import { c as listChatChannels, n as formatChannelSelectionLine, t as formatChannelPrimerLine, u as isChannelVisibleInSetup } from "./registry-DldQsVOb.js";
...
import { i as listBundledChannelSetupPlugins } from "./bootstrap-registry-DSG7nIY1.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-B7CYXHId.js";
import { t as isChannelConfigured } from "./channel-configured-CS3pHvH2.js";
...
import { B as runSingleChannelSecretStep, F as resolveAccountIdForConfigure, N as promptResolvedAllowFrom, Q as splitSetupEntries } from "./setup-wizard-helpers-ecC16ic3.js";
...
import { n as loadChannelSetupPluginRegistrySnapshotForChannel, t as ensureChannelSetupPluginInstalled } from "./plugin-install-BzfqKIqr.js";
...
function resolveChannelSetupEntries(params) {
	...
	const installedCatalogEntries = catalogEntries.filter((entry) => !installedPluginIds.has(entry.id) && manifestInstalledIds.has(entry.id) && shouldShowChannelInSetup(entry.meta));
	const installableCatalogEntries = catalogEntries.filter((entry) => !installedPluginIds.has(entry.id) && !manifestInstalledIds.has(entry.id) && shouldShowChannelInSetup(entry.meta));
...
//#endregion
export { isCatalogChannelInstalled as a, noteChannelStatus as i, runCollectedChannelOnboardingPostWriteHooks as n, shouldShowChannelInSetup as o, setupChannels as r, createChannelOnboardingPostWriteHookCollector as t };
