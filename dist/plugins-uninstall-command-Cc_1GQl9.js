...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { buildPluginSnapshotReport } = await import("./status-b7lx_SuI.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-B4w35nci.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-DHaxBFmN.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-Bp54EnYd.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-Cmoht_5u.js");
