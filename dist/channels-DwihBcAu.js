...
import { i as getBundledChannelSetupPlugin } from "./bundled-DEq7iy1i.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-BkuUNjzB.js";
import "./plugins-C729ZIvi.js";
import "./logging-DZKzaN8o.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-CX7fE1ZG.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-CtuVk7ji.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-DZpt9gd4.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-raYM5-Vl.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-Bm48pkHP.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-dXse5DzJ.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CuZobs-u.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-DoOF-CnW.js";
import { t as resolveCommandConfigWithSecrets } from "./command-config-resolution-JY0WX5LP.js";
import { n as resolveLogFile } from "./log-tail-BQVt_1Zb.js";
import { t as parseLogLine } from "./parse-log-line-Bpx1wN45.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-CzMBPj9p.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-Cjkq--CN.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-B1IQeIrh.js";
import { t as channelsListCommand } from "./list-njPsPE3A.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-DdwvCE3y.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-CAVObfbh.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-Cn9rgzW6.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-BRAMiDJo.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BIJfjlA8.js").then(({ listChannelPluginCatalogEntries }) => listChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-Bcnax98W.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-Cu_3ubFw.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-B9SvKXrv.js");
