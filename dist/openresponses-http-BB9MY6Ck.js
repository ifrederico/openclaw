...
import { i as emitAgentEvent, l as onAgentEvent } from "./agent-events-CSgsEl_z.js";
import { r as isClientToolNameConflictError } from "./pi-tool-definition-adapter-B1yqvP_o.js";
import { i as wrapExternalContent } from "./external-content-M-sFVDK7.js";
import { t as renderFileContextBlock } from "./file-context-DYCOP0Lo.js";
import { a as extractImageContentFromSource, c as resolveInputFileLimits, i as extractFileContentFromSource, n as DEFAULT_INPUT_IMAGE_MIMES, o as normalizeMimeList } from "./input-files-VGDL8p1G.js";
...
import { c as watchClientDisconnect, i as sendJson, l as writeDone, s as setSseHeaders } from "./http-common-CxRh-el-.js";
import { a as getHeader, i as getBearerToken, l as resolveOpenAiCompatibleHttpOperatorScopes, u as resolveOpenAiCompatibleHttpSenderIsOwner } from "./http-auth-utils-stNI7HTF.js";
import { a as resolveGatewayRequestContext, o as resolveOpenAiCompatModelOverride, r as resolveAgentIdForRequest } from "./http-utils-3xCgv22F.js";
import { t as handleGatewayPostJsonEndpoint } from "./http-endpoint-helpers-QzVdktwB.js";
import { n as buildAgentMessageFromConversationEntries, r as resolveAssistantStreamDeltaText, t as normalizeInputHostnameAllowlist } from "./input-allowlist-il0KwEKo.js";
...
async function handleOpenResponsesHttpRequest(req, res, opts) {
	...
	const responseId = payload.metadata?.trace_id?.trim() || getHeader(req, "x-request-id")?.trim() || `resp_${randomUUID()}`;
