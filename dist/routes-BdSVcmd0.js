...
import { a as getImageMetadata, l as resizeToJpeg, r as buildImageResizeSideGrid, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-CofkDchS.js";
import { a as ensureMediaDir, l as saveMediaBuffer } from "./store-LePoapNA.js";
import "./text-runtime-BMYQWTAu.js";
import { D as DEFAULT_AI_SNAPSHOT_MAX_CHARS, E as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, N as DEFAULT_BROWSER_SCREENSHOT_TIMEOUT_MS, d as parseBrowserHttpUrl, n as assertCdpEndpointAllowed, p as withCdpSocket } from "./cdp.helpers-CxaQ8QBG.js";
import { a as BrowserProfileUnavailableError, c as BrowserTabNotFoundError, d as toBrowserErrorResponse, i as BrowserProfileNotFoundError, l as BrowserTargetAmbiguousError, n as BrowserConflictError, r as BrowserError, s as BrowserResourceExhaustedError, u as BrowserValidationError } from "./errors-BQpn7MGJ.js";
import { n as deriveDefaultBrowserCdpPortRange } from "./sdk-config-94P68rMB.js";
import { a as DEFAULT_DOWNLOAD_DIR, c as resolveExistingPathsWithinRoot, i as resolveProfile, o as DEFAULT_TRACE_DIR, r as resolveManagedBrowserHeadlessMode, s as DEFAULT_UPLOAD_DIR, u as resolveWritablePathWithinRoot } from "./config-Cvs8G1H5.js";
import "./config-BCzKFr5r.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-CKR0d2U1.js";
import { n as normalizeString } from "./record-shared-BDXzED3w.js";
import "./sdk-setup-tools-CqJZd13u.js";
import { t as movePathToTrash } from "./trash-BwrO7sbV.js";
import { C as assertBrowserNavigationResultAllowed, T as withBrowserNavigationPolicy, _ as INTERACTIVE_ROLES, a as resolveOpenClawUserDataDir, g as CONTENT_ROLES, h as snapshotRoleViaCdp, m as snapshotAria, t as getChromeWebSocketUrl, u as captureScreenshot, v as STRUCTURAL_ROLES, x as assertBrowserNavigationAllowed, y as resolveBrowserNavigationProxyMode } from "./chrome-BJNKwrhr.js";
import { E as uploadChromeMcpFile, T as takeChromeMcpSnapshot, _ as navigateChromeMcpPage, a as closeChromeMcpTab, c as evaluateChromeMcpScript, f as getChromeMcpPid, l as fillChromeMcpElement, m as hoverChromeMcpElement, n as clickChromeMcpCoords, o as dragChromeMcpElement, r as clickChromeMcpElement, u as fillChromeMcpForm, w as takeChromeMcpScreenshot, x as resizeChromeMcpPage, y as pressChromeMcpKey } from "./chrome-mcp-BOqL_stO.js";
import { a as shouldUsePlaywrightForAriaSnapshot, i as resolveDefaultSnapshotFormat, n as getPwAiModule$1, o as shouldUsePlaywrightForScreenshot, r as getBrowserProfileCapabilities, t as resolveTargetIdFromTabs } from "./target-id-AXBtCe_J.js";
import { c as ACT_MAX_CLICK_DELAY_MS, l as ACT_MAX_WAIT_TIME_MS, o as normalizeBrowserFormField, p as matchBrowserUrlPattern, r as getRoleSnapshotStats, u as normalizeActBoundedNonNegativeMs } from "./pw-role-snapshot-Cv7ZUDBJ.js";
...
async function runBrowserLiveProbe(req, ctx) {
	...
	try {
		...
		if (capabilities.usesChromeMcp) {
			const { takeChromeMcpSnapshot } = await import("./chrome-mcp-BrHubjAk.js");
