...
const loadAuditChannelDiscordRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.discord.runtime-CIjoZ2Rq.js"), ({ auditChannelDiscordRuntime }) => auditChannelDiscordRuntime);
const loadAuditChannelAllowFromRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.allow-from.runtime-DQWtr6e4.js"), ({ auditChannelAllowFromRuntime }) => auditChannelAllowFromRuntime);
const loadAuditChannelTelegramRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.telegram.runtime-DGcitpU8.js"), ({ auditChannelTelegramRuntime }) => auditChannelTelegramRuntime);
const loadAuditChannelZalouserRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.zalouser.runtime-8a9JxI6F.js"), ({ auditChannelZalouserRuntime }) => auditChannelZalouserRuntime);
