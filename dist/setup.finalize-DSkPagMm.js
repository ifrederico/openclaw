...
import { f as resolveControlUiLinks, g as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-CJMGcz99.js";
...
import { t as runTui } from "./tui-D128n3Jw.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CRhfEIOe.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-X6q0EuxO.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-X6q0EuxO.js");
