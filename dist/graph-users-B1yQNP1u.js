...
import { c as isPrivateIpAddress } from "./ssrf-BdAu1_OT.js";
import { i as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist, r as isHttpsUrlAllowedByHostnameSuffixAllowlist } from "./ssrf-policy-Cve-f-IZ.js";
...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-ClgeYWp_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-CVmXBkaa.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createBotFrameworkJwtValidator(creds) {
	const { createServiceTokenValidator } = await import("./jwt-validator-Dypr0J1X.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	...
	return { async validate(authHeader, serviceUrl) {
		...
		try {
			return await validator.validateAccessToken(token, serviceUrl ? { validateServiceUrl: { expectedServiceUrl: serviceUrl } } : void 0) != null;
		} catch {
			return false;
		}
	} };
...
//#endregion
export { resolveRequestUrl as A, isDownloadableAttachment as C, normalizeContentType as D, isUrlAllowed as E, safeHostForUrl as M, resolveAttachmentFetchPolicy as O, inferPlaceholder as S, isRecord as T, GRAPH_ROOT as _, resolveGraphToken as a, extractHtmlFromAttachment as b, readAccessToken as c, createMSTeamsTokenProvider as d, loadMSTeamsSdkWithAuth as f, ATTACHMENT_TAG_RE as g, setMSTeamsRuntime as h, normalizeQuery as i, safeFetchWithPolicy as j, resolveMediaSsrfPolicy as k, createBotFrameworkJwtValidator as l, getMSTeamsRuntime as m, listChannelsForTeam as n, hasConfiguredMSTeamsCredentials as o, buildUserAgent as p, listTeamsByName as r, resolveMSTeamsCredentials as s, searchGraphUsers as t, createMSTeamsAdapter as u, IMG_SRC_RE as v, isLikelyImageAttachment as w, extractInlineImageCandidates as x, applyAuthorizationHeaderForUrl as y };
