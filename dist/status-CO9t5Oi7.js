...
import { n as getNodeDaemonStatusSummary, t as getDaemonStatusSummary } from "./status.daemon-D81hmpNl.js";
import "./status.summary-CVIq0_RP.js";
...
function loadSecurityAuditModule() {
	securityAuditModulePromise ??= import("./audit.runtime-bwymaTsv.js");
...
function loadStatusScanModule() {
	statusScanModulePromise ??= import("./status.scan-rqDefODS.js");
	return statusScanModulePromise;
}
function loadStatusScanFastJsonModule() {
	statusScanFastJsonModulePromise ??= import("./status.scan.fast-json-D4-VBBzl.js");
	return statusScanFastJsonModulePromise;
}
function loadStatusAllModule() {
	statusAllModulePromise ??= import("./status-all-C_qbiBaM.js");
	return statusAllModulePromise;
}
function loadStatusCommandTextRuntime() {
	statusCommandTextRuntimePromise ??= import("./status.command.text-runtime-CONRwFnl.js");
	return statusCommandTextRuntimePromise;
}
function loadStatusNodeModeModule() {
	statusNodeModeModulePromise ??= import("./status.node-mode-CRArERwN.js");
