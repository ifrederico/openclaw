...
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-BWTx5yRn.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-BxunCl1X.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
