...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-BuKAcvnv.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BWrypOof.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createBotFrameworkJwtValidator(creds) {
	const { JwtValidator } = await import("./jwt-validator-uWrWRDAJ.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
//#endregion
export { inferPlaceholder as A, safeHostForUrl as B, isRevokedProxyError as C, applyAuthorizationHeaderForUrl as D, IMG_SRC_RE as E, normalizeContentType as F, resolveAttachmentFetchPolicy as I, resolveMediaSsrfPolicy as L, isLikelyImageAttachment as M, isRecord$1 as N, extractHtmlFromAttachment as O, isUrlAllowed as P, resolveRequestUrl as R, formatUnknownError as S, GRAPH_ROOT as T, loadMSTeamsSdkWithAuth as _, listChannelsForTeam as a, classifyMSTeamsSendError as b, postGraphBetaJson as c, hasConfiguredMSTeamsCredentials as d, resolveMSTeamsCredentials as f, createMSTeamsTokenProvider as g, createMSTeamsAdapter as h, fetchGraphJson as i, isDownloadableAttachment as j, extractInlineImageCandidates as k, postGraphJson as l, createBotFrameworkJwtValidator as m, deleteGraphRequest as n, listTeamsByName as o, readAccessToken as p, escapeOData as r, normalizeQuery as s, searchGraphUsers as t, resolveGraphToken as u, buildUserAgent as v, ATTACHMENT_TAG_RE as w, formatMSTeamsSendErrorHint as x, ensureUserAgentHeader as y, safeFetchWithPolicy as z };
