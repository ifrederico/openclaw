...
function getCommonAndChangedSubstrings(diffs, op, hasCommonDiff) {
	return diffs.reduce((reduced, diff) => reduced + (diff[0] === 0 ? diff[1] : diff[0] === op ? hasCommonDiff ? C.inverse(diff[1]) : diff[1] : ""), "");
}
//#endregion
...
async function saveInlineSnapshots(environment, snapshots) {
	const MagicString = (await import("./magic-string.es-_btIhe05.js")).default;
