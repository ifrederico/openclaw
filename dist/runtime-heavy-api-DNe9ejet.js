...
import { a as resolveMatrixDefaultOrOnlyAccountId, i as resolveMatrixChannelConfig, n as requiresExplicitMatrixDefaultAccount, o as getMatrixScopedEnvVarNames, r as resolveConfiguredMatrixAccountIds, t as findMatrixAccountEntry } from "./account-selection-yi9R7gyc.js";
import { a as resolveMatrixCredentialsPath, n as resolveMatrixAccountStorageRoot, s as resolveMatrixLegacyFlatStoragePaths } from "./storage-paths-B5BRuhGd.js";
...
function isMatrixLegacyCryptoInspectorAvailable$1() {
	return true;
}
async function loadMatrixLegacyCryptoInspector() {
	return (await import("./legacy-crypto-inspector-x05DmL3u.js")).inspectLegacyMatrixCryptoStore;
}
...
function detectLegacyMatrixCrypto(params) {
	...
	if (detection.plans.length > 0 && !isMatrixLegacyCryptoInspectorAvailable$1()) return {
