...
import { n as resolveAuthStorePath, o as AUTH_STORE_LOCK_OPTIONS, p as log, t as ensureAuthStoreFile } from "./paths-DJBuCoRE.js";
import { n as resolveAuthProfileMetadata } from "./identity-chx6umeI.js";
import { i as formatProviderAuthProfileApiKeyWithPlugin, n as buildProviderAuthDoctorHintWithPlugin, o as refreshProviderOAuthCredentialWithPlugin } from "./provider-runtime.runtime-Do4WqoUN.js";
import { i as withFileLock } from "./file-lock-Cm3HPowf.js";
import { i as resolveSecretRefString } from "./resolve-DqJVzTVp.js";
import { c as ensureAuthProfileStore, m as updateAuthProfileStoreWithLock, n as listProfilesForProvider, p as saveAuthProfileStore, t as dedupeProfileIds } from "./profiles-CRvutsjq.js";
...
//#endregion
export { formatAuthDoctorHint as C, parseOAuthCallbackInput as S, evaluateStoredCredentialEligibility as _, clearExpiredCooldowns as a, exchangeChutesCodeForTokens as b, markAuthProfileCooldown as c, resolveProfileUnusableUntilForDisplay as d, resolveProfilesUnavailableReason as f, suggestOAuthProfileIdForLegacyDefault as g, repairOAuthProfileIdMismatch as h, clearAuthProfileCooldown as i, markAuthProfileFailure as l, resolveApiKeyForProfile as m, resolveAuthProfileOrder as n, getSoonestCooldownExpiry as o, sanitizeForConsole as p, calculateAuthProfileCooldownMs as r, isProfileInCooldown as s, resolveAuthProfileEligibility as t, markAuthProfileUsed as u, resolveTokenExpiryState as v, resolveAuthProfileDisplayLabel as w, generateChutesPkce as x, CHUTES_AUTHORIZE_ENDPOINT as y };
