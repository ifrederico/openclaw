...
import { n as removeCommandByName, t as registerLazyCommand } from "./register-lazy-command-BhXkoHGy.js";
import { t as getCoreCliCommandDescriptors } from "./core-command-descriptors-vYF7UgyI.js";
import { i as registerSubCliCommands } from "./register.subclis-YMNyBu6o.js";
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-D1Y8J1Ao.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-DZIi5AZS.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-CImUSJTu.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-CKTmMpn3.js")).registerConfigCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.backup-B1OPmKCE.js")).registerBackupCommand(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-CMcS5Zrx.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-DqRsT0KL.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./mcp-cli-D0Zwizs3.js")).registerMcpCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-Bzdv-kQA.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-DH5hFK3i.js")).registerStatusHealthSessionsCommands(program);
		}
	}
];
