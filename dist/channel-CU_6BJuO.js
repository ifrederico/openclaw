...
import { r as resolveMSTeamsGroupToolPolicy } from "./policy-CXs5tgk-.js";
import { m as getMSTeamsRuntime, s as resolveMSTeamsCredentials } from "./graph-users-B1yQNP1u.js";
import { i as parseMSTeamsTeamChannelInput, n as normalizeMSTeamsUserInput, o as resolveMSTeamsChannelAllowlist, r as parseMSTeamsConversationId, s as resolveMSTeamsUserAllowlist, t as normalizeMSTeamsMessagingTarget } from "./resolve-allowlist-BfMOQqIW.js";
import { n as msteamsSetupAdapter, t as msteamsSetupWizard } from "./setup-surface-BDTQwfL7.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DWkwrxWi.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorMSTeamsProvider } = await import("./src-CllIsDqP.js");
