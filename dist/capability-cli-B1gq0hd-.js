...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-Cb-weTw_.js";
import { t as ADMIN_SCOPE } from "./operator-scopes-D9nPeeKf.js";
import { i as callGateway, u as randomIdempotencyKey } from "./call-z1vgxJx0.js";
import { p as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-CSOk8Bno.js";
import { i as listMemoryEmbeddingProviders, o as registerMemoryEmbeddingProvider } from "./memory-embedding-providers-3vy8Xe8H.js";
import { r as loadModelCatalog } from "./model-catalog-BlLdiT-K.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-DOdi-EcR.js";
import { D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-Btvk-HT-.js";
import "./tts-B4VxOis2.js";
import { a as getImageMetadata, i as convertHeicToJpeg } from "./image-ops-CofkDchS.js";
...
import { u as buildMediaUnderstandingRegistry } from "./defaults.constants-Bb4Dm6jL.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-D9UfqVAj.js";
import { i as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-Dl0SBgk6.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-Buk7nxJx.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DbWvVOpI.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-B3VWfNZp.js";
import { n as runCommandWithRuntime } from "./cli-utils-C56x7xk6.js";
import { t as removeCommandByName } from "./command-tree-DENO8YA-.js";
import { t as collectOption } from "./helpers-DqWi7Ubf.js";
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-Csd_ucap.js";
import { a as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-B9g8ht8U.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-C2Z5HjVE.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command--uBPqGzM.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-BJf9DzbX.js");
