import { s as resolveValidatedMatrixHomeserverUrl } from "./config-DIIOT5nc.js";
import { i as writeStorageMeta, r as resolveMatrixStoragePaths, t as maybeMigrateLegacyStorage } from "./storage-pYn8eG-P.js";
...
async function loadMatrixCreateClientRuntimeDeps() {
	matrixCreateClientRuntimeDepsPromise ??= Promise.all([import("./sdk-ulegOOJo.js"), import("./logging-Bu3Q1iyC.js")]).then(([sdkModule, loggingModule]) => ({
