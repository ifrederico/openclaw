...
import { n as removeCommandByName, t as registerLazyCommand } from "./register-lazy-command-Cs49GgQ8.js";
import { t as getCoreCliCommandDescriptors } from "./core-command-descriptors-Bk-cu28T.js";
import { i as registerSubCliCommands } from "./register.subclis-CxbfwuSx.js";
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-K43VyK_B.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-D_AMROeF.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-DjUUmXij.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-Y536hiWN.js")).registerConfigCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.backup-DI_bq1qG.js")).registerBackupCommand(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-ac1j7USc.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-BmaqLpxL.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./mcp-cli-CHMjEaSW.js")).registerMcpCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-5tc1dCPV.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-BTQnGwru.js")).registerStatusHealthSessionsCommands(program);
		}
	}
];
