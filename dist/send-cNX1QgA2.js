...
import { a as isAutoLinkedFileRef } from "./text-runtime-CYpCjfTg.js";
import { t as loadOutboundMediaFromUrl } from "./outbound-media-55sTJsgk.js";
import { t as require_src } from "./src-BkBJMEBH.js";
...
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-DO50q16q.js";
import { a as EventType, c as RelationType, n as persistMatrixDirectRoomMapping, s as MsgType, t as inspectMatrixDirectRooms, u as buildMatrixReactionContent } from "./direct-management-CyITAXns.js";
import { t as fromBuffer } from "./lib-BAInjL57.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-Bcf42uDI.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-CKWT4Q85.js";
import { l as toRatio, n as decodeString } from "./Util-CQLX2DqZ.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-CaDv6D7F.js";
import { t as APEv2Parser } from "./APEv2Parser-C6f7npZ1.js";
import { r as hasID3v1Header } from "./ID3v1Parser-CIdvEthp.js";
import { i as isStrictDirectRoom } from "./direct-room-C3nJXG1N.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-CR_cqyMJ.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-a5zQ1e29.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-Bjsniq22.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-CP6zRv0A.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-PfltKFeb.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-nVKq6RtY.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CtfWrqJ3.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-BG-uvtru.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Dcp9HLXm.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DlUdYNCT.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CcdNUsN1.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-0oy0dO45.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CjGOB9Oa.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BP-_dCkw.js")).WaveParser;
	}
};
//#endregion
