...
import { o as fetchWithRuntimeDispatcher } from "./fetch-guard-Bl48brXk.js";
import { i as readResponseWithLimit$1 } from "./fetch-DzQEmCkk.js";
import "./infra-runtime-DS3U08t7.js";
import "./media-runtime-teBRB60y.js";
import { t as buildTimeoutAbortSignal } from "./runtime-api-F7BKl-oB.js";
...
async function fetchWithMatrixDispatcher(params) {
	if (params.init.dispatcher && !isMockedFetch(globalThis.fetch)) return await fetchWithRuntimeDispatcher(params.url, params.init);
