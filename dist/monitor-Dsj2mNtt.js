import { d as resolveThreadSessionKeys, u as resolveAgentIdFromSessionKey } from "./session-key-BR3Z-ljs.js";
import { n as formatAllowlistMatchMeta } from "./allowlist-match-BwqmzAfd.js";
import { a as resolveSessionStoreEntry } from "./store-C1XtW9hV.js";
...
import { a as buildExecApprovalPendingReplyPayload, c as getExecApprovalApproverDmNoticeText } from "./exec-approval-reply-28aiYmKw.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-Dk1WAJor.js";
import { n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-CavttejP.js";
...
import { i as resolveConfiguredAcpBindingRecord, t as ensureConfiguredAcpBindingReady } from "./persistent-bindings.lifecycle-Cn5ijaHI.js";
...
import { c as createDraftStreamLoop } from "./channel-lifecycle-3hD3I66y.js";
import { s as resolveMatrixAccountConfig } from "./config-paths-CoaCuevd.js";
import { t as getMatrixRuntime } from "./runtime-DmY6cbJm.js";
import { i as resolveMatrixAccount, n as resolveConfiguredMatrixBotUserIds } from "./accounts-CA9DbuWr.js";
import "./runtime-api-F7BKl-oB.js";
import { a as isMatrixExecApprovalAuthorizedSender, d as resolveMatrixAllowListMatch, i as matrixNativeApprovalAdapter, l as normalizeMatrixAllowList, n as resolveMatrixRoomConfig, o as isMatrixExecApprovalClientEnabled, s as shouldHandleMatrixExecApprovalRequest, t as resolveMatrixStoredSessionMeta, u as normalizeMatrixUserId } from "./session-store-metadata-Dajkgu5F.js";
import { a as resolveMatrixTargetIdentity, t as isMatrixQualifiedUserId } from "./target-ids-DO50q16q.js";
import { t as isBunRuntime } from "./runtime-dbhQ_5gE.js";
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-T3IZ6LWB.js";
import { n as resolveMatrixStateFilePath } from "./storage-COxLyXiQ.js";
import { n as LogService } from "./logger-DEkFaATj.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-DhCt3eu4.js";
import "./client-W3ob5qxk.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-CA2X4Fas.js";
import { t as resolveMatrixTargets } from "./resolve-targets-DLMQm0DA.js";
import { a as sendMessageMatrix, c as sendSingleTextMessageMatrix, g as isPollStartType, h as isPollEventType, i as reactMatrixMessage, l as sendTypingMatrix, n as editMessageMatrix, p as formatPollAsText, r as prepareMatrixSingleText, s as sendReadReceiptMatrix, t as chunkMatrixText, v as parsePollStartContent } from "./send-cNX1QgA2.js";
import { f as extractMatrixReactionAnnotation, i as repairMatrixDirectRooms, l as MATRIX_REACTION_EVENT_TYPE, o as MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY, r as promoteMatrixDirectRoomCandidate, s as MsgType } from "./direct-management-CyITAXns.js";
import { o as readJoinedMatrixMembers, r as isStrictDirectMembership, t as hasDirectMatrixMemberFlag } from "./direct-room-C3nJXG1N.js";
import { t as createMatrixThreadBindingManager } from "./thread-bindings-tkuHYPuv.js";
import { i as setActiveMatrixClient } from "./client-bootstrap-BftfeT7N.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-BPXDW1Vm.js";
import { c as formatMatrixMediaTooLargeText, d as resolveMatrixMessageAttachment, f as resolveMatrixMessageBody, l as formatMatrixMediaUnavailableText, m as fetchMatrixPollSnapshot, n as editMatrixMessage, t as deleteMatrixMessage, u as formatMatrixMessageText } from "./messages-QCz3-fMd.js";
import { t as isMatrixNotFoundError } from "./errors-CTAalQzZ.js";
import { t as createAsyncLock } from "./async-lock-CWIWVcKW.js";
...
//#endregion
//#region extensions/matrix/src/exec-approvals-handler.ts
...
function buildReactionTargetRefKey(params) {
...
function buildPendingApprovalContent(params) {
	const allowedDecisions = params.request.request.allowedDecisions ?? resolveExecApprovalAllowedDecisions({ ask: params.request.request.ask ?? void 0 });
	const payload = buildExecApprovalPendingReplyPayload({
		approvalId: params.request.id,
		approvalSlug: params.request.id.slice(0, 8),
		approvalCommandId: params.request.id,
		ask: params.request.request.ask ?? void 0,
		agentId: params.request.request.agentId ?? void 0,
		allowedDecisions,
		...
		sessionKey: params.request.request.sessionKey ?? void 0,
...
function buildResolvedApprovalText(params) {
	...
	return [
		`Exec approval: ${params.resolved.decision === "allow-once" ? "Allowed once" : params.resolved.decision === "allow-always" ? "Allowed always" : "Denied"}`,
		"",
		"Command",
		"```",
		command,
...
var MatrixExecApprovalHandler = class {
	constructor(opts, deps = {}) {
		this.opts = opts;
		this.trackedReactionTargets = /* @__PURE__ */ new Map();
		...
		this.runtime = createChannelNativeApprovalRuntime({
			...
			shouldHandle: (request) => shouldHandleMatrixExecApprovalRequest({
				cfg: this.opts.cfg,
				accountId: this.opts.accountId,
				request
			}),
			buildPendingContent: ({ request, nowMs }) => buildPendingApprovalContent({
				request,
				nowMs
			}),
			...
			deliverTarget: async ({ preparedTarget, pendingContent }) => {
				...
				await Promise.allSettled(listMatrixApprovalReactionBindings(pendingContent.allowedDecisions).map(async ({ emoji }) => {
	...
	async finalizeResolved(request, resolved, entries) {
		const text = buildResolvedApprovalText({
			request,
			resolved
		});
		await Promise.allSettled(entries.map(async (entry) => {
			...
			await Promise.allSettled([this.editMessage(entry.roomId, primaryMessageId, text, {
				cfg: this.opts.cfg,
				accountId: this.opts.accountId,
				client: this.opts.client
	...
	clearTrackedReactionTargets() {
		for (const target of this.trackedReactionTargets.values()) unregisterMatrixApprovalReactionTarget(target);
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-DHQQSEXo.js"), import("./direct-room-Dl736R80.js")]).then(([directManagementModule, directRoomModule]) => ({
...
async function resolveMatrixExecApproval(params) {
...
async function maybeResolveMatrixApprovalReaction(params) {
	...
	if (!isMatrixExecApprovalAuthorizedSender({
		cfg: params.cfg,
		accountId: params.accountId,
		senderId: params.senderId
	})) return false;
				...
				deliver: async (payload, info) => {
					if (draftStream && info.kind !== "tool" && !payload.isCompactionNotice) {
						...
						if (draftEventId && payload.text && !hasMedia && !payloadReplyMismatch && !mustDeliverFinalNormally) {
							try {
								if (quietDraftStreaming || !draftStream.matchesPreparedText(payload.text)) await editMessageMatrix(roomId, draftEventId, payload.text, {
									client,
									cfg,
									threadId: threadTarget,
									accountId: _route.accountId,
							...
							const requiresFinalTextEdit = quietDraftStreaming || typeof payloadText === "string" && !draftStream.matchesPreparedText(payloadText);
							if (textEditOk && payloadText && requiresFinalTextEdit) textEditOk = await editMessageMatrix(roomId, draftEventId, payloadText, {
								client,
								cfg,
								threadId: threadTarget,
								accountId: _route.accountId,
							...
							if (draftEventId && (payloadReplyMismatch || mustDeliverFinalNormally)) await redactMatrixDraftEvent(client, roomId, draftEventId);
							await deliverMatrixReplies({
								cfg,
								replies: [payload],
								roomId,
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-BV9E1JzL.js"),
		import("./device-health-DSVAQfrk.js"),
		import("./profile-BOf7nk8i.js"),
		import("./legacy-crypto-restore-BAL90Vd5.js"),
		import("./startup-verification-NrjfwqfA.js")
