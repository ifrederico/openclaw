...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-Nl5PFZKO.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-CKvTY7DL.js")]);
