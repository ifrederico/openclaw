import { i as restoreTerminalState, n as defaultRuntime, r as writeRuntimeJson } from "./runtime-D34lIttY.js";
import { m as resolveUserPath } from "./utils-ms6h9yny.js";
import { u as resolveGatewayPort } from "./paths-yyDPxM31.js";
import { l as readConfigFileSnapshot } from "./io-CS2J_l4V.js";
import { t as assertSupportedRuntime } from "./runtime-guard-B0z37ZP7.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-BZdSA8i7.js";
...
import "./daemon-runtime-BhzkNvfv.js";
import { t as resolveControlUiLinks } from "./control-ui-links-ntLENAJ3.js";
import { c as normalizeGatewayTokenInput, d as randomToken, h as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-CiVaZSUb.js";
...
import { i as resolveDeprecatedAuthChoiceReplacement, l as resolveManifestProviderOnboardAuthFlags, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-B6ZEuSKs.js";
import { t as runSetupWizard } from "./setup-BRk2Azrc.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-0d_eGA7x.js";
...
const WINDOWS_INSTALL_DAEMON_HEALTH_COMMAND_TIMEOUT_MS = 3e4;
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-CqNFi1Sy.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-v68O7GS7.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-SsSNu0mX.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DpmB8Cec.js");
