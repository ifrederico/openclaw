...
import { Da as CONFIG_DIR, E as getRuntimeConfigSnapshot, Fa as escapeRegExp, Ga as resolveUserPath, Gi as runExec, Ha as resolveConfigDir, L as writeConfigFile, O as loadConfig, T as createConfigIO, a as parseBooleanValue, la as isNotFoundPathError, o as createSubsystemLogger, ua as isPathInside } from "./env-D1ktUnAV.js";
import { n as resolvePreferredOpenClawTmpDir } from "./tmp-openclaw-dir-DzRxfh9a.js";
import { S as resolveSecretInputRef, g as hasConfiguredSecretInput, u as secretRefKey } from "./ref-contract-BFBhfQKU.js";
import { o as resolveSecretRefValues } from "./resolve-DqJVzTVp.js";
import { t as formatCliCommand } from "./command-format-CCyUqeuM.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-DWYw6uyd.js";
import { r as isLoopbackHost } from "./net-1LAzWzJc.js";
import { a as resolveGatewayAuth } from "./auth-BC0t_CEl.js";
import { c as hasGatewayPasswordEnvCandidate, d as readGatewayTokenEnv, l as hasGatewayTokenEnvCandidate } from "./credentials-6hokf6e3.js";
import { t as rawDataToString } from "./ws-CPolAahN.js";
import { r as ensurePortAvailable } from "./ports-DF41F7NN.js";
...
import { n as extensionForMime, t as detectMime } from "./mime-Bwp1UQ_8.js";
import { r as hasProxyEnvConfigured } from "./proxy-env-DWSC5E7E.js";
import { d as resolvePinnedHostnameWithPolicy, l as isPrivateNetworkAllowedByPolicy, t as SsrFBlockedError, u as resolvePinnedHostname } from "./ssrf-BdAu1_OT.js";
import { a as openFileWithinRoot, c as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-DpC9pe80.js";
import { a as allocateColor, c as isValidProfileName, f as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, i as allocateCdpPort, l as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, n as resolveBrowserConfig, o as getUsedColors, p as deriveDefaultBrowserCdpPortRange, r as resolveProfile, s as getUsedPorts, t as parseHttpUrl, u as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./config-B6bjVdCF.js";
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-CaOt9DFn.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CaOt9DFn.js");
	} catch (err) {
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-CaOt9DFn.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
...
//#endregion
export { ensureGatewayStartupAuth as $, movePathToTrash as A, assertBrowserNavigationRedirectChainAllowed as B, normalizeBrowserFormField as C, createBrowserRuntimeState as D, startBrowserControlServiceFromConfig as E, readBrowserVersion as F, getHeadersWithAuth as G, withBrowserNavigationPolicy as H, resolveGoogleChromeExecutableForPlatform as I, withCdpSocket as J, normalizeCdpHttpBaseForJsonEndpoints as K, formatAriaSnapshot as L, BrowserTabNotFoundError as M, getChromeWebSocketUrl as N, stopBrowserRuntime as O, parseBrowserMajorVersion as P, resolveBrowserControlAuth as Q, normalizeCdpWsUrl as R, DEFAULT_FILL_FIELD_TYPE as S, createBrowserControlContext as T, appendCdpPath as U, assertBrowserNavigationResultAllowed as V, fetchJson as W, markPwAiLoaded as X, withNoProxyForCdpUrl as Y, ensureBrowserControlAuth as Z, DEFAULT_TRACE_DIR as _, buildRoleSnapshotFromAriaSnapshot as a, deleteBridgeAuthForPort as at, resolveStrictExistingPathsWithinRoot as b, MEDIA_MAX_BYTES as c, ensureMediaDir as d, mergeGatewayAuthConfig as et, extractOriginalFilename as f, setMediaStoreNetworkDepsForTest as g, saveMediaSource as h, buildRoleSnapshotFromAiSnapshot as i, resolveRequiredConfiguredSecretRefInputString as it, getBrowserProfileCapabilities as j, createBrowserRouteContext as k, SaveMediaSourceError as l, saveMediaBuffer as m, createBrowserRouteDispatcher as n, resolveConfiguredSecretInputString as nt, getRoleSnapshotStats as o, setBridgeAuthForPort as ot, getMediaDir as p, redactCdpUrl as q, registerBrowserRoutes as r, resolveConfiguredSecretInputWithFallback as rt, parseRoleRef as s, fetchBrowserJson as t, mergeGatewayTailscaleConfig as tt, cleanOldMedia as u, DEFAULT_UPLOAD_DIR as v, normalizeBrowserFormFieldValue as w, matchBrowserUrlPattern as x, resolveExistingPathsWithinRoot as y, assertBrowserNavigationAllowed as z };
