import { i as restoreTerminalState } from "./runtime-D34lIttY.js";
import { d as pathExists, m as resolveUserPath } from "./utils-ms6h9yny.js";
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DLW8_PFX.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-DO_KBTik.js";
import { h as waitForGatewayReachable, i as formatControlUiSshHint, u as probeGatewayReachable } from "./onboard-helpers-CiVaZSUb.js";
...
import { t as listConfiguredWebSearchProviders } from "./runtime-BVpNlH6T.js";
...
import { t as runTui } from "./tui-BWDAZE5F.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DAgeO7cv.js");
	...
	const { describeCodexNativeWebSearch } = await import("./codex-native-web-search-DIaG2HXL.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CyJUB0oM.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-CyJUB0oM.js");
