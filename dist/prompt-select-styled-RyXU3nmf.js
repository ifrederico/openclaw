import { o as getResolvedLoggerSettings } from "./logger-C-bijuBQ.js";
import { o as resolveRequiredHomeDir } from "./home-dir-BnP38vVl.js";
import { n as defaultRuntime } from "./runtime-D34lIttY.js";
import { _ as shortenHomePath, m as resolveUserPath, v as sleep } from "./utils-ms6h9yny.js";
import { r as normalizeChatChannelId } from "./ids-Dm8ff2qI.js";
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-D7WzFglX.js";
import { t as sanitizeForLog } from "./ansi-DpBQLMEp.js";
import { t as isTruthyEnvValue$1 } from "./env-DkqMjWaD.js";
import { c as updateAuthProfileStoreWithLock, n as ensureAuthProfileStore } from "./store-HF_Z-jKz.js";
import { t as buildAuthProfileId } from "./identity-JX4QAtGN.js";
import { r as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-gRFfbuWd.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-yyDPxM31.js";
import { _ as normalizeAccountId, g as DEFAULT_ACCOUNT_ID, v as normalizeOptionalAccountId, w as parseAgentSessionKey } from "./session-key-BR3Z-ljs.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-CXWTwwic.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-CHN1LzVK.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-DLW8_PFX.js";
import { a as getModelRefStatus, g as resolveHooksGmailModel, m as resolveConfiguredModelRef } from "./model-selection-BVM4eHHo.js";
...
import { At as LEGACY_CONFIG_MIGRATIONS, I as getTrustedSafeBinDirs, J as resolveCommandResolutionFromArgv, L as isTrustedSafeBinPath, Lt as listPluginDoctorLegacyConfigRules, Mt as migrateLegacyXSearchConfig, Pt as mergeMissing, St as normalizeTalkSection, V as listRiskyConfiguredSafeBins, bt as resolveNormalizedProviderModelMaxTokens, h as writeConfigFile, jt as migrateLegacyWebSearchConfig, kt as findLegacyConfigIssues, l as readConfigFileSnapshot, x as validateConfigObjectWithPlugins, z as normalizeTrustedSafeBinDirs } from "./io-CS2J_l4V.js";
...
import { a as normalizePluginsConfig, i as normalizePluginId, s as resolveEffectivePluginActivationState } from "./config-state-CKMpUUgI.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-B7CYXHId.js";
import { i as hasBundledChannelPersistedAuthState, r as listPotentialConfiguredChannelIds } from "./config-presence-Bwyumb-a.js";
import { r as runPluginSetupConfigMigrations } from "./setup-registry-CLKO_jQP.js";
...
import { n as parseToolsBySenderTypedKey } from "./types.tools-CHbRLkF-.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-CoOjbg-h.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-C9rOoFG7.js";
import { t as formatCliCommand } from "./command-format-D6RJqoCJ.js";
import { d as resolveGatewayLaunchAgentLabel, g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-DRWfIhrn.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-CgEfWJeV.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-CtbCNzDU.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BhzkNvfv.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-ClDXr0JP.js";
import { d as resolveGatewayBindHost, r as isLoopbackHost } from "./net-DwNAtbJy.js";
...
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-D324ogmL.js";
import { i as resolveMainSessionKey } from "./main-session-D-BGz7Y3.js";
import "./sessions-C_xBS7FP.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-UazeViO92.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-BpLI8ahg.js";
import { t as loadSessionStore } from "./store-load-CibBc4QB.js";
import { i as resolveAgentSessionDirs } from "./targets-DRZWnRxv.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-SRMZ4WYD.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-BzIDRxIi.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DdujAMh7.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-CiVaZSUb.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-B_8Jeu7m.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-FcFHBNq5.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-ByeaoXxy.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DO4b04e2.js";
import { a as formatRuntimeStatus, n as renderSystemdUnavailableHints, o as resolveDaemonContainerContext, r as buildPlatformRuntimeLogHints, t as isSystemdUnavailableDetail } from "./systemd-hints-bQAQjsZ9.js";
import { n as formatConfigIssueLines } from "./issue-format-Cr3dE6oM.js";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-CfuFpxj3.js";
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-CYiXRDwm.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BhFBGIyB.js";
import { n as findExtraGatewayServices, r as renderGatewayServiceCleanupHints } from "./inspect-D5Z5KB7P.js";
import { r as loadModelCatalog } from "./model-catalog-EGduXjg8.js";
import { b as resolveBootstrapContextForRun, g as TrimmedNonEmptyStringFieldSchema, m as LowercaseNonEmptyStringFieldSchema, n as buildBootstrapInjectionStats, p as DeliveryThreadIdFieldSchema, s as inferLegacyName, t as analyzeBootstrapBudget, u as normalizeOptionalText, v as parseOptionalField } from "./bootstrap-budget-Fd-WnRNB.js";
import { g as resolveBootstrapMaxChars, v as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-T2IjifdJ.js";
import { d as DEFAULT_SANDBOX_IMAGE, l as DEFAULT_SANDBOX_BROWSER_IMAGE, r as resolveSandboxScope } from "./config-x6EsTLRX.js";
import { s as resolveApiKeyForProvider } from "./model-auth-BbESr7Je.js";
import { l as loadExecApprovals } from "./exec-approvals-CBfBa44f.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-DXgF5fCJ.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-CEzBPW9Z.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-DU7FjHYo.js";
import { i as listRouteBindings } from "./bindings-DkGhVRYX.js";
import { M as listTaskFlowRecords, d as listTasksForFlowId } from "./runtime-internal-BfoqPUH2.js";
import { t as note$1 } from "./note-BsMd9LpB.js";
import "./logging-C4AfZy9u.js";
import "./sandbox-CvlUgeTk.js";
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "./google-api-base-url-DQpGB4Lb.js";
import { n as getActiveMemorySearchManager, r as resolveActiveMemoryBackendConfig } from "./memory-runtime-C_LZob9g.js";
import { t as resolveMemorySearchConfig } from "./memory-search-DIQ9kV2j.js";
import { d as shouldMoveSingleAccountChannelKey } from "./setup-helpers-BiAtGxsL.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Be5NDUNh.js";
import { a as readChannelAllowFromStore } from "./pairing-store--adbbV4I.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-CWGTUVOf.js";
...
import { i as resolveBundledPluginSources } from "./bundled-sources-BvOYxh_e.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-RQT4b6MT.js";
import { a as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as auditShortTermPromotionArtifacts, o as repairShortTermPromotionArtifacts, r as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-DPQwR0ld.js";
...
import "./engine-storage-BMm7AmCy.js";
import { t as noteChromeMcpBrowserReadiness } from "./browser-doctor-FR5qYByu.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Dw9tgruA.js";
import { i as buildPluginDiagnosticsReport, r as buildPluginCompatibilityWarnings } from "./status-BC4s-4i3.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-DaOQslhI.js";
import { r as healthCommand } from "./health-BXpfaOi4.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DQVjofXa.js";
import { a as collectChannelDoctorRepairMutations, c as shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning, i as collectChannelDoctorPreviewWarnings, n as collectChannelDoctorEmptyAllowlistExtraWarnings, o as collectChannelDoctorStaleConfigMutations, r as collectChannelDoctorMutableAllowlistWarnings, s as runChannelDoctorConfigSequences, t as collectChannelDoctorCompatibilityMutations } from "./channel-doctor-JOsxbe8_.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-B9mfojPf.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B_LExwK4.js";
import { t as formatHealthCheckFailure } from "./health-format-Cmbq1Yyd.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-DBDQQtTq.js";
import { a as runGatewayUpdate, i as runChannelPluginStartupMaintenance, t as coerceFiniteScheduleNumber } from "./schedule-CZ4ymgNS.js";
import { n as doctorShellCompletion } from "./doctor-completion-DQM4mcS0.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-NbAopnFL.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context--nMca8Qp.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-DSxd_Xvo.js";
import "./doctor-state-migrations-cXUXH-8Q.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-pDuOnYF4.js";
...
function normalizeLegacyBrowserConfig(cfg, changes) {
	...
	if (!isRecord$2(rawBrowser)) return cfg;
	...
	if (isRecord$2(rawSsrFPolicy) && "allowPrivateNetwork" in rawSsrFPolicy) {
...
function seedMissingDefaultAccountsFromSingleAccountBase(cfg, changes) {
	...
	for (const [channelId, rawChannel] of Object.entries(channels)) {
		if (!isRecord$2(rawChannel)) continue;
		const rawAccounts = rawChannel.accounts;
		if (!isRecord$2(rawAccounts)) continue;
		...
		const keysToMove = Object.entries(rawChannel).filter(([key, value]) => {
			if (key === "accounts" || key === "enabled" || value === void 0) return false;
			return shouldMoveSingleAccountChannelKey({
...
function normalizeLegacyNanoBananaSkill(cfg, changes) {
	...
	if (!isRecord$2(rawSkills)) return cfg;
	let next = cfg;
	...
	const legacyEnv = isRecord$2(rawLegacyEntry.env) ? rawLegacyEntry.env : void 0;
	const legacyEnvApiKey = typeof legacyEnv?.GEMINI_API_KEY === "string" ? legacyEnv.GEMINI_API_KEY.trim() : "";
	const legacyApiKey = legacyEnvApiKey || (typeof rawLegacyEntry.apiKey === "string" ? rawLegacyEntry.apiKey.trim() : rawLegacyEntry.apiKey && isRecord$2(rawLegacyEntry.apiKey) ? structuredClone(rawLegacyEntry.apiKey) : void 0);
	const rawModels = isRecord$2(next.models) ? structuredClone(next.models) : {};
	const rawProviders = isRecord$2(rawModels.providers) ? { ...rawModels.providers } : {};
	const rawGoogle = isRecord$2(rawProviders.google) ? { ...rawProviders.google } : {};
...
function normalizeLegacyTalkConfig(cfg, changes) {
	...
	if (!isRecord$2(rawTalk)) return cfg;
	const normalizedTalk = normalizeTalkSection(rawTalk);
	if (!normalizedTalk || isDeepStrictEqual(normalizedTalk, rawTalk)) return cfg;
...
function normalizeLegacyCrossContextMessageConfig(cfg, changes) {
	...
	if (!isRecord$2(rawTools)) return cfg;
	const rawMessage = rawTools.message;
	if (!isRecord$2(rawMessage) || !("allowCrossContextSend" in rawMessage)) return cfg;
	...
	if (legacyAllowCrossContextSend) {
		const rawCrossContext = isRecord$2(nextMessage.crossContext) ? structuredClone(nextMessage.crossContext) : {};
...
function migrateLegacyDeepgramCompat(params) {
	const rawCompat = isRecord$2(params.owner.deepgram) ? structuredClone(params.owner.deepgram) : null;
	if (!rawCompat) return false;
	const compatProviderOptions = mapDeepgramCompatToProviderOptions(rawCompat);
	const currentProviderOptions = isRecord$2(params.owner.providerOptions) ? structuredClone(params.owner.providerOptions) : {};
	const currentDeepgram = isRecord$2(currentProviderOptions.deepgram) ? structuredClone(currentProviderOptions.deepgram) : {};
...
function normalizeLegacyMediaProviderOptions(cfg, changes) {
	...
	if (!isRecord$2(rawMedia)) return cfg;
	...
	for (const capability of [
		...
		const config = isRecord$2(nextMedia[capability]) ? structuredClone(nextMedia[capability]) : null;
		if (!config) continue;
...
function normalizeLegacyMistralModelMaxTokens(cfg, changes) {
	...
	if (!isRecord$2(rawProviders)) return cfg;
	let providersChanged = false;
	const nextProviders = { ...rawProviders };
	for (const [providerId, rawProvider] of Object.entries(rawProviders)) {
		if (normalizeProviderId(providerId) !== "mistral" || !isRecord$2(rawProvider)) continue;
		const rawModels = rawProvider.models;
		if (!Array.isArray(rawModels)) continue;
		let modelsChanged = false;
		const nextModels = rawModels.map((model, index) => {
			if (!isRecord$2(model)) return model;
...
function collectEmptyAllowlistPolicyWarningsForAccount(params) {
	...
	if (params.channelName && shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning({
		account: params.account,
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = findLegacyConfigIssues(snapshot.parsed, snapshot.parsed, listPluginDoctorLegacyConfigRules());
	...
	if (legacyIssueLines.length > 0) note$1(legacyIssueLines.join("\n"), "Legacy config keys detected");
	if (legacyStep.changeLines.length > 0) note$1(legacyStep.changeLines.join("\n"), "Doctor changes");
	if (hasLegacyInternalHookHandlers(snapshot.parsed)) note$1([
	...
	for (const compatibility of collectChannelDoctorCompatibilityMutations(candidate)) {
		if (compatibility.changes.length === 0) continue;
		note$1(compatibility.changes.join("\n"), "Doctor changes");
		({cfg, candidate, pendingChanges, fixHints} = applyDoctorConfigMutation({
			state: {
				cfg,
				candidate,
	...
	for (const staleCleanup of await collectChannelDoctorStaleConfigMutations(candidate)) {
		...
		note$1(staleCleanup.changes.join("\n"), "Doctor changes");
		({cfg, candidate, pendingChanges, fixHints} = applyDoctorConfigMutation({
			state: {
				cfg,
				candidate,
	...
	const mutableAllowlistWarnings = await collectChannelDoctorMutableAllowlistWarnings({ cfg: candidate });
	if (mutableAllowlistWarnings.length > 0) note$1(mutableAllowlistWarnings.join("\n"), "Doctor warnings");
...
//#endregion
//#region src/commands/doctor-auth-anthropic-claude-cli.ts
...
function isClaudeCliProviderId(value) {
...
function resolveTargetProfileId(params) {
	return buildAuthProfileId({
		...
		profileName: trimOptionalString(params.profileConfig?.email) ?? trimOptionalString("email" in (params.credential ?? {}) ? params.credential?.email : void 0)
	});
}
function buildConvertedCredential(credential) {
	if (!credential || !isClaudeCliProviderId(credential.provider)) return;
...
function buildConvertedProfileConfig(params) {
	...
	const email = trimOptionalString(params.profileConfig?.email) ?? trimOptionalString("email" in params.credential ? params.credential.email : void 0);
	const displayName = trimOptionalString(params.profileConfig?.displayName) ?? trimOptionalString("displayName" in params.credential ? params.credential.displayName : void 0);
	return {
		provider: ANTHROPIC_PROVIDER_ID,
		mode,
		...email ? { email } : {},
...
function toAnthropicModelRef(raw) {
	...
	if (!trimmed.toLowerCase().startsWith(`${CLAUDE_CLI_PROVIDER_ID}/`)) return null;
...
function rewriteModelSelection(model) {
	...
	if (Array.isArray(current.fallbacks)) {
		...
		const nextFallbacks = current.fallbacks.map((entry) => typeof entry === "string" ? toAnthropicModelRef(entry) ?? entry : entry);
...
function rewriteModelMap(models) {
	if (!models) return {
		value: models,
		changed: false
	};
...
function rewriteOrderMap(order, replacementProfileId) {
	if (!order) return {
		value: order,
		changed: false
	};
	...
	for (const [provider, profileIds] of Object.entries(order)) {
		...
		if (nextProvider !== provider) changed = true;
		const rewritten = dedupeStrings(profileIds.flatMap((profileId) => {
			if (profileId !== CLAUDE_CLI_PROFILE_ID) return [profileId];
			changed = true;
			return replacementProfileId ? [replacementProfileId] : [];
		}));
		if (rewritten.length === 0) {
			if (profileIds.length > 0) changed = true;
			continue;
		}
		if (rewritten.length !== profileIds.length || rewritten.some((id, index) => id !== profileIds[index])) changed = true;
		next[nextProvider] = next[nextProvider] ? dedupeStrings([...next[nextProvider], ...rewritten]) : rewritten;
	}
	return {
		value: Object.keys(next).length > 0 ? next : void 0,
		changed
	};
}
function rewriteLastGoodMap(lastGood, replacementProfileId) {
	if (!lastGood) return {
		value: lastGood,
		changed: false
	};
	...
	for (const [provider, profileId] of Object.entries(lastGood)) {
		...
		if (nextProvider !== provider || nextProfileId !== profileId) changed = true;
		if (!nextProfileId) continue;
...
function rewriteUsageStatsMap(usageStats, replacementProfileId) {
	...
	if (replacementProfileId && !next[replacementProfileId]) next[replacementProfileId] = stale;
	return {
		value: Object.keys(next).length > 0 ? next : void 0,
		changed: true
	};
}
function rewriteAuthProfilesConfig(profiles, replacementProfileId, replacementProfileConfig) {
	if (!profiles) return {
		value: profiles,
		changed: false
	};
...
function rewriteAnthropicClaudeCliConfig(params) {
	const changes = [];
	const rewrittenProfiles = rewriteAuthProfilesConfig(params.cfg.auth?.profiles, params.replacementProfileId, params.replacementProfileConfig);
	...
	if (rewrittenProfiles.changed) changes.push("removed stale Anthropic Claude CLI auth-profile config");
	if (rewrittenOrder.changed) changes.push("rewrote auth-order references away from Claude CLI");
	if (rewrittenModel.changed || rewrittenModels.changed) changes.push("rewrote claude-cli model refs back to anthropic/*");
	if (changes.length === 0) return {
		next: params.cfg,
		changes
	};
	...
	const nextModel = rewrittenModel.value;
	const nextModels = rewrittenModels.value;
	const nextAuth = nextProfiles || nextOrder || params.cfg.auth?.cooldowns ? {
		...params.cfg.auth,
		...nextProfiles ? { profiles: nextProfiles } : {},
		...nextProfiles === void 0 ? { profiles: void 0 } : {},
		...nextOrder ? { order: nextOrder } : {},
		...nextOrder === void 0 ? { order: void 0 } : {}
	} : void 0;
	const nextDefaults = rewrittenModel.changed || rewrittenModels.changed ? {
		...defaults,
		...rewrittenModel.changed ? { model: nextModel } : {},
		...rewrittenModels.changed ? { models: nextModels } : {}
	} : defaults;
	const nextAgents = nextDefaults && nextDefaults !== defaults ? {
		...params.cfg.agents,
	...
	return {
		next: {
			...params.cfg,
			...nextAuth ? { auth: nextAuth } : { auth: void 0 },
...
async function maybeRepairAnthropicClaudeCliStore(params) {
	...
	await updateAuthProfileStoreWithLock({ updater: (nextStore) => {
		...
		if (staleCredential && isClaudeCliProviderId(staleCredential.provider)) {
			if (params.replacementProfileId && params.replacementCredential) if (nextStore.profiles[params.replacementProfileId]) keptExistingTarget = true;
			else {
		...
		const rewrittenUsageStats = rewriteUsageStatsMap(nextStore.usageStats, params.replacementProfileId);
...
function hasStaleAnthropicClaudeCliConfig(cfg) {
	if (cfg.auth?.profiles) {
		for (const [profileId, profile] of Object.entries(cfg.auth.profiles)) if (profileId === CLAUDE_CLI_PROFILE_ID || isClaudeCliProviderId(profile.provider)) return true;
	}
	if (Object.values(cfg.auth?.order ?? {}).some((profileIds) => profileIds.includes(CLAUDE_CLI_PROFILE_ID))) return true;
	const defaults = cfg.agents?.defaults;
	if (typeof defaults?.model === "string" && defaults.model.startsWith(`${CLAUDE_CLI_PROVIDER_ID}/`) || defaults?.model && typeof defaults.model === "object" && !Array.isArray(defaults.model) && (typeof defaults.model.primary === "string" && defaults.model.primary.startsWith(`${CLAUDE_CLI_PROVIDER_ID}/`) || defaults.model.fallbacks?.some((entry) => typeof entry === "string" && entry.startsWith(`${CLAUDE_CLI_PROVIDER_ID}/`)))) return true;
	if (Object.keys(defaults?.models ?? {}).some((modelId) => modelId.startsWith(`${CLAUDE_CLI_PROVIDER_ID}/`))) return true;
	return false;
}
async function maybeRepairRemovedAnthropicClaudeCliState(cfg, prompter) {
	const staleCredential = ensureAuthProfileStore(void 0, { allowKeychainPrompt: false }).profiles[CLAUDE_CLI_PROFILE_ID];
	const staleProfileConfig = cfg.auth?.profiles?.[CLAUDE_CLI_PROFILE_ID] ?? Object.values(cfg.auth?.profiles ?? {}).find((profile) => isClaudeCliProviderId(profile.provider));
	const replacementCredential = buildConvertedCredential(staleCredential);
	const replacementProfileId = replacementCredential ? resolveTargetProfileId({
	...
	if (!staleConfigDetected && !staleStoreDetected) return cfg;
	note$1([
		"Stale Anthropic Claude CLI state detected.",
		staleStoreDetected ? `- stored credential bytes found under ${CLAUDE_CLI_PROFILE_ID}` : `- no stored credential bytes found for ${CLAUDE_CLI_PROFILE_ID}`,
		"- Claude CLI Anthropic auth is no longer a supported OpenClaw path",
		staleStoreDetected && replacementProfileId ? `- doctor can convert the stored credential to ${replacementProfileId}` : "- doctor can only remove stale config; use an Anthropic API key or setup-token afterward"
	].join("\n"), "Auth profiles");
	if (!await prompter.confirmAutoFix({
		message: staleStoreDetected ? "Convert stale Anthropic Claude CLI auth back to Anthropic profiles and remove Claude CLI config now?" : "Remove stale Anthropic Claude CLI config now? No stored credential bytes were found to convert.",
		initialValue: true
	})) return cfg;
	...
	const rewrittenConfig = rewriteAnthropicClaudeCliConfig({
		cfg,
		replacementProfileId: storeRepair.converted || storeRepair.keptExistingTarget ? replacementProfileId : void 0,
		replacementProfileConfig: storeRepair.converted || storeRepair.keptExistingTarget ? replacementProfileConfig : void 0
	});
	const changes = [];
	if (storeRepair.converted && replacementProfileId) changes.push(`converted ${CLAUDE_CLI_PROFILE_ID} -> ${replacementProfileId}`);
	else if (storeRepair.keptExistingTarget && replacementProfileId) changes.push(`removed ${CLAUDE_CLI_PROFILE_ID} and kept existing ${replacementProfileId}`);
	else if (staleStoreDetected) changes.push(`removed stale stored profile ${CLAUDE_CLI_PROFILE_ID}`);
	changes.push(...rewrittenConfig.changes);
	if (changes.length > 0) note$1(changes.map((line) => `- ${line}`).join("\n"), "Doctor changes");
	if (!storeRepair.converted) note$1([
...
function scanBundledPluginRuntimeDeps(params) {
	...
	return {
		missing: deps.filter((dep) => !fs.existsSync(path.join(params.packageRoot, dependencySentinelPath(dep.name)))),
		conflicts
	};
}
...
async function noteMemoryRecallHealth(cfg) {
	try {
		...
		if (message) note$1(message, "Memory search");
	} catch (err) {
		note$1(`Memory recall audit could not be completed: ${err instanceof Error ? err.message : String(err)}`, "Memory search");
	}
}
async function maybeRepairMemoryRecallHealth(params) {
	try {
		...
		})).issues.some((issue) => issue.fixable)) return;
		if (!await params.prompter.confirmRuntimeRepair({
		...
		note$1(`Memory recall repair could not be completed: ${err instanceof Error ? err.message : String(err)}`, "Memory search");
	}
}
/**
...
function shouldRequireOAuthDir(cfg, env) {
	...
	for (const channelId of listBundledChannelPluginIds()) if (hasBundledChannelPersistedAuthState({
		channelId,
		cfg,
		env
	})) return true;
