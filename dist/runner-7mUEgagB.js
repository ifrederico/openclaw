...
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CRVCy_2Y.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-DOdi-EcR.js";
...
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-Bb4Dm6jL.js";
import { t as providerSupportsCapability } from "./provider-supports-QWa1PSnv.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-D7XwZuJE.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-C-8YHm29.js";
import { t as buildRandomTempFilePath } from "./temp-download-7Db7hQyX.js";
import "./temp-path-y0jrf-U9.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-X96tZZds.js";
import "./shared-XxgPc3c2.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-DRHwiBpJ.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-uKXleyaj.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-K7ANcKrf.js");
