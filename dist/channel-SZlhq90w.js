...
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-CJRBysvf.js";
import { a as createActionGate, f as readNumberParam, g as readStringParam, n as ToolAuthorizationError } from "./common-CA61yuMe.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-C3YAiGHo.js";
import { n as describeAccountSnapshot } from "./account-helpers-BTPCXbCn.js";
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-BalSTcSW.js";
...
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-BSjzQfzH.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-CiTSiN-o.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-CwsUV5uO.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-yJMo07fK.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-EbdaWWKh.js";
import { t as extractToolSend } from "./tool-send-CjGvH77i.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-CSChf1Eb.js";
...
import { n as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-JRKDaSq0.js";
...
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-DhF6pdxG.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-CNOVgj71.js";
import { a as resolveMatrixAccountConfig } from "./account-config-Bv9opGb1.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-tyQe3IDb.js";
import { n as normalizeMatrixUserId } from "./allowlist-ncxPmCKY.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-5M56LZ9j.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-BhGTDarq.js";
import { t as formatMatrixErrorMessage } from "./errors-DMIiRMST.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-9oFJkvlk.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-ByEJ_QIC.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-BTcZRuhc.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-BRFb7_e7.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-BYv-CRbd.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-B4vsBt8v.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-ChH9io2h.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-BZEUlP2H.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-CSkJ1Cyn.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-DUKRoJtk.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-D5qqVI0t.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixDoctor = {
	...
	runConfigSequence: async ({ cfg, env, shouldRepair }) => await (await import("./doctor-Dj2NLFsy.js")).runMatrixDoctorSequence({
		cfg,
		env,
		shouldRepair
	}),
	cleanStaleConfig: async ({ cfg }) => await (await import("./doctor-Dj2NLFsy.js")).cleanStaleMatrixPluginConfig(cfg)
};
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-BEJ5bygy.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
