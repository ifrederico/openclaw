...
import { M as resolveBrowserConfig, Y as redactCdpUrl, f as createBrowserControlContext, m as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, t as fetchBrowserJson } from "./client-fetch-XYkQEgq8.js";
import "./browser-config-runtime-CXZjFS8D.js";
import "./control-auth-2zykptG0.js";
import { t as withTimeout } from "./browser-node-runtime-DbvJd3Vt.js";
import "./browser-security-runtime-CMb_3kMM.js";
import "./session-tab-registry-Bl2r5mCP.js";
import "./server-middleware-Cn053FCv.js";
import "./bridge-server-DdDYELMv.js";
...
async function browserScreenshotAction(baseUrl, opts) {
	return await fetchBrowserJson(withBaseUrl(baseUrl, `/screenshot${buildProfileQuery(opts.profile)}`), {
		method: "POST",
		headers: { "Content-Type": "application/json" },
		body: JSON.stringify({
			targetId: opts.targetId,
...
//#endregion
export { persistBrowserProxyFiles as a, browserPdfSave as c, browserArmFileChooser as d, browserNavigate as f, applyBrowserProxyPaths as i, browserAct as l, normalizeBrowserRequestPath as n, runBrowserProxyCommand as o, browserScreenshotAction as p, resolveRequestedBrowserProfile as r, browserConsoleMessages as s, isPersistentBrowserProfileMutation as t, browserArmDialog as u };
