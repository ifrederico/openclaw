...
import { n as isRich$1, r as theme, t as colorize } from "./theme-BeexRN7S.js";
import { d as resolveAuthStorePathForDisplay, i as loadAuthProfileStoreForRuntime, n as ensureAuthProfileStore } from "./store-HF_Z-jKz.js";
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-gRFfbuWd.js";
import { n as resolveAgentModelPrimaryValue, r as toAgentModelListLike, t as resolveAgentModelFallbackValues } from "./model-input-BvHDuFyu.js";
import { r as normalizeStringEntries } from "./string-normalization-CvImYLpT.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir, s as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-CXWTwwic.js";
import { g as resolveDefaultAgentWorkspaceDir } from "./workspace-DLW8_PFX.js";
import { _ as resolveModelRefFromString, c as modelKey, d as parseModelRef, h as resolveDefaultModelForAgent, i as buildModelAliasIndex, m as resolveConfiguredModelRef } from "./model-selection-BVM4eHHo.js";
...
import { f as readSourceConfigSnapshotForWrite, i as getRuntimeConfig, r as createConfigIO } from "./io-CS2J_l4V.js";
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-C1EhQ2Cz.js";
...
import { o as setRuntimeConfigSnapshot } from "./runtime-snapshot-BQtdTwL2.js";
...
import { d as resolveProfileUnusableUntilForDisplay, i as clearAuthProfileCooldown, n as resolveAuthProfileOrder, t as resolveAuthProfileEligibility } from "./order-CoOjbg-h.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-BQP0rGzW.js";
import { a as upsertAuthProfile, i as setAuthProfileOrder, n as listProfilesForProvider } from "./profiles-DKQdaSwr.js";
import { t as formatCliCommand } from "./command-format-D6RJqoCJ.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-UazeViO92.js";
...
import "./onboard-helpers-CiVaZSUb.js";
import { _ as resolveProviderEnvApiKeyCandidates, u as isNonSecretApiKeyMarker } from "./model-auth-markers-DBBQxeVp.js";
import { t as resolveEnvApiKey } from "./model-auth-env--oAvogL1.js";
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-D5s3-tJn.js";
...
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey, o as hasUsableCustomProviderApiKey, s as resolveApiKeyForProvider } from "./model-auth-BbESr7Je.js";
import { r as describeFailoverError } from "./failover-error-Qb-CdGBo.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-WXkYWliW.js";
import { r as getModelsCommandSecretTargetIds } from "./command-secret-targets-Cx2mAV-T.js";
import { o as resolveUsageProviderId } from "./provider-usage.shared-DCZgLEg2.js";
import { i as formatUsageWindowSummary, t as loadProviderUsageSummary } from "./provider-usage-DKf8xAMK.js";
import { r as resolveModelWithRegistry } from "./model-D9GwM6aS.js";
import { n as shouldSuppressBuiltInModel } from "./model-suppression-UFWYusPX.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, p as upsertCanonicalModelConfigEntry, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-Dpgo97-6.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-RQT4b6MT.js";
import { t as maskApiKey } from "./mask-api-key-CeE37_Ft.js";
import { r as withProgressTotals } from "./progress-Ba3DFrwb.js";
import { n as validateAnthropicSetupToken } from "./provider-auth-token-maECIMpF.js";
import "./provider-auth-login-CC7fCHW_.js";
import { t as createClackPrompter } from "./clack-prompter-TkKxgd3Q.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-B90FoRxa.js";
import { a as isRemoteEnvironment, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-dUpm2Imt.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-CLGyBnNt.js";
import "./list.runtime-Bz4HRDjp.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-B9mfojPf.js";
import { n as redactSecrets } from "./format-fgkIZhcS.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-CKxBFJ2-.js";
...
async function persistProviderAuthResult(params) {
	...
	await updateConfig((cfg) => {
		let next = cfg;
		if (params.result.configPatch) next = applyProviderAuthConfigPatch(next, params.result.configPatch);
...
async function modelsAuthPasteTokenCommand(opts, runtime) {
	...
	const token = provider === "anthropic" ? String(tokenInput ?? "").replaceAll(/\s+/g, "").trim() : String(tokenInput ?? "").trim();
	...
	if (provider === "anthropic") {
		...
		runtime.log("Anthropic told OpenClaw users this path requires Extra Usage on the Claude account.");
	}
}
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore, ensureOpenClawModelsJson } = await import("./list.runtime-Dj1pl025.js");
	...
	const providerFilter = (() => {
		...
		if (!raw) return;
		return parseModelRef(`${raw}/_`, "openai")?.provider ?? raw.toLowerCase();
	})();
	let modelRegistry;
...
function loadEmbeddedRunnerModule() {
	embeddedRunnerModulePromise ??= import("./pi-embedded-DoG0DZ9e.js");
