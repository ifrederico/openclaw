...
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-Cuq36U9C.js";
import { n as resolveGatewayAuth } from "./auth-resolve-CUlf3sC8.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-E69J4lLI.js";
import { _ as setRuntimeConfigSnapshot } from "./runtime-snapshot-DFDX1J4B.js";
import { r as setCurrentPluginMetadataSnapshot, t as clearCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CBe-gKry.js";
import { n as isRestartEnabled } from "./commands.flags-B7qbzmZ1.js";
import { t as loadGatewayTlsRuntime$1 } from "./gateway-CR1hhr5-.js";
import { i as READ_SCOPE, n as APPROVALS_SCOPE, o as WRITE_SCOPE, r as PAIRING_SCOPE } from "./operator-scopes-D9nPeeKf.js";
import "./method-scopes-CXVBHLXE.js";
import { m as setPreRestartDeferralCheck, p as setGatewaySigusr1RestartPolicy } from "./restart-Dd-BFtwl.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-BNUgpUnK.js";
import { b as resolveActivePluginHttpRouteRegistry, d as pinActivePluginChannelRegistry, f as pinActivePluginHttpRouteRegistry, h as releasePinnedPluginHttpRouteRegistry, m as releasePinnedPluginChannelRegistry } from "./runtime-B0MMVyKh.js";
import { i as resolveMainSessionKey } from "./main-session-C7L7pyed.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-ChuwkhCQ.js";
import "./sessions-DEgkNCWw.js";
import { o as getActiveEmbeddedRunCount } from "./run-state-COZ3YHhO.js";
import { g as stopDiagnosticHeartbeat, h as startDiagnosticHeartbeat } from "./diagnostic-DbrcADVi.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-Cg1wuX5x.js";
...
import { r as resolveCronStorePath } from "./store--4w3cgRj.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot } from "./runtime-uCeCLCPX.js";
import { i as CANVAS_HOST_PATH } from "./file-resolver-DZ_3r_Nk.js";
import { t as handleA2uiHttpRequest } from "./a2ui-VUtAzs7_.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-D5DVs9d7.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DSDZt45z.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-CeB90f53.js";
import { t as createDefaultDeps } from "./deps-BvJgAY_2.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-BRbjSCcF.js";
import { n as sendGatewayAuthFailure, o as setDefaultSecurityHeaders } from "./http-common-CxRh-el-.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-DqhtKRzX.js";
import { t as GatewayLockError } from "./gateway-lock-ARBtYsKu.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DvXAsV_z.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-Dv8SE8-N.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-CpGn9QCx.js";
import { i as getRequiredSharedGatewaySessionGeneration, r as enforceSharedGatewaySessionGenerationForConfigWrite } from "./server-shared-auth-generation-CCBEtIaf.js";
import { a as createToolEventRecipientRegistry, n as createChatRunState } from "./server-chat-state-D2oD-CW5.js";
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-CsR1jV9x.js";
import { i as normalizeCanvasScopedUrl } from "./canvas-capability-B7CZkHEQ.js";
import { i as setFallbackGatewayContextResolver } from "./server-plugins-CQNjPpGb.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CsHBpS4X.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-DGNT2c3H.js";
import { t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./server-startup-unavailable-methods-CWtvR4in.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-C2pXV1UU.js";
import { a as resolvePluginRoutePathContext, i as isProtectedPluginRoutePathFromContext, n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-BHe_CkjS.js";
import "./paths-DjlLVbS9.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-Tm09m8iU.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-CDhWLKbZ.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-BcC6Q-Nf.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-Bi0nj-hi.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-B3bNoT7I.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-Cq2OEnDM.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-D0w1tss9.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-BB9MY6Ck.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-DssMeN4V.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-DMwXVYBM.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-Ddfj9DSF.js");
	return toolsInvokeHttpModulePromise;
}
function getVoiceClawRealtimeUpgradeModule() {
	voiceClawRealtimeUpgradeModulePromise ??= import("./upgrade-BNOMg1fo.js");
	return voiceClawRealtimeUpgradeModulePromise;
}
function getCanvasAuthModule() {
	canvasAuthModulePromise ??= import("./http-auth-CfCqxQNp.js");
	return canvasAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-CYDazns1.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-CULroINr.js");
...
async function createGatewayRuntimeState(params) {
	...
	try {
		...
		if (params.canvasHostEnabled) try {
			const { createCanvasHostHandler } = await import("./server-VkQraHMe.js");
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-Bc2H48KD.js");
		...
		const handlePluginRequest = async (req, res, pathContext, dispatchContext) => {
			...
			if (!loadedPluginRequestHandler) {
				const { createGatewayPluginRequestHandler } = await import("./plugins-http-CKr5gWd2.js");
...
async function __resetModelCatalogCacheForTest() {
	const { __resetModelCatalogCacheForTest: resetModelCatalogCacheForTest } = await import("./server-model-catalog-CRcXjReX.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-By7SJZ-9.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-BqBM85eA.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-DE0Zbj3B.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
function getStartupChannelRuntime() {
	cachedStartupChannelRuntimePromise ??= import("./channel-runtime-contexts-jOw1X7dE.js").then(({ createChannelRuntimeContextRegistry }) => ({ runtimeContexts: createChannelRuntimeContextRegistry() }));
	return cachedStartupChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-BGO6nAoH.js");
...
const loadGatewayModelCatalog = async (...args) => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-CRcXjReX.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-Qe9VC4WA.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-Cfm0pmgs.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-DyTZeaAs.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-DzBqfC5e.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-4fxHWoDQ.js");
	...
	const controlUiSeed = minimalTestGateway ? {
		...
		writeConfig: async (nextConfig) => {
			const { replaceConfigFile } = await import("./mutate-D1T13W33.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-BDa4Pt6M.js");
	...
	const { createChannelManager } = await import("./server-channels-BmRP5q1u.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-D6-DyBda.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, gatewayRuntimeServices] = await Promise.all([import("./server-runtime-subscriptions-CSlQ8pNl.js"), import("./server-runtime-services-Ddn-pW8y.js")]);
		...
		const { createGatewayAuxHandlers } = await import("./server-aux-handlers-BiB3S89Z.js");
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-D5bsPB1_.js"),
				import("./server-plugin-bootstrap-DYLFoxwD.js"),
				import("./services-DqAbDrlq.js")
			]);
		...
		const { createGatewayRequestContext } = await import("./server-request-context-D2eARWAW.js");
		...
		if (!minimalTestGateway) {
			if (runtimePluginsLoaded && deferredConfiguredChannelPluginIds.length > 0) {
				const { reloadDeferredGatewayPlugins } = await import("./server-plugin-bootstrap-DYLFoxwD.js");
		...
		const { attachGatewayWsHandlers } = await import("./server-ws-runtime-CFTtKa_2.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-CZp0NUb9.js");
	...
	return { close: async (opts) => {
		try {
			markClosePreludeStarted();
			const { runGlobalGatewayStopSafely } = await import("./hook-runner-global-BMiiOjOf.js");
