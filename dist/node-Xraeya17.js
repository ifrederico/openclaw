...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-gKr3gP1n.js";
...
var require_p_retry = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var CredentialsProviderFactory = class {
		...
		*/
		static create(keyFilePath) {
			switch (path$4.extname(keyFilePath)) {
...
function generateContentConfigToMldev$1(apiClient, fromObject, parentObject) {
	...
	if (getValueByPath(fromObject, ["modelArmorConfig"]) !== void 0) throw new Error("modelArmorConfig parameter is not supported in Gemini API.");
...
function imageConfigToMldev$1(fromObject) {
	...
	if (getValueByPath(fromObject, ["personGeneration"]) !== void 0) throw new Error("personGeneration parameter is not supported in Gemini API.");
...
function createCachedContentConfigToVertex(fromObject, parentObject) {
	...
	const fromSystemInstruction = getValueByPath(fromObject, ["systemInstruction"]);
	if (parentObject !== void 0 && fromSystemInstruction != null) setValueByPath(parentObject, ["systemInstruction"], contentToVertex$2(tContent(fromSystemInstruction)));
	const fromTools = getValueByPath(fromObject, ["tools"]);
	if (parentObject !== void 0 && fromTools != null) {
		let transformedList = fromTools;
		if (Array.isArray(transformedList)) transformedList = transformedList.map((item) => {
...
function partToVertex$2(fromObject) {
	...
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], fromVideoMetadata);
	if (getValueByPath(fromObject, ["toolCall"]) !== void 0) throw new Error("toolCall parameter is not supported in Vertex AI.");
	if (getValueByPath(fromObject, ["toolResponse"]) !== void 0) throw new Error("toolResponse parameter is not supported in Vertex AI.");
	if (getValueByPath(fromObject, ["partMetadata"]) !== void 0) throw new Error("partMetadata parameter is not supported in Vertex AI.");
	return toObject;
}
...
function toolConfigToVertex$1(fromObject) {
	...
	if (getValueByPath(fromObject, ["includeServerSideToolInvocations"]) !== void 0) throw new Error("includeServerSideToolInvocations parameter is not supported in Vertex AI.");
	return toObject;
}
...
function audioTranscriptionConfigToMldev$1(fromObject) {
	const toObject = {};
	if (getValueByPath(fromObject, ["languageCodes"]) !== void 0) throw new Error("languageCodes parameter is not supported in Gemini API.");
	return toObject;
}
...
function liveConnectConfigToMldev$1(fromObject, parentObject) {
	...
	if (getValueByPath(fromObject, ["explicitVadSignal"]) !== void 0) throw new Error("explicitVadSignal parameter is not supported in Gemini API.");
	return toObject;
}
function liveConnectConfigToVertex(fromObject, parentObject) {
	...
	const fromSystemInstruction = getValueByPath(fromObject, ["systemInstruction"]);
	if (parentObject !== void 0 && fromSystemInstruction != null) setValueByPath(parentObject, ["setup", "systemInstruction"], contentToVertex$1(tContent(fromSystemInstruction)));
	const fromTools = getValueByPath(fromObject, ["tools"]);
	if (parentObject !== void 0 && fromTools != null) {
		let transformedList = tTools(fromTools);
		if (Array.isArray(transformedList)) transformedList = transformedList.map((item) => {
...
function replicatedVoiceConfigToVertex$1(fromObject) {
	...
	if (fromVoiceSampleAudio != null) setValueByPath(toObject, ["voiceSampleAudio"], fromVoiceSampleAudio);
	return toObject;
}
...
function speakerVoiceConfigToVertex$1(fromObject) {
	...
	if (fromSpeaker != null) setValueByPath(toObject, ["speaker"], fromSpeaker);
	const fromVoiceConfig = getValueByPath(fromObject, ["voiceConfig"]);
	if (fromVoiceConfig != null) setValueByPath(toObject, ["voiceConfig"], voiceConfigToVertex$1(fromVoiceConfig));
	return toObject;
}
function speechConfigToVertex$1(fromObject) {
	...
	if (fromMultiSpeakerVoiceConfig != null) setValueByPath(toObject, ["multiSpeakerVoiceConfig"], multiSpeakerVoiceConfigToVertex$1(fromMultiSpeakerVoiceConfig));
	return toObject;
}
...
function voiceConfigToVertex$1(fromObject) {
	...
	if (fromReplicatedVoiceConfig != null) setValueByPath(toObject, ["replicatedVoiceConfig"], replicatedVoiceConfigToVertex$1(fromReplicatedVoiceConfig));
	const fromPrebuiltVoiceConfig = getValueByPath(fromObject, ["prebuiltVoiceConfig"]);
	if (fromPrebuiltVoiceConfig != null) setValueByPath(toObject, ["prebuiltVoiceConfig"], fromPrebuiltVoiceConfig);
	return toObject;
}
/**
* @license
...
function countTokensConfigToVertex(fromObject, parentObject, rootObject) {
	const toObject = {};
	const fromSystemInstruction = getValueByPath(fromObject, ["systemInstruction"]);
	if (parentObject !== void 0 && fromSystemInstruction != null) setValueByPath(parentObject, ["systemInstruction"], contentToVertex(tContent(fromSystemInstruction)));
	const fromTools = getValueByPath(fromObject, ["tools"]);
	if (parentObject !== void 0 && fromTools != null) {
		let transformedList = fromTools;
		if (Array.isArray(transformedList)) transformedList = transformedList.map((item) => {
...
function embedContentConfigToVertex(fromObject, parentObject, rootObject) {
	...
	if (discriminatorTaskType === "PREDICT") {
		...
		const fromTaskType = getValueByPath(fromObject, ["taskType"]);
		if (parentObject !== void 0 && fromTaskType != null) setValueByPath(parentObject, ["taskType"], fromTaskType);
	}
	...
	if (discriminatorTitle === "PREDICT") {
		...
		const fromTitle = getValueByPath(fromObject, ["title"]);
		if (parentObject !== void 0 && fromTitle != null) setValueByPath(parentObject, ["title"], fromTitle);
	}
	...
	if (discriminatorOutputDimensionality === "PREDICT") {
		...
		const fromOutputDimensionality = getValueByPath(fromObject, ["outputDimensionality"]);
		if (parentObject !== void 0 && fromOutputDimensionality != null) setValueByPath(parentObject, ["outputDimensionality"], fromOutputDimensionality);
	}
	...
	if (discriminatorAutoTruncate === "PREDICT") {
		...
		const fromAutoTruncate = getValueByPath(fromObject, ["autoTruncate"]);
		if (parentObject !== void 0 && fromAutoTruncate != null) setValueByPath(parentObject, ["autoTruncate"], fromAutoTruncate);
	}
	return toObject;
}
...
function embedContentParametersPrivateToVertex(apiClient, fromObject, rootObject) {
	...
	if (discriminatorContent === "EMBED_CONTENT") {
		const fromContent = getValueByPath(fromObject, ["content"]);
		if (fromContent != null) setValueByPath(toObject, ["content"], contentToVertex(tContent(fromContent)));
	}
	const fromConfig = getValueByPath(fromObject, ["config"]);
...
function generateContentConfigToVertex(apiClient, fromObject, parentObject, rootObject) {
	...
	if (getValueByPath(fromObject, ["serviceTier"]) !== void 0) throw new Error("serviceTier parameter is not supported in Vertex AI.");
	return toObject;
}
...
function speakerVoiceConfigToVertex(fromObject, rootObject) {
	...
	if (fromSpeaker != null) setValueByPath(toObject, ["speaker"], fromSpeaker);
	const fromVoiceConfig = getValueByPath(fromObject, ["voiceConfig"]);
	if (fromVoiceConfig != null) setValueByPath(toObject, ["voiceConfig"], voiceConfigToVertex(fromVoiceConfig));
	return toObject;
}
function speechConfigToVertex(fromObject, rootObject) {
	...
	if (fromLanguageCode != null) setValueByPath(toObject, ["languageCode"], fromLanguageCode);
	const fromMultiSpeakerVoiceConfig = getValueByPath(fromObject, ["multiSpeakerVoiceConfig"]);
	if (fromMultiSpeakerVoiceConfig != null) setValueByPath(toObject, ["multiSpeakerVoiceConfig"], multiSpeakerVoiceConfigToVertex(fromMultiSpeakerVoiceConfig));
	return toObject;
}
...
function voiceConfigToVertex(fromObject, rootObject) {
	const toObject = {};
	const fromReplicatedVoiceConfig = getValueByPath(fromObject, ["replicatedVoiceConfig"]);
	if (fromReplicatedVoiceConfig != null) setValueByPath(toObject, ["replicatedVoiceConfig"], replicatedVoiceConfigToVertex(fromReplicatedVoiceConfig));
	const fromPrebuiltVoiceConfig = getValueByPath(fromObject, ["prebuiltVoiceConfig"]);
	if (fromPrebuiltVoiceConfig != null) setValueByPath(toObject, ["prebuiltVoiceConfig"], fromPrebuiltVoiceConfig);
	return toObject;
}
...
const LIBRARY_LABEL = `google-genai-sdk/1.47.0`;
...
var ApiClient = class {
	constructor(opts) {
		...
		if (this.clientOptions.vertexai) {
			...
			else if (this.clientOptions.project && this.clientOptions.location && this.clientOptions.location === "us") initHttpOptions.baseUrl = `https://aiplatform.${this.clientOptions.location}.rep.googleapis.com/`;
	...
	constructor(apiClient) {
		...
		*/
		this.embedContent = async (params) => {
			if (!this.apiClient.isVertexAI()) return await this.embedContentInternal(params);
		...
		*/
		...
		this.list = async (params) => {
			...
			if (this.apiClient.isVertexAI()) {
				if (!actualParams.config.queryBase) if ((_a = actualParams.config) === null || _a === void 0 ? void 0 : _a.filter) throw new Error("Filtering tuned models list for Vertex AI is not currently supported");
...
const isReadonlyArray = isArrayInternal;
...
*/
const path$2 = /* @__PURE__ */ createPathTagFunction(encodeURIPath);
/**
* @license
* Copyright 2025 Google LLC
* SPDX-License-Identifier: Apache-2.0
...
var BaseInteractions = class extends APIResource {
	create(params, options) {
		...
		return this._client.post(path$2`/${api_version}/interactions`, Object.assign(Object.assign({ body }, options), { stream: (_a = params.stream) !== null && _a !== void 0 ? _a : false }));
	}
	/**
	...
	*/
	delete(id, params = {}, options) {
		...
		return this._client.delete(path$2`/${api_version}/interactions/${id}`, options);
	}
	/**
	...
	*/
	cancel(id, params = {}, options) {
		const { api_version = this._client.apiVersion } = params !== null && params !== void 0 ? params : {};
		return this._client.post(path$2`/${api_version}/interactions/${id}/cancel`, options);
	}
	get(id, params = {}, options) {
		var _a;
		const _b = params !== null && params !== void 0 ? params : {}, { api_version = this._client.apiVersion } = _b, query = __rest(_b, ["api_version"]);
		return this._client.get(path$2`/${api_version}/interactions/${id}`, Object.assign(Object.assign({ query }, options), { stream: (_a = params === null || params === void 0 ? void 0 : params.stream) !== null && _a !== void 0 ? _a : false }));
	}
};
...
const readEnv = (env) => {
	var _a, _b, _c, _d, _e, _f;
	if (typeof globalThis.process !== "undefined") return (_c = (_b = (_a = globalThis.process.env) === null || _a === void 0 ? void 0 : _a[env]) === null || _b === void 0 ? void 0 : _b.trim()) !== null && _c !== void 0 ? _c : void 0;
...
var BaseGeminiNextGenAPIClient = class BaseGeminiNextGenAPIClient {
	...
	*/
	...
	async authHeaders(opts) {
		...
		if (this.clientAdapter.isVertexAI()) return buildHeaders([await this.clientAdapter.getAuthHeaders()]);
	}
	/**
	* Basic re-implementation of `qs.stringify` for primitive types.
	*/
...
function createTuningJobConfigToMldev(fromObject, parentObject, _rootObject) {
	...
	if (getValueByPath(fromObject, ["tuningMode"]) !== void 0) throw new Error("tuningMode parameter is not supported in Gemini API.");
	if (getValueByPath(fromObject, ["customBaseModel"]) !== void 0) throw new Error("customBaseModel parameter is not supported in Gemini API.");
	...
	if (getValueByPath(fromObject, ["baseTeacherModel"]) !== void 0) throw new Error("baseTeacherModel parameter is not supported in Gemini API.");
	if (getValueByPath(fromObject, ["tunedTeacherModelSource"]) !== void 0) throw new Error("tunedTeacherModelSource parameter is not supported in Gemini API.");
	if (getValueByPath(fromObject, ["sftLossWeightMultiplier"]) !== void 0) throw new Error("sftLossWeightMultiplier parameter is not supported in Gemini API.");
	if (getValueByPath(fromObject, ["outputUri"]) !== void 0) throw new Error("outputUri parameter is not supported in Gemini API.");
	if (getValueByPath(fromObject, ["encryptionSpec"]) !== void 0) throw new Error("encryptionSpec parameter is not supported in Gemini API.");
	return toObject;
}
...
function tuningJobFromVertex(fromObject, _rootObject) {
	...
	if (fromDistillationSpec != null) setValueByPath(toObject, ["distillationSpec"], fromDistillationSpec);
	...
	if (fromDistillationSamplingSpec != null) setValueByPath(toObject, ["distillationSamplingSpec"], fromDistillationSamplingSpec);
...
var NodeUploader = class {
	...
	async upload(file, uploadUrl, apiClient, httpOptions) {
		if (typeof file === "string") return await this.uploadFileFromPath(file, uploadUrl, apiClient, httpOptions);
		else return uploadBlob(file, uploadUrl, apiClient, httpOptions);
	}
	async uploadToFileSearchStore(file, uploadUrl, apiClient, httpOptions) {
		if (typeof file === "string") return await this.uploadFileToFileSearchStoreFromPath(file, uploadUrl, apiClient, httpOptions);
		else return uploadBlobToFileSearchStore(file, uploadUrl, apiClient, httpOptions);
	}
	/**
...
var NodeFiles = class extends Files {
	...
	*/
	async registerFiles(params) {
		if (typeof process === "undefined" || !process.versions || !process.versions.node) throw new Error("registerFiles is only supported in Node.js environments.");
		const authHeaders = await params.auth.getRequestHeaders();
		const config = params.config || {};
		const httpOptions = config.httpOptions || {};
		const headers = Object.assign({}, httpOptions.headers || {});
		if (authHeaders) if (typeof authHeaders[Symbol.iterator] === "function") for (const [key, value] of authHeaders) headers[key] = value;
		else for (const [key, value] of Object.entries(authHeaders)) headers[key] = value;
...
var GoogleGenAI = class {
	get interactions() {
		...
		this._interactions = new GeminiNextGenAPIClient({
