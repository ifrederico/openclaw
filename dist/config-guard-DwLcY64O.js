import { F as shouldMigrateStateFromPath } from "./logger-C-bijuBQ.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-toiS0jsP.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-CG9D3oUM.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		import("./theme-Bc_OLqli.js"),
		import("./utils-Dkl18RZX.js"),
		import("./command-format-BQKy5OF5.js")
	]);
	const rich = isRich();
