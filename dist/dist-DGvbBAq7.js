...
import { t as require_lib } from "./lib-Dth9Atb8.js";
import { t as require_http } from "./http-BH65ftYP.js";
...
var require_meeting$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var MeetingClient = class {
		...
		async getById(id) {
			return (await this.http.get(`${this.serviceUrl}/v1/meetings/${id}`)).data;
		}
		async getParticipant(meetingId, id) {
			return (await this.http.get(`${this.serviceUrl}/v1/meetings/${meetingId}/participants/${id}`)).data;
		}
	};
