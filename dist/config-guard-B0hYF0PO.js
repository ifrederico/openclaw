import { M as readConfigFileSnapshot, Yo as shouldMigrateStateFromPath } from "./env-D1ktUnAV.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-ToUBx10M.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-BCbrBpqi.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		import("./theme-DA-pEMqD.js"),
		import("./utils-CBuP0bhr.js"),
		import("./command-format-CdNM9pbC.js")
	]);
	const rich = isRich();
