...
import { t as removePluginFromConfig } from "./uninstall-FTsv7VDE.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-yi9R7gyc.js";
import { s as resolveMatrixAccountConfig } from "./config-paths-CoaCuevd.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-CA9DbuWr.js";
import "./runtime-api-F7BKl-oB.js";
import { c as shouldSuppressLocalMatrixExecApprovalPrompt, l as normalizeMatrixAllowList, n as resolveMatrixRoomConfig, r as matrixApprovalCapability, t as resolveMatrixStoredSessionMeta, u as normalizeMatrixUserId } from "./session-store-metadata-Dajkgu5F.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-DO50q16q.js";
import { a as detectLegacyMatrixState, i as autoMigrateLegacyMatrixState, n as hasPendingMatrixMigration, o as autoPrepareLegacyMatrixCrypto, r as maybeCreateMatrixMigrationSnapshot, s as detectLegacyMatrixCrypto, t as hasActionableMatrixMigration } from "./runtime-heavy-api-DNe9ejet.js";
import "./matrix-migration.runtime-CkW_5e_D.js";
...
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries, t as matrixOnboardingAdapter } from "./setup-surface-lAQx-IFH.js";
import { a as resolveSingleAccountPromotionTarget, i as namedAccountPromotionKeys, o as singleAccountKeysToMove, t as matrixSetupAdapter } from "./setup-core-C4se3vXA.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-BX6mvcul.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel2.runtime-BdHQxeSk.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-Dsj2mNtt.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
