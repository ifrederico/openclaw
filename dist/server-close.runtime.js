...
import { n as closePluginStateSqliteStore } from "./plugin-state-store-B1vkXITa.js";
import { i as listChannelPlugins } from "./registry-BkuUNjzB.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./pi-bundle-lsp-runtime-CqoqdWPg.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-DKZt_gLq.js");
