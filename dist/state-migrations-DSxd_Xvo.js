...
import { _ as resolveStateDir, h as resolveOAuthDir, m as resolveNewStateDir, p as resolveLegacyStateDirs } from "./paths-yyDPxM31.js";
import { c as normalizeAgentId, l as normalizeMainKey, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, w as parseAgentSessionKey } from "./session-key-BR3Z-ljs.js";
import { m as resolveDefaultAgentId } from "./agent-scope-CXWTwwic.js";
import { n as iterateBootstrapChannelPlugins, r as listBundledChannelPlugins } from "./bootstrap-registry-DSG7nIY1.js";
import { o as saveSessionStore } from "./store-C1XtW9hV.js";
...
function canonicalizeSessionKeyForAgent(params) {
	...
	for (const surface of getLegacySessionSurfaces()) {
		...
		if (typeof canonicalized === "string" && canonicalized.trim()) return canonicalized.trim().toLowerCase();
	}
	const lower = raw.toLowerCase();
	if (lower.startsWith("group:") || lower.startsWith("channel:")) return `agent:${agentId}:unknown:${raw}`.toLowerCase();
