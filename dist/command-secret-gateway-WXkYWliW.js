...
import { r as resolveManifestContractOwnerPluginId } from "./manifest-registry-Cqdpf6fh.js";
import { d as resolveSecretInputRef } from "./types.secrets-BZdSA8i7.js";
import { t as describeUnknownError } from "./shared-BTjsck-6.js";
import { a as resolveSecretRefValue } from "./resolve-D4yyG1J7.js";
import { Et as validateSecretsResolveResult } from "./method-scopes-D4ep-GlN.js";
import { r as callGateway } from "./call-CEzBPW9Z.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-BIxqlTpH.js";
import { d as assertExpectedResolvedSecretValue, i as createResolverContext } from "./runtime-config-collectors-tts-B43VyFVH.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-4ZVRjB-K.js";
import { i as collectConfigAssignments, s as analyzeCommandSecretAssignmentsFromSnapshot, t as resolveRuntimeWebTools } from "./runtime-web-tools-DNguyGIc.js";
...
function describeInactiveRuntimeWebTargetPath(params) {
	...
	if (pluginId) {
		...
		const configuredProvider = typeof search?.provider === "string" ? search.provider.trim().toLowerCase() : "";
		const configuredPluginId = configuredProvider ? resolveManifestContractOwnerPluginId({
			contract: "webSearchProviders",
			value: configuredProvider,
			origin: "bundled",
			config: params.config
