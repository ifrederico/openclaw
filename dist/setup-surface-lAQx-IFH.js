...
import { n as requiresExplicitMatrixDefaultAccount, o as getMatrixScopedEnvVarNames } from "./account-selection-yi9R7gyc.js";
import { s as resolveMatrixAccountConfig, t as resolveMatrixConfigFieldPath } from "./config-paths-CoaCuevd.js";
...
import { n as moveSingleMatrixAccountConfigToNamedAccount, r as resolveMatrixEnvAuthReadiness } from "./setup-core-C4se3vXA.js";
import { t as updateMatrixAccountConfig } from "./config-update-DeGV9gWU.js";
import { c as validateMatrixHomeserverUrl, s as resolveValidatedMatrixHomeserverUrl } from "./config-T3IZ6LWB.js";
import "./client-W3ob5qxk.js";
import { n as listMatrixDirectoryGroupsLive, t as resolveMatrixTargets } from "./resolve-targets-DLMQm0DA.js";
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-CdHSev1e.js");
