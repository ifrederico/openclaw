...
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-CZsv8fpj.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-Dx6Bpz-W.js"));
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-CrpNhsOZ.js");
