...
import { t as require_src } from "./src-C-Zgfhn5.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-BpqxjEpR.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-CC0UiKSR.js";
import { l as toRatio, n as decodeString } from "./Util-ChnhO9OA.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-IZZ6NXcY.js";
import { t as APEv2Parser } from "./APEv2Parser-DWsaLyLV.js";
import { r as hasID3v1Header } from "./ID3v1Parser-DYl479WB.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-B3nlVQDm.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-DYPux1YP.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-BHpi8f03.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BHaUQvlV.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-BMSclaZk.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BqNZfwc6.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-bw2wDYaD.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-DP0Tm6nt.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-nbK1sRHc.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-D4vFWm2B.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser--8P_qrsr.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-qCDYKz3H.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-C5z6IK1v.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BdOw7WjS.js")).WaveParser;
	}
};
//#endregion
