...
import { jv as resolveMentionGatingWithBypass, my as resolveInboundRouteEnvelopeBuilderWithRuntime } from "./pi-embedded-DhFkhMap.js";
...
import { o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-3Jdbvvlm.js";
...
import { a as resolveWebhookTargetWithAuthOrReject, c as withResolvedWebhookRequestPipeline, n as registerWebhookTargetWithPluginRoute, x as readJsonWebhookBodyOrReject, y as createWebhookInFlightLimiter } from "./webhook-ingress-CwnvXQ9i.js";
...
import "./googlechat-CoEsOKd1.js";
import "./jws-hwqout2g.js";
import "./runtime-api-DnJKKl9W.js";
import "./json-bigint-B7ZvqTpv.js";
import { c as sendGoogleChatMessage, d as verifyGoogleChatRequest, i as downloadGoogleChatMedia, l as updateGoogleChatMessage, n as deleteGoogleChatMessage, s as probeGoogleChat, u as uploadGoogleChatAttachment } from "./api-BRxcn8zW.js";
import { t as getGoogleChatRuntime } from "./runtime-6e-ZqrRh.js";
...
function resolveGroupConfig(params) {
	...
	let entry = [
		...
		groupName ?? "",
		normalizedName ?? ""
	].filter(Boolean).map((candidate) => entries[candidate]).find(Boolean);
	if (!entry && normalizedName) entry = entries[normalizedName];
...
async function uploadAttachmentForReply(params) {
	...
	const { uploadGoogleChatAttachment } = await import("./api-ZF2HEWMH.js");
