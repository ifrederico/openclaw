...
import { h as resolveModelRefFromString, i as buildModelAliasIndex } from "./model-selection-shared-DOxyWoaQ.js";
import { o as resolveDefaultModelForAgent } from "./model-selection-u8IQheQP.js";
import { n as applyLocalNoAuthHeaderOverride, r as getApiKeyForModel } from "./model-auth-CunBH4hV.js";
import { n as resolveModelAsync, t as resolveModel } from "./model-f6pqrkVH.js";
import { t as prepareModelForSimpleCompletion } from "./simple-completion-transport-CvMIn-TU.js";
...
async function setRuntimeApiKeyForCompletion(params) {
	if (params.model.provider === "github-copilot") {
		const { resolveCopilotApiToken } = await import("./github-copilot-token-DvlEyvAH.js");
