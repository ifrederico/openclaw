...
if (!isMainModule({
	...
	const { installGaxiosFetchCompat } = await import("./gaxios-fetch-compat-DUK-293x.js");
...
function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	import("./root-help-bLqDmU9H.js").then(({ outputRootHelp }) => {
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-BTPgnbfv.js").then(({ runCli }) => runCli(argv)).catch((error) => {
