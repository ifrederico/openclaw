...
import { N as isRootHelpInvocation, P as isRootVersionInvocation, j as hasHelpOrVersion } from "./logger-C-bijuBQ.js";
import { a as parseCliContainerArgs, n as applyCliProfileEnv, o as resolveCliContainerTarget, r as parseCliProfileArgs, t as normalizeWindowsArgv } from "./windows-argv-DuNiH0yF.js";
...
import { t as ensureOpenClawExecMarkerOnProcess } from "./openclaw-exec-env-C0Uz7DaS.js";
...
if (!isMainModule({
	...
	const { installGaxiosFetchCompat } = await import("./gaxios-fetch-compat-ZZWjQXyr.js");
	...
	function tryHandleRootVersionFastPath(argv) {
		...
		Promise.all([import("./version-D6Q9DSv_.js"), import("./git-commit-Di8Seljc.js")]).then(([{ VERSION }, { resolveCommitHash }]) => {
...
function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	import("./root-help-metadata-R8Nn5KNd.js").then(async ({ outputPrecomputedRootHelpText }) => {
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-CuCei2nf.js").then(({ runCli }) => runCli(argv)).catch((error) => {
