...
import { t as CONFIG_PATH } from "./paths-yyDPxM31.js";
import { t as isBlockedObjectKey } from "./prototype-keys-DxnN-2X5.js";
import { n as info, o as success, t as danger } from "./globals-B43CpcZo.js";
import { _ as collectUnsupportedSecretRefPolicyIssues, l as readConfigFileSnapshot, y as validateConfigObjectRaw } from "./io-CS2J_l4V.js";
import { C as SecretProviderSchema } from "./zod-schema.core-BITC5-JP.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-BZdSA8i7.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-ho6SSF_R.js";
import { r as replaceConfigFile } from "./config-dzPpvDz6.js";
import { a as resolveSecretRefValue } from "./resolve-D4yyG1J7.js";
import { t as formatCliCommand } from "./command-format-D6RJqoCJ.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-Cr3dE6oM.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-4ZVRjB-K.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-Cg0ZbD2O.js";
import { n as setCommandJsonMode } from "./json-mode-C4x-8Jl6.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-DTVOg0DV.js");
