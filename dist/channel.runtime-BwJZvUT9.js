...
import { Ba as normalizeE164, Do as defaultRuntime, Ga as resolveUserPath, O as loadConfig, Ra as isSelfChatMode, Va as pathExists, Wa as resolveJidToE164, Ya as sleep, Za as toWhatsappJid, Zi as logInfo, ao as success, eo as danger, io as shouldLogVerbose, ka as clamp, no as logVerbose, o as createSubsystemLogger, to as info, uo as getChildLogger, za as jidToE164 } from "./env-D1ktUnAV.js";
import { _ as normalizeAccountId, a as buildGroupHistoryKey, c as normalizeAgentId, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-CYZxn_Kd.js";
import { t as formatDocsLink } from "./links-DaR1j_Bv.js";
import { t as redactIdentifier } from "./redact-identifier-BiwwDfOa.js";
import { t as formatCliCommand } from "./command-format-CCyUqeuM.js";
import { W as resolveGroupSessionKey, g as recordSessionMetaFromInbound, m as loadSessionStore, y as updateLastRoute } from "./sessions-uRDRs4f-.js";
import { l as resolveStorePath } from "./paths-BEHCHyAI.js";
import { o as resolveIdentityNamePrefix, s as resolveMessagePrefix } from "./identity-xGthCqY8.js";
import { $t as getComparableIdentityValues, Av as resolveMentionGating, Bt as getWebAuthAgeMs$1, Dv as resolveInboundSessionEnvelopeContext, Ht as logWebSelfId$1, Hv as formatInboundEnvelope, It as resolveWhatsAppAccount, Jt as readWebSelfIdentity, Lt as resolveWhatsAppAuthDir, Lv as shouldComputeCommandAuthorized, Nt as listWhatsAppAccountIds, Ov as formatLocationText, Pv as hasControlCommand, Ql as dispatchReplyWithBufferedBlockDispatcher, Qt as webAuthExists$1, Rt as resolveWhatsAppMediaMaxBytes, Sb as recordChannelActivity, Ut as logoutWeb$1, an as identitiesOverlap, bf as parseActivationCommand, en as getMentionIdentities, gy as resolveInboundDebounceMs, hy as createInboundDebouncer, in as getSenderIdentity, ju as getReplyFromConfig, kv as toLocationContext, nn as getReplyContext, on as resolveComparableIdentity, qt as readWebSelfId$1, rn as getSelfIdentity, tn as getPrimaryIdentityId, yf as normalizeGroupActivation } from "./pi-embedded-DhFkhMap.js";
...
import { E as resolveTextChunkLimit, S as chunkMarkdownTextWithMode, T as resolveChunkMode, m as convertMarkdownTables, p as markdownToWhatsApp } from "./text-runtime-Cbjdi5n6.js";
...
import { a as migrateBaseNameToDefaultAccount, t as applyAccountNameToChannelSection } from "./setup-helpers-CLiDrlXo.js";
...
import { O as normalizeAllowFromEntries, rt as setSetupChannelEnabled, st as splitSetupEntries } from "./setup-wizard-proxy-3tbzVvIf.js";
import { a as resolveDmGroupAccessWithCommandGate, c as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-3Jdbvvlm.js";
...
import { d as resolveOutboundMediaUrls, h as sendMediaWithLeadingCaption, p as resolveSendableOutboundReplyParts } from "./reply-payload-DgkHZodm.js";
...
import { f as buildMentionRegexes, h as normalizeMentionText, r as buildHistoryContextFromEntries, u as recordPendingHistoryEntryIfEnabled } from "./reply-history-CYr7j6cE.js";
import { m as saveMediaBuffer } from "./client-fetch-BpnVLZgl.js";
import { i as assertLocalMediaAllowed, r as LocalMediaAccessError, s as fetchRemoteMedia, u as getAgentScopedMediaLocalRoots } from "./web-media-B7RZCKik.js";
import { n as normalizePollInput } from "./polls-CAYm9rBH.js";
import { r as shouldAckReactionForWhatsApp } from "./ack-reactions-C142ljS_.js";
import { t as waitForever } from "./cli-runtime-CivyfPOe.js";
import { n as createConnectedChannelStatusPatch } from "./gateway-runtime-_5BLwTPa.js";
import { i as setActiveWebListener, n as requireActiveWebListener, t as getActiveWebListener$1 } from "./active-listener-vCAxfRQM.js";
import { a as waitForWaConnection, c as downloadMediaMessage, d as normalizeMessageContent, f as isJidGroup, i as waitForCredsSaveQueueWithTimeout, l as extractMessageContent, o as formatError, p as DisconnectReason, s as getStatusCode, t as createWaSocket, u as getContentType } from "./session-DyuDcSD_.js";
...
function loadWhatsAppLoginQr() {
	loginQrPromise ??= import("./login-qr-CPOrMi4E.js");
