...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-CL51SR4g.js";
...
import { d as ssrfPolicyFromDangerouslyAllowPrivateNetwork, o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-C397I3Ir.js";
import "./ssrf-runtime-BFVSngaE.js";
import "./retry-runtime-Bu-oaOTa.js";
import "./secret-input-runtime-XsBh4yhx.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-CNOVgj71.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-CMrAdQHx.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-Bv9opGb1.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-CF5bnZ21.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-CkalHleB.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-BRSsaPRA.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-Ba1FTd9q.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-C537LdxQ.js"), import("./logging-B1T66bTz.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BfuyByoK.js").then((credentialsReadModule) => ({
