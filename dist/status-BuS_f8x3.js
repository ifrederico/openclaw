...
import { n as getNodeDaemonStatusSummary, t as getDaemonStatusSummary } from "./status.daemon-DHbVbKlj.js";
import "./status.summary-CRV8rWSE.js";
...
function loadSecurityAuditModule() {
	securityAuditModulePromise ??= import("./audit.runtime-JkemZQ9m.js");
...
function loadStatusScanModule() {
	statusScanModulePromise ??= import("./status.scan-BYdPYuEf.js");
	return statusScanModulePromise;
}
function loadStatusScanFastJsonModule() {
	statusScanFastJsonModulePromise ??= import("./status.scan.fast-json-C-yVEJOZ.js");
	return statusScanFastJsonModulePromise;
}
function loadStatusAllModule() {
	statusAllModulePromise ??= import("./status-all-BXWKRh0I.js");
	return statusAllModulePromise;
}
function loadStatusCommandTextRuntime() {
	statusCommandTextRuntimePromise ??= import("./status.command.text-runtime-3gYlLCYP.js");
	return statusCommandTextRuntimePromise;
}
function loadStatusNodeModeModule() {
	statusNodeModeModulePromise ??= import("./status.node-mode-B9-llRkN.js");
