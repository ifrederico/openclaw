import { Qa as truncateUtf16Safe, no as logVerbose } from "./env-D1ktUnAV.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-CYZxn_Kd.js";
import { ES as extractAssistantText, Jr as normalizeDiscordAllowList, Xi as ChannelType, Xr as resolveDiscordAllowListMatch, Zl as createReplyReferencePlanner, aa as StickerFormatType, ar as sendVoiceMessageDiscord, bi as createDiscordRetryRunner, ci as formatDiscordUserTag, iC as prepareSimpleCompletionModelForAgent, ia as Routes, nC as completeWithPreparedSimpleCompletionModel, nr as sendMessageDiscord, or as sendWebhookMessageDiscord, ri as resolveDiscordOwnerAllowFrom, ui as resolveTimestampMs, wC as resolveDiscordAccount, xi as chunkDiscordTextWithMode, zr as sendDiscordText } from "./pi-embedded-DhFkhMap.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-C5Xj9lGN.js";
...
import { m as convertMarkdownTables } from "./text-runtime-Cbjdi5n6.js";
...
import { l as resolveCommandAuthorizedFromAuthorizers, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-3Jdbvvlm.js";
import { u as resolveChannelModelOverride } from "./config-runtime-BMqUsOKJ.js";
import { h as sendMediaWithLeadingCaption, m as resolveTextChunksWithFallback, p as resolveSendableOutboundReplyParts, x as buildMediaPayload } from "./reply-payload-DgkHZodm.js";
import { s as wrapExternalContent } from "./external-content-BtOAY1jC.js";
...
import { s as fetchRemoteMedia } from "./web-media-B7RZCKik.js";
...
//#endregion
export { buildDiscordMediaPayload as C, resolveDiscordMessageText as D, resolveDiscordMessageChannelId as E, resolveForwardedMediaList as O, buildDiscordInboundAccessContext as S, resolveDiscordChannelInfo as T, buildGuildLabel as _, handleDiscordDmCommandDecision as a, resolveDiscordWebhookId as b, resolveDiscordAutoThreadReplyPlan as c, resolveDiscordThreadChannel as d, resolveDiscordThreadParentInfo as f, buildDirectLabel as g, deliverDiscordReply as h, resolveDiscordEffectiveRoute as i, resolveMediaList as k, resolveDiscordReplyDeliveryPlan as l, sanitizeDiscordThreadName as m, resolveDiscordBoundConversationRoute as n, resolveDiscordDmCommandAccess as o, resolveDiscordThreadStarter as p, resolveDiscordConversationRoute as r, sendTyping as s, buildDiscordRoutePeer as t, resolveDiscordReplyTarget as u, resolveReplyContext as v, hasDiscordMessageStickers as w, buildDiscordGroupSystemPrompt as x, resolveDiscordSenderIdentity as y };
