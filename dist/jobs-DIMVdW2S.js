...
import { t as getLoadedChannelPluginForRead } from "./registry-loaded-read-BaloxaH0.js";
import { a as normalizeTargetForProvider } from "./target-normalization-CObQTGpA.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CEHMsNAM.js";
import { i as normalizeRequiredName, n as normalizeOptionalAgentId, r as normalizePayloadToSystemText } from "./normalize-Dk30Nk_g.js";
...
import { n as resolveOutboundTargetWithPlugin, t as resolveSessionDeliveryTarget } from "./targets-session-X5GCN7JM.js";
import { t as parseExplicitTargetForLoadedChannel } from "./target-parsing-loaded-B0tSB1Ut.js";
import { n as computeNextRunAtMs, r as computePreviousRunAtMs, t as coerceFiniteScheduleNumber } from "./schedule-C6nnR4tn.js";
...
function isPendingErrorBackoffSlot(params) {
	...
	if (job.state.lastStatus !== "error" || !isFiniteTimestamp(job.state.lastRunAtMs)) return false;
	...
	const backoffFloor = job.state.lastRunAtMs + lastDurationMs + errorBackoffMs(consecutiveErrors, state.deps.cronConfig?.retry?.backoffMs ?? DEFAULT_ERROR_BACKOFF_SCHEDULE_MS);
