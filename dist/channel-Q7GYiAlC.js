...
import { o as stripChannelTargetPrefix, r as createChatChannelPlugin, s as stripTargetKindPrefix, t as buildChannelOutboundSessionRoute } from "./core-DzCPHG4M.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-Kb2g1MkO.js";
import { s as resolveMatrixAccountConfig } from "./config-paths-BYr6c1ee.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-d7NKgzPL.js";
import "./runtime-api-DyGypntr.js";
import { n as normalizeMatrixAllowList, r as normalizeMatrixUserId, t as resolveMatrixRoomConfig } from "./rooms-B_wXLtTt.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-D2oMmsXL.js";
import { f as setMatrixThreadBindingMaxAgeBySessionKey, u as setMatrixThreadBindingIdleTimeoutBySessionKey } from "./thread-bindings-shared-Dd7u4t0I.js";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-DrvJzrGZ.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CQbpu3Rg.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-DhWU8nJa2.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
