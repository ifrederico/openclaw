...
import { s as hasConfiguredSecretInput } from "./types.secrets-CL51SR4g.js";
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-Bj7l9NI7.js";
import { L as requireOpenAllowFrom, h as MarkdownConfigSchema, l as GroupPolicySchema, n as BlockStreamingCoalesceSchema, o as DmPolicySchema } from "./zod-schema.core-B8hU4HYi.js";
...
import { c as normalizeMessagePresentation, l as presentationToInteractiveReply, u as renderMessagePresentationFallbackText } from "./payload-Ojv8hlch.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-lsreEzCY.js";
import { s as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-C3YAiGHo.js";
import "./text-runtime-BMYQWTAu.js";
import { n as describeAccountSnapshot } from "./account-helpers-BTPCXbCn.js";
import { a as createSetupInputPresenceValidator, n as applySetupAccountConfigPatch, s as migrateBaseNameToDefaultAccount, t as applyAccountNameToChannelSection } from "./setup-helpers-CuZobs-u.js";
import { d as stripTargetKindPrefix, i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-DHPyYUWl.js";
import "./channel-core-DqHfnd3q.js";
import { r as buildSecretInputSchema } from "./secret-input-BP7EccAI.js";
import { t as createAccountStatusSink } from "./channel-lifecycle.core-BcJ10WSB.js";
import { n as formatNormalizedAllowFromEntries } from "./allow-from-CXjiWuE7.js";
import { n as createDangerousNameMatchingMutableAllowlistWarningCollector, r as createRestrictSendersChannelSecurity } from "./channel-policy-BSjzQfzH.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-CiTSiN-o.js";
import { f as createStandardChannelSetupStatus } from "./setup-wizard-helpers-BBdrHBUV.js";
import { r as createLoggedPairingApprovalNotifier } from "./channel-pairing-D3GB9vDi.js";
...
import "./setup-runtime-DKWe3_eZ.js";
...
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-C397I3Ir.js";
import "./ssrf-runtime-BFVSngaE.js";
import { t as chunkTextForOutbound } from "./text-chunking-UnppYSLN.js";
import { n as buildPassiveProbedChannelStatusSummary } from "./extension-shared-DUYXCIBS.js";
import "./channel-config-primitives-BICyGUyi.js";
import "./channel-lifecycle-Bu26e0v-.js";
import { t as zod_exports } from "./zod-ZgVdNYVh.js";
import { g as normalizeMattermostBaseUrl, i as resolveMattermostReplyToMode, n as resolveDefaultMattermostAccountId, r as resolveMattermostAccount, t as listMattermostAccountIds } from "./accounts-Dnickpu3.js";
import { t as resolveMattermostGatewayAuthBypassPaths } from "./gateway-auth-bypass-CRBI3V9m.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-CI9Jyom8.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-DB2EneXR.js";
...
const MattermostGroupSchema = zod_exports.z.object({ 
/** Whether mentions are required to trigger the bot in this group. */
requireMention: zod_exports.z.boolean().optional() }).strict();
...
const MattermostNetworkSchema = zod_exports.z.object({ 
...
const MattermostStreamingModeSchema = zod_exports.z.enum([
	"off",
	"partial",
	"block",
	"progress"
]);
const MattermostStreamingProgressSchema = zod_exports.z.object({
...
const MattermostStreamingPreviewSchema = zod_exports.z.object({ toolProgress: zod_exports.z.boolean().optional() }).strict();
const MattermostStreamingBlockSchema = zod_exports.z.object({
	enabled: zod_exports.z.boolean().optional(),
	coalesce: BlockStreamingCoalesceSchema.optional()
}).strict();
const MattermostStreamingSchema = zod_exports.z.union([
	MattermostStreamingModeSchema,
	zod_exports.z.boolean(),
	zod_exports.z.object({
...
const loadMattermostChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-CoaRliFd.js"));
