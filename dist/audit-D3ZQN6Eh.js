...
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-D0EEaUh1.js";
...
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-hfPTaZtK.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-D6VluJ3Q.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-VwVa1ZRs.js");
