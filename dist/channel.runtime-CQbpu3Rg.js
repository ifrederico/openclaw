...
import { n as resolveMatrixAuth } from "./config-DIIOT5nc.js";
import "./client-BuaGRU7F.js";
import { n as listMatrixDirectoryGroupsLive, r as listMatrixDirectoryPeersLive, t as resolveMatrixTargets } from "./resolve-targets-C_JNXdUS.js";
import { a as sendMessageMatrix, o as sendPollMatrix } from "./send-DYtwDagt.js";
//#region extensions/matrix/src/matrix/probe.ts
let matrixProbeRuntimeDepsPromise;
async function loadMatrixProbeRuntimeDeps() {
	matrixProbeRuntimeDepsPromise ??= import("./client-C2RsM6qm.js").then((clientModule) => ({ createMatrixClient: clientModule.createMatrixClient }));
