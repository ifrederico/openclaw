import { c as jsonResult, d as readNumberParam, f as readReactionParams, h as readStringParam, l as parseAvailableTags, p as readStringArrayParam } from "./common-B7pbdYUb.js";
import { a as withNormalizedTimestamp } from "./date-time-rVMdwbGz.js";
import { t as assertMediaNotDataUrl } from "./sandbox-paths-B1-hAAsM.js";
import { r as resolvePollMaxSelections } from "./polls-DHTlCLT8.js";
import { t as readBooleanParam } from "./boolean-param-B3tzmZ3k.js";
import { a as resolveDefaultDiscordAccountId, t as createDiscordActionGate } from "./accounts-CNVeps3i.js";
import { n as resolveDiscordChannelId } from "./target-parsing-D2llSetB.js";
import { r as sendDiscordComponentMessage } from "./send.components-CNHh8_1j.js";
import { n as getGateway, o as getPresence } from "./gateway-registry-mFBdnrAv.js";
import { a as PermissionFlagsBits } from "./v10-FULzL-xS.js";
import { A as kickMemberDiscord, B as editChannelDiscord, C as addRoleDiscord, D as fetchMemberInfoDiscord, E as fetchChannelInfoDiscord, F as listGuildEmojisDiscord, H as removeChannelPermissionDiscord, I as uploadEmojiDiscord, L as uploadStickerDiscord, M as listScheduledEventsDiscord, N as removeRoleDiscord, O as fetchRoleInfoDiscord, P as timeoutMemberDiscord, Q as fetchChannelPermissionsDiscord, R as createChannelDiscord, S as unpinMessageDiscord, T as createScheduledEventDiscord, U as setChannelPermissionDiscord, V as moveChannelDiscord, _ as listPinsDiscord, b as readMessagesDiscord, c as sendStickerDiscord, g as fetchMessageDiscord, h as editMessageDiscord, i as removeReactionDiscord, it as createDiscordRuntimeAccountContext, j as listGuildChannelsDiscord, k as fetchVoiceStatusDiscord, l as sendVoiceMessageDiscord, m as deleteMessageDiscord, n as reactMessageDiscord, o as sendMessageDiscord, p as createThreadDiscord, r as removeOwnReactionsDiscord, s as sendPollDiscord, t as fetchReactionsDiscord, tt as hasAnyGuildPermissionDiscord, v as listThreadsDiscord, w as banMemberDiscord, x as searchMessagesDiscord, y as pinMessageDiscord, z as deleteChannelDiscord } from "./send-Czq8YV5S.js";
import { s as readDiscordComponentSpec } from "./components-v7u06Ud-.js";
import "./targets-DWBKSTPF.js";
...
async function handleDiscordGuildAction(action, params, isActionEnabled, cfg) {
	...
	switch (action) {
		case "memberInfo": {
			...
			const effectiveAccountId = accountId ?? (cfg ? resolveDefaultDiscordAccountId(cfg) : void 0);
			const member = effectiveAccountId ? await discordGuildActionRuntime.fetchMemberInfoDiscord(guildId, userId, { accountId: effectiveAccountId }) : await discordGuildActionRuntime.fetchMemberInfoDiscord(guildId, userId);
...
async function handleDiscordAction(params, cfg, options) {
	...
	if (guildActions.has(action)) return await handleDiscordGuildAction(action, params, isActionEnabled, cfg);
