...
import { t as require_src } from "./src-DZk2W0ah.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-W7_j9nIt.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-Dgo4ZR7D.js";
import { l as toRatio, n as decodeString } from "./Util-DzzbWGWK.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-Ckpp2H-E.js";
import { t as APEv2Parser } from "./APEv2Parser-CqMOyMdz.js";
import { r as hasID3v1Header } from "./ID3v1Parser-BGZkafQx.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DZ6P6fpT.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-KSyASYYB.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-CELETO9t.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-Bhpf73c9.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DHe08NIh.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DcjdNpYE.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-B2LgR6bO.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-OufscObW.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-91EmVYwj.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-DkpvtB3K.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-Bhmyt1qT.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BsR1_Tol.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-C7HPG4fR.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DowGPlSL.js")).WaveParser;
	}
};
//#endregion
