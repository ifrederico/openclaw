...
import { s as resolveMatrixAccountConfig, t as resolveMatrixConfigFieldPath } from "./config-paths-BYr6c1ee.js";
...
import { n as resolveMatrixEnvAuthReadiness } from "./setup-core-BJNjkH5t.js";
import { t as updateMatrixAccountConfig } from "./config-update-mWop9t0z.js";
import { c as validateMatrixHomeserverUrl, s as resolveValidatedMatrixHomeserverUrl } from "./config-DIIOT5nc.js";
import "./client-BuaGRU7F.js";
import { n as listMatrixDirectoryGroupsLive, t as resolveMatrixTargets } from "./resolve-targets-C_JNXdUS.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-CKY574z-.js";
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-EeUZyY21.js");
