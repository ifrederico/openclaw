...
import { a as OPENAI_DEFAULT_MODEL, c as applyOpenAIConfig } from "./default-models-CWg7R7AS.js";
...
function buildOpenAIProvider() {
	return {
		...
		prepareExtraParams: (ctx) => {
			...
			const hasSupportedTransport = transport === "auto" || transport === "sse" || transport === "websocket";
			const hasExplicitWarmup = typeof ctx.extraParams?.openaiWsWarmup === "boolean";
			if (hasSupportedTransport && hasExplicitWarmup) return ctx.extraParams;
			return {
				...ctx.extraParams,
