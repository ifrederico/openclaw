...
import { n as collectTelegramUnmentionedGroupIds, t as auditTelegramGroupMembership } from "./audit-BIpJRACK.js";
import { t as createPluginRuntimeStore } from "./runtime-store-krvAWvNP.js";
import { c as createNestedAllowlistOverrideResolver, n as buildDmGroupAccountAllowlistAdapter } from "./allowlist-config-edit-BEXw5pjC.js";
import { a as telegramSetupWizard, i as telegramConfigAdapter, n as findTelegramTokenOwnerAccountId, o as telegramSetupAdapter, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-pZkV7AC9.js";
...
const telegramPlugin = createChatChannelPlugin({
		...
		lifecycle: {
			onAccountConfigChanged: async ({ prevCfg, nextCfg, accountId }) => {
				if (resolveTelegramAccount({
					...
					const { deleteTelegramUpdateOffset } = await import("./update-offset-store-CKU8mJIz.js");
	...
	outbound: {
		...
		attachedResults: {
			...
			sendPoll: async ({ cfg, to, poll, accountId, threadId, silent, isAnonymous, gatewayClientScopes }) => await getTelegramRuntime().channel.telegram.sendPollTelegram(to, poll, {
				cfg,
