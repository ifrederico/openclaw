...
import { a as resolveDefaultDiscordAccountId, n as listDiscordAccountIds, o as resolveDiscordAccount } from "./accounts-CNVeps3i.js";
import { n as getChatChannelMeta, t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CKCr96-t.js";
import { t as parseDiscordTarget } from "./target-parsing-D2llSetB.js";
import { c as shouldSuppressLocalDiscordExecApprovalPrompt, r as getDiscordApprovalCapability, t as DiscordUiContainer } from "./ui-BBSXCeKY.js";
import { t as discordMessageActions$1 } from "./channel-actions-Drf1VMMz.js";
import { E as setBindingRecord, O as shouldPersistBindingMutations, T as saveBindingsToDisk, o as ensureBindingsLoaded, t as BINDINGS_BY_THREAD_ID, v as resolveBindingIdsForSession } from "./thread-bindings.state-CN6OImuT.js";
import { n as normalizeDiscordMessagingTarget, r as normalizeDiscordOutboundTarget, t as looksLikeDiscordTargetId } from "./normalize-CK0HKpmW.js";
import { t as getDiscordRuntime } from "./runtime-Di0iad89.js";
import { t as normalizeExplicitDiscordSessionKey } from "./session-key-normalization-DEkHJ1LX.js";
import { t as inspectDiscordAccount } from "./account-inspect-onOZ3V7l.js";
import { t as DiscordChannelConfigSchema } from "./config-schema-78wM6KSs.js";
import { a as secretTargetRegistryEntries, i as collectRuntimeConfigAssignments, n as collectUnsupportedSecretRefConfigCandidates, r as unsupportedSecretRefSurfacePatterns, s as normalizeCompatibilityConfig, t as deriveLegacySessionChatType } from "./session-contract-eHT1qUdh.js";
import { t as DISCORD_LEGACY_CONFIG_RULES } from "./doctor-shared-ZdQ6f-WV.js";
...
async function loadDiscordDoctorModule() {
	discordDoctorModulePromise ??= import("./doctor-vbtbJouW.js");
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(() => import("./directory-config-CcutqSVK.js"));
const loadDiscordSecurityAuditModule = createLazyRuntimeModule(() => import("./security-audit.runtime-gqIQpx8r.js"));
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(() => import("./resolve-channels-D0XN_IK6.js"));
const loadDiscordResolveUsersModule = createLazyRuntimeModule(() => import("./resolve-users-CU4A8DYW.js"));
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-ESXXxn7P.js"));
const require = createRequire(import.meta.url);
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-DagZP_6e.js");
	return await discordProviderRuntimePromise;
}
async function loadDiscordProbeRuntime() {
	discordProbeRuntimePromise ??= import("./probe.runtime-CtLjAqOO.js");
	return await discordProbeRuntimePromise;
}
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-Db4jkuVD.js");
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-DZA0-x__.js");
	return await discordSendModulePromise;
}
async function loadDiscordDirectoryLiveModule() {
	discordDirectoryLiveModulePromise ??= import("./directory-live-ojA_ObTM.js");
