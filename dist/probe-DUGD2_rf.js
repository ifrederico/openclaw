...
import { l as loadDeviceAuthToken, n as GatewayClient, r as GatewayClientRequestError } from "./client-DZ1aRkVL.js";
import { i as READ_SCOPE } from "./operator-scopes-D9nPeeKf.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-CxCwMzOT.js");
