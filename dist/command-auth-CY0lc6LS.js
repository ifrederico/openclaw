...
import { r as listLoadedChannelPlugins, t as getLoadedChannelPluginById } from "./registry-loaded-ChuwkhCQ.js";
...
function resolveCommandAuthorization(params) {
	...
	const isAuthorizedSender = resolveCommandSenderAuthorization({
		...
		nativeCommandAuthorized: commandAuthorized && ctx.CommandSource === "native" && !requireOwner,
		isOwnerForCommands,
		senderCandidates,
