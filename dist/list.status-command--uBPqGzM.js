...
import { G as getShellEnvAppliedKeys, Y as shouldEnableShellEnvFallback, r as createConfigIO } from "./io-E69J4lLI.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-Cbe87E7A.js";
import "./config-Dq84uU6c.js";
import { u as resolveAuthStorePathForDisplay } from "./source-check-Bp0rrZbJ.js";
import { h as loadPersistedAuthProfileStore, i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-CSOk8Bno.js";
import { N as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-Cl9AEOGH.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-umbOEWUL.js";
import { _ as modelKey, f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, y as parseModelRef } from "./model-selection-shared-DOxyWoaQ.js";
import { b as resolveProviderEnvAuthEvidence, u as isNonSecretApiKeyMarker, v as listProviderEnvAuthLookupKeys, y as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-DBkfxh3_.js";
...
import { i as resolveAuthProfileDisplayLabel } from "./auth-profiles-Dqjb7Hia.js";
...
import { d as resolveUsableCustomProviderApiKey, i as getCustomProviderApiKey } from "./model-auth-CunBH4hV.js";
import { t as resolveRuntimeSyntheticAuthProviderRefs } from "./synthetic-auth.runtime.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-yc3l08J1.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-ffrMTyXD.js";
import { t as maskApiKey } from "./mask-api-key-Cak1M4P8.js";
import { t as loadModelsConfig } from "./load-config-BU2jJdWv.js";
import { n as isRich } from "./list.format-C30WSiox.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-CvhQkrR2.js"));
const progressRuntimeLoader = createLazyImportLoader(() => import("./progress-BtrZgC6Z.js"));
const terminalTableRuntimeLoader = createLazyImportLoader(() => import("./table-DR4da6oO.js"));
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-CEj7Gk-P.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-Dv-nZWes.js");
		runtime.log("");
