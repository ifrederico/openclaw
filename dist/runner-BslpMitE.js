...
import { n as findNormalizedProviderValue } from "./provider-id-CUjr7KCR.js";
import { c as isInboundPathAllowed, u as mergeInboundPathRoots } from "./zod-schema.providers-core-COgcDZGS.js";
import { a as isAudioFileName, r as getFileExtension, s as kindFromMime, t as detectMime } from "./mime-MVyX1IzB.js";
...
import { a as hasAvailableAuthForProvider, s as resolveApiKeyForProvider } from "./model-auth-BbESr7Je.js";
import { i as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-SQDr_rmB.js";
import { t as resolveSystemBin } from "./resolve-system-bin-BAMWqi9l.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-Dk1WAJor.js";
import { a as normalizeMediaProviderId, n as getMediaUnderstandingProvider, t as buildMediaUnderstandingRegistry } from "./provider-registry-BD1bQp1o.js";
import { t as describeImageWithModel } from "./image-runtime--_kRkSbF.js";
import { n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-DzQEmCkk.js";
import { _ as DEFAULT_VIDEO_MAX_BASE64_BYTES, a as resolvePrompt, b as resolveAutoMediaKeyProviders, g as DEFAULT_TIMEOUT_SECONDS, i as resolveModelEntries, n as resolveMaxBytes, o as resolveScopeDecision, r as resolveMaxChars, s as resolveTimeoutMs, u as CLI_OUTPUT_MAX_BUFFER, v as MIN_AUDIO_FILE_BYTES, x as resolveDefaultMediaModel } from "./resolve-Djj793q2.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-k1xieG7s.js";
import { t as buildRandomTempFilePath } from "./temp-download-C7nY-2xj.js";
import "./temp-path-BO7uM_47.js";
import { a as mergeProviderRequestOverrides, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-BRDGCVdB.js";
import "./shared-CXDsESE1.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DLhl_EE-.js";
...
function resolveCatalogImageModelId(params) {
	...
	if (matches.length === 0) return;
	return (matches.find((entry) => entry.id.trim().toLowerCase() === "auto") ?? matches[0])?.id.trim() || void 0;
}
...
//#endregion
export { isMediaUnderstandingSkipError as _, runCapability as a, resolveAttachmentKind as b, parseFfprobeCodecAndSampleRate as c, runFfprobe as d, MEDIA_FFMPEG_MAX_AUDIO_DURATION_SECS as f, MediaAttachmentCache as g, MEDIA_FFPROBE_TIMEOUT_MS as h, resolveMediaAttachmentLocalRoots as i, parseFfprobeCsvFields as l, MEDIA_FFMPEG_TIMEOUT_MS as m, clearMediaUnderstandingBinaryCacheForTests as n, createMediaAttachmentCache as o, MEDIA_FFMPEG_MAX_BUFFER_BYTES as p, resolveAutoImageModel as r, normalizeMediaAttachments as s, buildProviderRegistry as t, runFfmpeg as u, isAudioAttachment as v, normalizeAttachments as y };
