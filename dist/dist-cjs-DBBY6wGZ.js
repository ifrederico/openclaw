...
import { t as require_dist_cjs$2 } from "./dist-cjs-DCPRySOP.js";
import { n as init_client, t as client_exports } from "./client-BAJs31YJ.js";
import { t as require_dist_cjs$3 } from "./dist-cjs-C1LV_4y8.js";
import { t as require_dist_cjs$4 } from "./dist-cjs-BSMvmm8m.js";
...
var require_dist_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var LoginCredentialsFetcher = class LoginCredentialsFetcher {
		...
		async refresh(token) {
			const { SigninClient, CreateOAuth2TokenCommand } = await import("./signin-BkPQw7QJ.js");
...
var require_dist_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const resolveCredentialSource = (credentialSource, profileName, logger) => {
		const sourceProvidersMap = {
			EcsContainer: async (options) => {
				...
				const { fromContainerMetadata } = await import("./dist-cjs-BCw_Y09_.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is EcsContainer");
				return async () => propertyProvider.chain(fromHttp(options ?? {}), fromContainerMetadata(options))().then(setNamedProvider);
			},
			Ec2InstanceMetadata: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Ec2InstanceMetadata");
				const { fromInstanceMetadata } = await import("./dist-cjs-BCw_Y09_.js").then((m) => /* @__PURE__ */ __toESM(m.default));
				return async () => fromInstanceMetadata(options)().then(setNamedProvider);
			},
			Environment: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
				const { fromEnv } = await import("./dist-cjs-rKskha3k.js").then((m) => /* @__PURE__ */ __toESM(m.default));
	...
	const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
		...
		if (!options.roleAssumer) {
			const { getDefaultRoleAssumer } = await import("./sts-RA8XAsST.js");
	...
	const resolveProcessCredentials = async (options, profile) => import("./dist-cjs-DHpkQaBV.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromProcess }) => fromProcess({
		...options,
		profile
	...
	const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => import("./dist-cjs-Dj_PWGas.js").then((m) => /* @__PURE__ */ __toESM(m.default)).then(({ fromTokenFile }) => fromTokenFile({
