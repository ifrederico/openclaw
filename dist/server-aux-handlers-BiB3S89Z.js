...
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-D88uBdlI.js";
import { n as channelRouteDedupeKey } from "./channel-route-clbSK-46.js";
import { n as getLoadedChannelPlugin } from "./registry-BkuUNjzB.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-C729ZIvi.js";
import { D as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-CAkDft3R.js";
import { i as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-uCeCLCPX.js";
import { n as collectCommandSecretAssignmentsFromSnapshot } from "./command-config-DAqPCsZH.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-Csuv8yeD.js";
import { c as formatExecApprovalExpiresIn } from "./exec-approval-reply-D-Wvnv_y.js";
import { r as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-CQT3bGKL.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-MVDWqYlP.js";
import { l as roleScopesAllow } from "./pairing-token-KDYsL3Tp.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-B1MRm3c4.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-CT3ozyNA.js";
import { a as resolveApnsAuthConfigFromEnv, c as sendApnsExecApprovalAlert, d as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalResolvedWake, n as loadApnsRegistration, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-CGSsuDFi.js";
import { a as setCurrentSharedGatewaySessionGeneration, n as disconnectStaleSharedGatewayAuthClients } from "./server-shared-auth-generation-CCBEtIaf.js";
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-BkpBA7ht.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-COqE08rQ.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-CHg62MCS.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
