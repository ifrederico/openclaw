import { Dn as listRiskyConfiguredSafeBins, Tn as normalizeTrustedSafeBinDirs } from "./env-D1ktUnAV.js";
...
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-7IxnGQxG.js";
...
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-BdAu1_OT.js";
import { i as loadExecApprovals } from "./exec-approvals-CoUFlPSg.js";
import { a as listInterpreterLikeSafeBins, r as isInterpreterLikeAllowlistPattern, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-CAjjj6oR.js";
import { Q as resolveBrowserControlAuth, q as redactCdpUrl } from "./client-fetch-BpnVLZgl.js";
import { n as resolveBrowserConfig, r as resolveProfile } from "./config-B6bjVdCF.js";
import { n as hasPotentialConfiguredChannels } from "./config-presence-Bo4-9YVM.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DV6V_90O.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-C3j0z9Hs.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-DREIT2ko.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-DB6yKLBA.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-BmAosWnf.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-ZJt7dzoE.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-CkjhFXF1.js"),
		import("./probe-auth-D56ZgrBU.js"),
		import("./probe-Ck6c95zD.js")
