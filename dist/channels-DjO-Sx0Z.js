...
import { l as isChannelVisibleInConfiguredLists } from "./registry-DldQsVOb.js";
import { t as formatDocsLink } from "./links-BFfjc3N-.js";
import { r as theme } from "./theme-BeexRN7S.js";
import { r as loadAuthProfileStore } from "./store-HF_Z-jKz.js";
...
import { r as createMessageActionDiscoveryContext, s as resolveMessageActionDiscoveryForPlugin } from "./message-action-discovery-RDjl5Hph.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-DKf8xAMK.js";
import { n as formatTimeAgo } from "./format-relative-Cdxcv0IJ.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-C-YC9Mfg.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-BiAtGxsL.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-mnjlKuYD.js";
import { n as withProgress } from "./progress-Ba3DFrwb.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-CBFljImd.js";
import { t as createClackPrompter } from "./clack-prompter-TkKxgd3Q.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-NdvMaOwx.js";
import { t as parseLogLine } from "./parse-log-line-TRcgUoij.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-C6M13EAP.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-HN9QiYek.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-NbAopnFL.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-DRHiPuHM.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-DtlQmVaU.js"), import("./onboard-channels-Bx4N8THE.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-CWjIpVrE.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-CWjIpVrE.js");
			const prompter = createClackPrompter();
...
function detectAutoKindForPlugin(input, plugin) {
	...
	const prefixes = [plugin.id, ...plugin.meta?.aliases ?? []].map((entry) => entry.trim().toLowerCase()).filter(Boolean);
