...
import { B as MEMORY_DREAMING_SYSTEM_EVENT_TEXT } from "./dreaming-oOlVey8D.js";
import { i as saveCronStore, r as resolveCronStorePath, t as loadCronStore } from "./store--4w3cgRj.js";
import { i as TrimmedNonEmptyStringFieldSchema, n as LowercaseNonEmptyStringFieldSchema, o as parseOptionalField, t as DeliveryThreadIdFieldSchema } from "./delivery-field-schemas-Cug13zAZ.js";
...
import { t as coerceFiniteScheduleNumber } from "./schedule-C6nnR4tn.js";
...
function isInvalidCronPayloadModelSentinel(value) {
...
function normalizeStoredCronJobs(jobs) {
	...
	for (const raw of jobs) {
		...
		if (payloadRecord) {
			if (payloadRecord.kind === "agentTurn" && "model" in payloadRecord && isInvalidCronPayloadModelSentinel(payloadRecord.model)) {
...
function formatLegacyIssuePreview(issues) {
	...
	if (issues.invalidCronPayloadModel) {
		...
		lines.push(`- ${pluralize(issues.invalidCronPayloadModel, "job")} ${verb} an invalid cron payload model inheritance sentinel`);
	}
