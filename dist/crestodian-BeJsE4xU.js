...
import { i as isPersistentCrestodianOperation, n as executeCrestodianOperation } from "./operations-Djb2J1r2.js";
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-C4xmbcIz.js";
import { r as resolveCrestodianOperation } from "./dialogue-CPoPXkT1.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-uyRv87Mp.js")).runCrestodianTui;
	opts.onReady?.();
