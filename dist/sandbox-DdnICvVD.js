import { Ai as DEFAULT_IDENTITY_FILENAME, Di as DEFAULT_AGENT_WORKSPACE_DIR, Do as defaultRuntime, Ei as DEFAULT_AGENTS_FILENAME, Fi as DEFAULT_USER_FILENAME, Ga as resolveUserPath, Ii as ensureAgentWorkspace, Ni as DEFAULT_SOUL_FILENAME, O as loadConfig, Oi as DEFAULT_BOOTSTRAP_FILENAME, Pi as DEFAULT_TOOLS_FILENAME, Xa as sliceUtf16Safe, ki as DEFAULT_HEARTBEAT_FILENAME, ta as openBoundaryFile, ua as isPathInside, wi as resolveSessionAgentId } from "./env-D1ktUnAV.js";
...
import { C as updateRegistry, E as resolveSandboxConfigForAgent, G as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, O as isToolAllowed, S as updateBrowserRegistry, T as resolveSandboxBrowserDockerCreateConfig, W as SANDBOX_AGENT_WORKSPACE_MOUNT, _ as slugifySessionKey, a as execDockerRaw, b as removeBrowserRegistryEntry, c as readDockerPort, d as validateNetworkMode, f as resolveSandboxHostPathViaExistingAncestor, g as resolveSandboxWorkspaceDir, h as resolveSandboxScopeKey, i as execDocker, k as resolveSandboxToolPolicyForAgent, l as appendWorkspaceMountArgs, m as resolveSandboxAgentId, n as dockerContainerState, o as readDockerContainerEnvVar, p as splitSandboxBindSpec, r as ensureSandboxContainer, s as readDockerContainerLabel, t as buildSandboxCreateArgs, v as readBrowserRegistry, w as computeSandboxBrowserConfigHash, x as removeRegistryEntry, y as readRegistry } from "./docker-BrzH-NvE.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-BfUEa8Z8.js";
import { i as resolveSandboxPath, n as assertSandboxPath, r as resolveSandboxInputPath } from "./sandbox-paths-DM85ql27.js";
import { c as syncSkillsToWorkspace } from "./skills-Xrdxpo0d.js";
import { Q as resolveBrowserControlAuth, Z as ensureBrowserControlAuth, at as deleteBridgeAuthForPort, k as createBrowserRouteContext, ot as setBridgeAuthForPort, r as registerBrowserRoutes } from "./client-fetch-BpnVLZgl.js";
import { d as DEFAULT_OPENCLAW_BROWSER_COLOR, f as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, p as deriveDefaultBrowserCdpPortRange, r as resolveProfile } from "./config-B6bjVdCF.js";
import { t as parseSshTarget } from "./ssh-tunnel-Ca8F0wnz.js";
