...
import { n as resolveMatrixConfigPath } from "./config-paths-CkalHleB.js";
import { t as updateMatrixAccountConfig } from "./config-update-bhAc2GnE.js";
import { n as matrixSetupAdapter } from "./setup-core-B4vsBt8v.js";
import { t as resolveMatrixRoomKeyBackupIssue } from "./backup-health-CjIZfYeb.js";
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-qaaYw8iV.js";
import { t as withResolvedActionClient } from "./client-gOhqLhYO.js";
import { r as resolveMatrixAuthContext } from "./config-BPcknnAL.js";
import "./client-DJfqrmLb.js";
import "./runtime-api-BcD1E4O8.js";
import { n as summarizeMatrixDeviceHealth, t as isOpenClawManagedMatrixDevice } from "./device-health-utGInNrv.js";
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-D8568S6c.js";
import { a as confirmMatrixVerificationSas, c as getMatrixRoomKeyBackupStatus, d as listMatrixVerifications, f as mismatchMatrixVerificationSas, g as runMatrixSelfVerification, h as restoreMatrixRoomKeyBackup, l as getMatrixVerificationSas, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, p as requestMatrixVerification, r as cancelMatrixVerification, t as acceptMatrixVerification, u as getMatrixVerificationStatus, v as startMatrixVerification, y as verifyMatrixRecoveryKey } from "./verification-DL09YNG-.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-bMjZ8Oz3.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-sw-dsIJr.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-BU5BalA9.js");
