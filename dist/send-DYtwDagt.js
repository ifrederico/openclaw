...
import { a as isAutoLinkedFileRef } from "./text-runtime-CGJVPr69.js";
import { t as loadOutboundMediaFromUrl } from "./outbound-media-Cj_f0fBE.js";
import { t as require_src } from "./src-DhEZntCI.js";
...
import { a as EventType, l as buildMatrixReactionContent, n as persistMatrixDirectRoomMapping, o as MsgType, s as RelationType, t as inspectMatrixDirectRooms } from "./direct-management-Dy5X7YiZ.js";
import { t as fromBuffer } from "./lib-CYqZL3OY.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DnD1zP9i.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-sRJ3QF7r.js";
import { l as toRatio, n as decodeString } from "./Util-DM3MIIE6.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-DnPL7gUd.js";
import { t as APEv2Parser } from "./APEv2Parser-Co_GtMDc.js";
import { r as hasID3v1Header } from "./ID3v1Parser-5h7KZXz4.js";
import { i as isStrictDirectRoom } from "./direct-room-DYlSJOU_.js";
...
async function loadMatrixSendClientRuntime() {
	matrixSendClientRuntimePromise ??= import("./client-bootstrap-DVCOAYnN.js");
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-BcBDcQwO.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-CSQ_kxvA.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BuMR7Tmv.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DMDVLU54.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-cVI9rWau.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DuhX6Ndn.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-mae_1Eyv.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-Bjc7Ym8V.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-_yyTerel.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CeU_ND6Z.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-Bz6IXtsx.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DliYAZZ9.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DWXy64oI.js")).WaveParser;
	}
};
//#endregion
