...
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-B5YaHwav.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-C1dy8S7w.js";
import "./provider-auth-choice-preference-BuI5-n7q.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-BLukc5qw.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-Cc_VJOSt.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-D-zBfKcM.js");
