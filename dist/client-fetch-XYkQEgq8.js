...
import { c as escapeRegExp, m as resolveUserPath, t as CONFIG_DIR } from "./utils-ms6h9yny.js";
...
import { d as resolvePinnedHostnameWithPolicy, l as isPrivateNetworkAllowedByPolicy, t as SsrFBlockedError } from "./ssrf-BWjc2mcC.js";
import { i as generateSecureToken } from "./secure-random-BRacmrZN.js";
import { o as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-DpEi_XvA.js";
import "./browser-setup-tools-C244pZOh.js";
import { a as ensureMediaDir, l as saveMediaBuffer } from "./store-caT1P_9G.js";
import "./temp-path-BO7uM_47.js";
import { n as deriveDefaultBrowserCdpPortRange, r as deriveDefaultBrowserControlPort } from "./port-defaults-TUnYQMq2.js";
import { t as parseBooleanValue } from "./boolean-CKdslSGT.js";
import "./browser-config-runtime-CXZjFS8D.js";
import { n as resolveBrowserControlAuth, t as ensureBrowserControlAuth } from "./control-auth-2zykptG0.js";
import "./browser-config-support-BDDkfL2E.js";
import "./browser-node-runtime-DbvJd3Vt.js";
import "./browser-security-runtime-CMb_3kMM.js";
import "./logging-core-MxjSoc-i.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-I6yV4XiW.js";
...
async function closePlaywrightBrowserConnectionForProfile$1(cdpUrl) {
	try {
		await (await import("./pw-ai-CwwIEolR.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
	} catch {}
}
//#endregion
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CwwIEolR.js");
	} catch (err) {
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-CwwIEolR.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
...
//#endregion
export { setBridgeAuthForPort as $, withBrowserNavigationPolicy as A, DEFAULT_BROWSER_EVALUATE_ENABLED as B, getChromeWebSocketUrl as C, assertBrowserNavigationAllowed as D, InvalidBrowserNavigationUrlError as E, DEFAULT_UPLOAD_DIR as F, fetchJson as G, DEFAULT_OPENCLAW_BROWSER_ENABLED as H, resolveExistingPathsWithinRoot as I, parseBrowserHttpUrl as J, getHeadersWithAuth as K, resolveStrictExistingPathsWithinRoot as L, resolveBrowserConfig as M, resolveProfile as N, assertBrowserNavigationRedirectChainAllowed as O, DEFAULT_TRACE_DIR as P, deleteBridgeAuthForPort as Q, DEFAULT_AI_SNAPSHOT_MAX_CHARS as R, BrowserTabNotFoundError as S, normalizeCdpWsUrl as T, DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME as U, DEFAULT_OPENCLAW_BROWSER_COLOR as V, appendCdpPath as W, withCdpSocket as X, redactCdpUrl as Y, withNoProxyForCdpUrl as Z, createBrowserRuntimeState as _, buildRoleSnapshotFromAriaSnapshot as a, movePathToTrash as b, matchBrowserUrlPattern as c, normalizeBrowserFormFieldValue as d, createBrowserControlContext as f, isDefaultBrowserPluginEnabled as g, stopBrowserControlService as h, buildRoleSnapshotFromAiSnapshot as i, markPwAiLoaded as j, assertBrowserNavigationResultAllowed as k, DEFAULT_FILL_FIELD_TYPE as l, startBrowserControlServiceFromConfig as m, createBrowserRouteDispatcher as n, getRoleSnapshotStats as o, getBrowserControlState as p, normalizeCdpHttpBaseForJsonEndpoints as q, registerBrowserRoutes as r, parseRoleRef as s, fetchBrowserJson as t, normalizeBrowserFormField as u, stopBrowserRuntime as v, formatAriaSnapshot as w, getBrowserProfileCapabilities as x, createBrowserRouteContext as y, DEFAULT_BROWSER_DEFAULT_PROFILE_NAME as z };
