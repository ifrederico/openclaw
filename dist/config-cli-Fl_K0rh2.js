import { Do as defaultRuntime, H as validateConfigObjectRaw, Ja as shortenHomePath, L as writeConfigFile, M as readConfigFileSnapshot, Oo as writeRuntimeJson, ao as success, eo as danger, to as info } from "./env-D1ktUnAV.js";
import { t as CONFIG_PATH } from "./paths-CjuwkA2v.js";
import "./safe-text-K2Nonoo3.js";
import "./tmp-openclaw-dir-DzRxfh9a.js";
import { r as theme } from "./theme-BH5F9mlg.js";
import "./version-DGzLsBG-.js";
import { y as isBlockedObjectKey } from "./session-key-CYZxn_Kd.js";
import { S as resolveSecretInputRef, a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, h as coerceSecretRef, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey, v as isValidEnvSecretRefId } from "./ref-contract-BFBhfQKU.js";
import { k as SecretProviderSchema } from "./zod-schema.agent-runtime-DNndkpI8.js";
import "./runtime-BF_KUcJM.js";
import "./registry-bOiEdffE.js";
import "./ip-ByO4-_4f.js";
import { t as formatDocsLink } from "./links-DaR1j_Bv.js";
import "./audit-fs-7IxnGQxG.js";
import { a as resolveSecretRefValue } from "./resolve-DqJVzTVp.js";
import { t as formatCliCommand } from "./command-format-CCyUqeuM.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-Cj39YIRp.js";
import { t as OLLAMA_DEFAULT_BASE_URL } from "./ollama-defaults-BH8D2agd.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-CUzd3r6R.js";
import "./timeouts-BITLzPy1.js";
import "./timeouts-Co8KR8ho.js";
import { t as redactConfigObject } from "./redact-snapshot-DZ-PRV32.js";
import { n as setCommandJsonMode } from "./json-mode-CfAbHFRW.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-ChtmUVYm.js");
