import { Do as defaultRuntime, Ga as resolveUserPath, L as writeConfigFile, M as readConfigFileSnapshot, Oo as writeRuntimeJson, jt as assertSupportedRuntime, ko as restoreTerminalState } from "./env-D1ktUnAV.js";
import { u as resolveGatewayPort } from "./paths-CjuwkA2v.js";
import { l as resolveDefaultSecretProviderAlias, v as isValidEnvSecretRefId } from "./ref-contract-BFBhfQKU.js";
import { t as formatCliCommand } from "./command-format-CCyUqeuM.js";
import "./daemon-runtime-_44dBgK9.js";
import { h as resolveControlUiLinks, i as ensureWorkspaceAndSessions, l as normalizeGatewayTokenInput, n as applyWizardMetadata, p as randomToken, s as handleReset, t as DEFAULT_WORKSPACE, y as waitForGatewayReachable } from "./onboard-helpers-1d1tmKDF.js";
...
import { t as runSetupWizard } from "./setup-BqRQgJwd.js";
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-Dv7QaV0L.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-Le4OgskG.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BdtfU9_v.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-Dfbn2gwH.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-NDqc4SAr.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-C0KQ-Vlc.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Cp39ux73.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-Bswit-qT.js");
