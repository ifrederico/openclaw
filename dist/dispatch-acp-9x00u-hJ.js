...
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-B0psX4Mk.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-CMKeNlcV.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-ChOSYgmf.js");
...
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-Dg-rgFip.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-BFhfpS51.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-G6blr53X.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-ChOSYgmf.js");
