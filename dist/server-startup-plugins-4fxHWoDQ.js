...
import { P as createEmptyPluginRegistry, a as getActivePluginRegistry, x as setActivePluginRegistry } from "./runtime-B0MMVyKh.js";
import { c as initSubagentRegistry } from "./subagent-registry-BTDmugmA.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-BizzirQ4.js";
import { t as loadPluginLookUpTable } from "./plugin-lookup-table-D6BeHVEN.js";
import { n as listGatewayMethods } from "./server-methods-list-DGNT2c3H.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-F_cmuFSO.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-DvJPOrwF.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-DYLFoxwD.js");
