...
import { J as listSubagentRunsForController, W as getLatestSubagentRunByChildSessionKey, X as markSubagentRunTerminated, vt as resolveInternalSessionKey, yt as resolveMainSessionAlias } from "./pi-embedded-BZAy4SUa.js";
import { h as replyRunRegistry, t as abortEmbeddedPiRun } from "./runs-D1jY2fB7.js";
import { a as clearSessionQueues } from "./fast-mode-BbA2K8ts.js";
import { n as getAcpSessionManager } from "./manager-D9hIAV3J.js";
import { i as setAbortMemory, n as isAbortRequestText } from "./abort-primitives-Cb4xj3G4.js";
...
async function tryFastAbortFromMessage(params) {
	...
	if (!isAbortRequestText(ctx.ChatType?.trim().toLowerCase() === "group" ? stripMentions(raw, ctx, cfg, resolveSessionAgentId({
