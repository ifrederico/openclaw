...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-GzU_89__.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-BRL1qM8r.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createNoOpHttpPlugin() {
	await import("./Reflect--tEgrNYU.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_METADATA_KEY } = await import("./plugin-BM3z1LPb.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_DEPENDENCIES_METADATA_KEY } = await import("./dependency-D2j0C2Ev.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { PLUGIN_EVENTS_METADATA_KEY } = await import("./event-CsXt_AP9.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
async function createBotFrameworkJwtValidator(creds) {
	const { JwtValidator } = await import("./jwt-validator-Ddlgwqo5.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
