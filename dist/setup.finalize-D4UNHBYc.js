...
import { Ga as resolveUserPath, Oi as DEFAULT_BOOTSTRAP_FILENAME, Va as pathExists, ko as restoreTerminalState } from "./env-D1ktUnAV.js";
...
import { n as resolveCliName } from "./cli-name-DdoGzQxW.js";
...
import { a as formatControlUiSshHint, f as probeGatewayReachable, h as resolveControlUiLinks, r as detectBrowserOpenSupport, u as openUrl, y as waitForGatewayReachable } from "./onboard-helpers-1d1tmKDF.js";
...
import { vs as listConfiguredWebSearchProviders } from "./pi-embedded-DhFkhMap.js";
...
import { t as runTui } from "./tui-NzVa_d8K.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DvBeHTLF.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Bvu-CPTI.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-Bvu-CPTI.js");
