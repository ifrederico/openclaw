...
import { $i as logWarn, Do as defaultRuntime, Fn as resolvePlannedSegmentArgv, O as loadConfig, Sa as sanitizeHostExecEnv, Un as resolveCommandResolutionFromArgv, Vn as resolveApprovalAuditCandidatePath, Yn as resolveExecutableFromPathEnv, Zn as POSIX_SHELL_WRAPPERS, ar as resolveInlineCommandMatch, cr as normalizeExecutableToken, ia as sameFileIdentity, kn as analyzeArgvCommand, lr as splitShellArgs, nr as unwrapKnownShellMultiplexerInvocation, rr as POSIX_INLINE_COMMAND_FLAGS, sr as unwrapKnownDispatchWrapperInvocation, ui as resolveAgentConfig, wa as sanitizeSystemRunEnvOverrides, ya as inspectHostExecEnvOverrides } from "./env-D1ktUnAV.js";
import { _ as resolveStateDir } from "./paths-CjuwkA2v.js";
import "./safe-text-K2Nonoo3.js";
import "./tmp-openclaw-dir-DzRxfh9a.js";
import { r as theme, t as colorize } from "./theme-BH5F9mlg.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-CJXstBek.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-ddAnhVxS.js";
import { c as buildNodeServiceEnvironment } from "./runtime-paths-Du8UajUp.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-_44dBgK9.js";
...
import { pn as loadOrCreateDeviceIdentity, u as GatewayClient } from "./method-scopes-DtJfTstv.js";
...
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-BUwuwoKQ.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-Ble1Dwd-.js";
import "./logging-CS4wyI-j.js";
import { t as parsePort } from "./parse-port-BGM5pBTb.js";
import "./commands-AceByDw5.js";
import "./issue-format-Cj39YIRp.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-gBCZgGHS.js";
...
import { AC as getMachineDisplayName, ev as formatExecCommand, g as withTimeout, ov as normalizeSystemRunApprovalPlan, tv as resolveSystemRunCommandRequest } from "./pi-embedded-DhFkhMap.js";
...
import { i as isInterpreterLikeSafeBin, n as detectInterpreterInlineEvalArgv, o as resolveExecSafeBinRuntimePolicy, t as describeInterpreterInlineEval } from "./exec-inline-eval-CAjjj6oR.js";
...
import { E as startBrowserControlServiceFromConfig, T as createBrowserControlContext, n as createBrowserRouteDispatcher, q as redactCdpUrl } from "./client-fetch-BpnVLZgl.js";
...
import { t as ensureOpenClawCliOnPath } from "./path-env-uLqYPlhY.js";
import { n as normalizeBrowserRequestPath, r as resolveRequestedBrowserProfile, t as isPersistentBrowserProfileMutation } from "./request-policy-Dxw0Zuku.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-Cw8L4Vlq.js";
