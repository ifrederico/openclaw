...
import { t as require_src } from "./src-B-3aQijO.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DQ9u_t4y.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DbeK5N5y.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-REATtAtD.js";
import { l as toRatio, n as decodeString } from "./Util-BQcX6K7e.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-DXk8zBdU.js";
import { t as APEv2Parser } from "./APEv2Parser--8RKSgPk.js";
import { r as hasID3v1Header } from "./ID3v1Parser--Mru19tM.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-cz0jtdFN.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-D7LBh1Ih.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-B5DxUeLt.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-CK6PEVTC.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-HJU6FgLC.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CsIWnuum.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-mjlly3I4.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CGNZ5AGO.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-Dq4Hryd6.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-D3sNcIIc.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BYWRwyO7.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-CXV5O6LL.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DrgjCwpW.js")).WaveParser;
	}
};
//#endregion
