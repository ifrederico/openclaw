...
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-D34lIttY.js";
...
import { d as setConsoleTimestampPrefix, t as createSubsystemLogger } from "./subsystem-CVf5iEWk.js";
...
import { _ as resolveStateDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-yyDPxM31.js";
import "./globals-B43CpcZo.js";
import { _ as resolveWorkspaceTemplateDir, g as resolveDefaultAgentWorkspaceDir } from "./workspace-DLW8_PFX.js";
import { a as loadConfig, c as readBestEffortConfig, h as writeConfigFile, l as readConfigFileSnapshot, r as createConfigIO } from "./io-CS2J_l4V.js";
...
import { t as inspectBestEffortPrimaryTailnetIPv4 } from "./network-discovery-display-Noqt172f.js";
import { i as probeGateway } from "./probe-Cv3pJ1Va.js";
import { o as handleReset } from "./onboard-helpers-CiVaZSUb.js";
import { t as cleanStaleGatewayProcessesSync } from "./restart-stale-pids-6v9JnhXs.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-FcFHBNq5.js";
import { t as parsePort } from "./parse-port-DpUYrM0p.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-B0zHVLtm.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-CYiXRDwm.js";
import { a as getActiveTaskCount, c as markGatewayDraining, d as waitForActiveTasks, l as resetAllLanes } from "./command-queue-lJ0o3pQC.js";
import { r as callGateway } from "./call-CEzBPW9Z.js";
import { b as markGatewaySigusr1RestartHandled, d as waitForActiveEmbeddedRuns, g as consumeGatewaySigusr1RestartAuthorization, r as getActiveEmbeddedRunCount, t as abortEmbeddedPiRun, w as triggerOpenClawRestart, x as scheduleGatewaySigusr1Restart, y as isGatewaySigusr1RestartExternallyAllowed } from "./runs-D1jY2fB7.js";
import { n as parseTimeoutMsWithFallback } from "./parse-timeout-B6U24Eqt.js";
import { t as formatHelpExamples } from "./help-format-LjQpSCiy.js";
import { n as runCommandWithRuntime } from "./cli-utils-BdKzKa-H.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-D23GgwNR.js";
import { i as formatUsd, r as formatTokenCount } from "./usage-format-B6wsX5Cv.js";
import { n as withProgress } from "./progress-Ba3DFrwb.js";
import { t as readSecretFromFile } from "./secret-file-BfGbaCXy.js";
import { n as resolveWideAreaDiscoveryDomain } from "./widearea-dns-BASDK4tZ.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-2wPOkpgA.js";
import { i as discoverGatewayBeacons, n as buildGatewayDiscoveryTarget, r as serializeGatewayDiscoveryBeacon } from "./gateway-discovery-targets-CT49CXQR.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-C6zp6X9l.js";
import { i as styleHealthChannelLine, t as formatHealthChannelLines } from "./health-BXpfaOi4.js";
import { o as resolveControlUiRootSync } from "./control-ui-assets-DQVjofXa.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-BhEfnfUu.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-ffonqp-L.js";
...
async function resolveSshTarget(params) {
	...
	return {
		target,
		identity: params.identity ?? config.identityFiles.find((entry) => entry.trim().length > 0)?.trim() ?? void 0
	};
}
...
function buildGatewayStatusWarnings(params) {
	...
	if (params.sshTarget && !params.sshTunnelStarted) warnings.push({
		...
		message: params.sshTunnelError ? `SSH tunnel failed: ${String(params.sshTunnelError)}` : "SSH tunnel failed to start; falling back to direct probes."
	});
...
function writeGatewayStatusText(params) {
	const ok = params.probed.filter((entry) => isProbeReachable(entry.probe)).length > 0;
...
function loadSshConfigModule() {
	sshConfigModulePromise ??= import("./ssh-config-C_eTSGqA.js");
	return sshConfigModulePromise;
}
function loadSshTunnelModule() {
	sshTunnelModulePromise ??= import("./ssh-tunnel-DOMnaHza.js");
...
async function runGatewayCommand$1(opts) {
	...
	const { startGatewayServer } = await withProgress({
		...
		indeterminate: true
	}, async () => import("./server-BtS-cEW1.js"));
