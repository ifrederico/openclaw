...
import { t as inspectReadOnlyChannelAccount } from "./read-only-account-inspect-BirtT2sz.js";
...
const loadAuditChannelDiscordRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.discord.runtime-DdA-Ohqo.js"), ({ auditChannelDiscordRuntime }) => auditChannelDiscordRuntime);
const loadAuditChannelAllowFromRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.allow-from.runtime-Be1hQbNT.js"), ({ auditChannelAllowFromRuntime }) => auditChannelAllowFromRuntime);
const loadAuditChannelTelegramRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.telegram.runtime-EQSZE8ZJ.js"), ({ auditChannelTelegramRuntime }) => auditChannelTelegramRuntime);
const loadAuditChannelZalouserRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.zalouser.runtime-CLcsC6Wo.js"), ({ auditChannelZalouserRuntime }) => auditChannelZalouserRuntime);
