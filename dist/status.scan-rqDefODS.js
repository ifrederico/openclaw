...
import { n as buildPluginCompatibilityNotices } from "./status-BC4s-4i3.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-C6zp6X9l.js";
import { t as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-CRHZ2klJ.js";
import { t as resolveOsSummary } from "./os-summary-CoUbmZh2.js";
import { a as resolveMemoryPluginStatus, i as resolveGatewayProbeSnapshot, n as scanStatusJsonCore, o as resolveSharedMemoryStatusSnapshot, r as buildTailscaleHttpsUrl, t as buildColdStartUpdateResult } from "./status.scan.json-core-B7FqeqaH.js";
...
const loadStatusScanRuntimeModule = createLazyRuntimeSurface(() => import("./status.scan.runtime-B82Fil5h.js"), ({ statusScanRuntime }) => statusScanRuntime);
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-DWTXyMMQ.js");
	return statusScanDepsRuntimeModulePromise;
}
function loadStatusAgentLocalModule() {
	statusAgentLocalModulePromise ??= import("./status.agent-local-B3mrs-q5.js");
	return statusAgentLocalModulePromise;
}
function loadStatusSummaryModule() {
	statusSummaryModulePromise ??= import("./status.summary-B7TNhNVI.js");
	return statusSummaryModulePromise;
}
function loadStatusUpdateModule() {
	statusUpdateModulePromise ??= import("./status.update-B5p6yQAU.js");
