import{h as e,o as t,p as n}from"./string-coerce-fg0uHMX_.js";import"./format-CywOr69k.js";import{i as r}from"./index-DNNBM457.js";function i(i){let a=(i.status&&typeof i.status==`object`?i.status.securityAudit:null)?.summary??null,o=a?.critical??0,s=a?.warn??0,c=a?.info??0,l=o>0?`danger`:s>0?`warn`:`success`,u=o>0?t(`debug.security.critical`,{count:String(o)}):s>0?t(`debug.security.warnings`,{count:String(s)}):t(`debug.security.noCriticalIssues`);return e`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-NQnXpfLJ.js.map