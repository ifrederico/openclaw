import{h as e,l as t,o as n,p as r,t as i}from"./string-coerce-fg0uHMX_.js";import{d as a}from"./format-CywOr69k.js";import{i as o}from"./directive-helpers-DzlrYvXs.js";import{n as s,t as c}from"./directive-Dk4hInuL.js";import{A as l,C as u,D as d,E as f,F as p,M as m,N as ee,O as h,P as g,S as te,T as ne,a as _,b as v,f as y,j as re,k as b,m as x,n as ie,p as S,r as C,t as w,v as T,w as E,x as D,y as O}from"./index-DNNBM457.js";import{r as k}from"./channel-config-extras-D8Gky8e-.js";import{i as A,n as j,r as M,t as ae}from"./skills-shared-70lbFSiL.js";var oe=c(class extends s{constructor(){super(...arguments),this.key=r}render(e,t){return this.key=e,t}update(e,[t,n]){return t!==this.key&&(o(e),this.key=t),n}});function se(t){let{agent:i,configForm:a,agentFilesList:o,configLoading:s,configSaving:c,configDirty:u,onConfigReload:p,onConfigSave:m,onModelChange:ee,onModelFallbacksChange:g,onSelectPanel:te}=t,_=!!(t.defaultId&&i.id===t.defaultId),y=d(a,i.id),x=i.model,ie=(o&&o.agentId===i.id?o.workspace:null)||y.entry?.workspace||y.defaults?.workspace||i.workspace||`default`,S=y.entry?.model?l(y.entry?.model):y.defaults?.model?l(y.defaults?.model):l(x),C=h(i.agentRuntime),w=l(y.defaults?.model??x),T=re(y.entry?.model),E=re(y.defaults?.model)||(w===`-`?null:ne(w))||(a?null:re(x)),D=T??E??null,O=_?D:T,k=b(y.entry?.model)??b(y.defaults?.model)??(a?null:b(x))??[],A=Array.isArray(y.entry?.skills)?y.entry?.skills:null,j=A?.length??null,M=!a||s||c,ae=e=>{let t=k.filter((t,n)=>n!==e);g(i.id,t)};return e`
    <section class="card">
      ...
      <div class="agent-model-select" style="margin-top: 20px;">
        ...
        <div class="agent-model-fields">
          <label class="field">
            ...
            >
              ${_?e` <option value="" ?selected=${!O}>Not set</option> `:e`
                    <option value="" ?selected=${!O}>
                      ${E?`Inherit default (${E})`:`Inherit default`}
                    </option>
                  `}
              ${v(a,D??void 0,t.modelCatalog,O)}
            </select>
          </label>
          <div class="field">
            <span>Fallbacks</span>
            ...
            >
              ...
              <input
                ...
                @keydown=${e=>{let t=e.target;if(e.key===`Enter`||e.key===`,`){e.preventDefault();let n=f(t.value);n.length>0&&(g(i.id,[...k,...n]),t.value=``)}}}
                @blur=${e=>{let t=e.target,n=f(t.value);n.length>0&&(g(i.id,[...k,...n]),t.value=``)}}
              />
            </div>
          </div>
        </div>
...
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+q(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function $(e,t){return Q.parse(e,t)}$.options=$.setOptions=function(e){return Q.setOptions(e),$.defaults=Q.defaults,je($.defaults),$},$.getDefaults=Ae,$.defaults=I,$.use=function(...e){return Q.use(...e),$.defaults=Q.defaults,je($.defaults),$},$.walkTokens=function(e,t){return Q.walkTokens(e,t)},$.parseInline=Q.parseInline,$.Parser=X,$.parser=X.parse,$.Renderer=Vt,$.TextRenderer=Ht,$.Lexer=Y,$.lexer=Y.lex,$.Tokenizer=Bt,$.Hooks=Z,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,X.parse,Y.lex;function Ut(e){let t=e.trim();return t?t.split(/\s+/).length:0}function Wt(e){return e.length===0?0:e.split(/\r?\n/).length}function Gt(e){return e<=0?n(`agents.files.emptyDraft`):n(`agents.files.minRead`,{count:String(Math.max(1,Math.round(e/220)))})}function Kt(e){let t=e.split(`.`).pop()?.trim().toLowerCase();return t===`md`||t===`markdown`?n(`agents.files.markdownPreview`):t?n(`agents.files.extensionPreview`,{ext:t.toUpperCase()}):n(`agents.files.preview`)}function qt(e,t){let n=e.trim(),r=t?.trim();if(!n)return``;if(r&&n===r)return`.`;if(r&&n.startsWith(`${r}/`))return n.slice(r.length+1)||`.`;let i=n.split(/[\\/]+/);for(let e=i.length-1;e>=0;--e){let t=i[e];if(t)return t}return n}function Jt(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`preview`}function Yt(e,t){if(!(e instanceof HTMLElement))return;let r=n(t?`agents.files.collapsePreview`:`agents.files.expandPreview`);e.classList.toggle(`is-fullscreen`,t),e.setAttribute(`aria-pressed`,String(t)),e.setAttribute(`aria-label`,r),e.setAttribute(`title`,r)}function Xt(t,r,i){return e`
            ...
            <div class="list" style="margin-top: 16px;">
              ${i.map(i=>e`
                  <div class="list-item">
                    ...
                    <div class="list-meta">
                      <div class="mono">${C(i)}</div>
                      <div class="muted">${w(i)}</div>
                      <button
                        class="btn btn--sm"
  ...
  `}function rn(t){let i=t.agentFilesList?.agentId===t.agentId?t.agentFilesList:null,o=i?.files??[],s=t.agentFileActive??null,c=s?o.find(e=>e.name===s)??null:null,l=s?t.agentFileContents[s]??``:``,u=s?t.agentFileDrafts[s]??l:``,d=s?u!==l:!1,f=c?Oe($.parse(u,{gfm:!0,breaks:!0}),{sanitize:e=>y.sanitize(e)}):``,p=D(new TextEncoder().encode(u).length),m=Ut(u),ee=Wt(u),h=c?qt(c.path,i?.workspace):``,g=c?`agent-file-preview-title-${Jt(c.name)}`:``,te=c?.missing?n(`agents.files.willCreateOnSave`):n(d?`agents.files.liveDraftPreview`:`agents.files.savedPreview`),ne=c?.missing?`is-missing`:d?`is-dirty`:`is-synced`,_=c?.updatedAtMs?n(`agents.files.updated`,{time:a(c.updatedAtMs)}):c?.missing?n(`agents.files.notCreatedYet`):n(`agents.files.updatedUnknown`);return e`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
                      ...
                      <div class="md-preview-dialog__panel">
                        <div class="md-preview-dialog__header">
                          ...
                          <div class="md-preview-dialog__actions">
                            ...
                            >
                              <span class="when-normal" aria-hidden="true">${x.maximize}</span
                            ...
                            >
                              <span aria-hidden="true">${x.edit}</span>
                            </button>
                            <button
                              type="button"
                              class="btn btn--sm md-preview-icon-btn"
                            ...
                            >
                              <span aria-hidden="true">${x.x}</span>
                            </button>
                          </div>
                        </div>
                        <div class="md-preview-dialog__meta">
                          <div class="md-preview-dialog__chip ${ne}">
                            <strong>${te}</strong>
                          </div>
  ...
  `}function on(e,t){let n=t.source??e.source,r=t.pluginId??e.pluginId,i=[];return n===`plugin`&&r?i.push(`Plugin: ${r}`):n===`core`&&i.push(`Built-In`),t.optional&&i.push(`Optional`),i}function sn(e){let t=on(e.section,e.tool);return e.activeEntry&&t.unshift(`Live Now`),t}function cn(e){return e.denied?`Disabled by agent override.`:e.allowed&&e.baseAllowed?`Enabled by the current profile.`:e.allowed?`Enabled by agent override.`:`Not included in the current profile.`}function ln(e,t){let n=t.source??e.source,r=t.pluginId??e.pluginId;return n===`plugin`&&r?`Plugin: ${r}`:`Built-In`}function un(e){return e.denied?`Override Off`:e.allowed&&e.baseAllowed?`Enabled`:e.allowed?`Override On`:`Profile Off`}function dn(e){return e.activeEntry?`Live Now`:e.runtimeSessionMatchesSelectedAgent?`Not Live`:`Other Agent`}function fn(e){return`agent-tool-${p(e).replace(/[^a-z0-9_-]+/g,`-`)}`}function pn(e,t,n=`${t}s`){return`${e} ${e===1?t:n}`}function mn(e){return(e??[]).flatMap(e=>e.tools)}var hn=12;function gn(e){let t=e.currentTarget;if(!(!(t instanceof HTMLDetailsElement)||t.open))for(let e of t.querySelectorAll(`.agent-tool-card[open]`))e.open=!1}function _n(e,t){let n=document.getElementById(t);if(!(n instanceof HTMLDetailsElement))return;e.preventDefault();let r=n.closest(`.agent-tools-group`);r&&(r.open=!0),n.open=!0;let i=new URL(window.location.href);i.hash=t,window.history.replaceState(null,``,i),requestAnimationFrame(()=>{let e=typeof window.matchMedia==`function`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;n.scrollIntoView?.({block:`center`,behavior:e?`auto`:`smooth`}),n.querySelector(`summary`)?.focus()})}function vn(e){return e.source===`plugin`?e.pluginId?n(`agentTools.connectedSource`,{id:e.pluginId}):n(`agentTools.connected`):e.source===`channel`?e.channelId?n(`agentTools.channelSource`,{id:e.channelId}):n(`agentTools.channel`):n(`agentTools.builtIn`)}function yn(t){let i=d(t.configForm,t.agentId),a=i.entry?.tools??{},o=i.globalTools??{},s=a.profile??o.profile??`full`,c=ee(t.toolsCatalogResult),l=g(t.toolsCatalogResult),f=a.profile?`agent override`:o.profile?`global default`:`default`,h=Array.isArray(a.allow)&&a.allow.length>0,ne=Array.isArray(o.allow)&&o.allow.length>0,_=!!t.configForm&&!t.configLoading&&!t.configSaving&&!h&&!(t.toolsCatalogLoading&&!t.toolsCatalogResult&&!t.toolsCatalogError),v=h?[]:Array.isArray(a.alsoAllow)?a.alsoAllow:[],y=h?[]:Array.isArray(a.deny)?a.deny:[],re=h?{allow:a.allow??[],deny:a.deny??[]}:m(s)??void 0,b=l.flatMap(e=>e.tools.map(e=>e.id)),x=e=>{let t=te(e,re),n=u(e,v),r=u(e,y);return{allowed:(t||n)&&!r,baseAllowed:t,denied:r}},ie=b.filter(e=>x(e).allowed).length,S=t.runtimeSessionMatchesSelectedAgent&&!t.toolsEffectiveError?mn(t.toolsEffectiveResult?.groups):[],C=Array.from(new Map(S.map(e=>[p(e.id),e])).values()),w=C.slice(0,hn),T=Math.max(0,C.length-w.length),E=C.length,D=new Map(S.map(e=>[p(e.id),e])),O=new Set(D.keys()),k=e=>e.toSorted((e,t)=>{let n=p(e.id),r=p(t.id),i=O.has(n)?1:0,a=O.has(r)?1:0;if(i!==a)return a-i;let o=x(e.id).allowed?1:0,s=x(t.id).allowed?1:0;return o===s?e.label.localeCompare(t.label):s-o}),A=(e,n)=>{let r=new Set(v.map(e=>p(e)).filter(e=>e.length>0)),i=new Set(y.map(e=>p(e)).filter(e=>e.length>0)),a=x(e).baseAllowed,o=p(e);n?(i.delete(o),a||r.add(o)):(r.delete(o),i.add(o)),t.onOverridesChange(t.agentId,[...r],[...i])},j=e=>{let n=new Set(v.map(e=>p(e)).filter(e=>e.length>0)),r=new Set(y.map(e=>p(e)).filter(e=>e.length>0));for(let t of b){let i=x(t).baseAllowed,a=p(t);e?(r.delete(a),i||n.add(a)):(n.delete(a),r.add(a))}t.onOverridesChange(t.agentId,[...n],[...r])};return e`
    <section class="card">
      <div class="agent-tools-header">
        <div class="agent-tools-header__intro">
          ...
          <div class="card-sub">
            ...
            <span class="mono">${ie}/${b.length}</span> enabled.
          </div>
        </div>
        <div class="agent-tools-header__actions">
          <button class="btn btn--sm" ?disabled=${!_} @click=${()=>j(!0)}>
            Enable All
          </button>
          <button class="btn btn--sm" ?disabled=${!_} @click=${()=>j(!1)}>
            Disable All
          </button>
          <button
            class="btn btn--sm"
      ...
      <div class="agent-tools-overview">
                    ...
                    `:(t.toolsEffectiveResult?.groups?.length??0)===0?e`
                      ...
                      `:e`
                        <div class="agent-tools-runtime">
                          ${w.map(t=>{let n=fn(t.id);return e`
                              <a
                          ...
                          ${T>0?e`
                                <span
                                  ...
                                  title=${`${T} more live tools are available in the groups below.`}
                                >
                                  +${T} more live tools
                                </span>
                              `:r}
        ...
        <div class="agent-tools-facts">
          ...
          <div class="agent-tools-fact">
            ...
            <div class="mono">${ie}/${b.length}</div>
          </div>
          <div class="agent-tools-fact">
      ...
      <div class="agent-tools-grid">
        ${l.map(n=>{let i=k(n.tools),a=n.tools.filter(e=>x(e.id).allowed).length,o=n.tools.filter(e=>O.has(p(e.id))).length,s=i.slice(0,4),c=Math.max(0,i.length-s.length);return e`
            <details class="agent-tools-group" @toggle=${gn}>
              ...
              <div class="agent-tools-list agent-tools-list--stacked">
                ${i.map(i=>{let a=fn(i.id),o=x(i.id),s=D.get(p(i.id))??null,c=i.defaultProfiles??[],l=sn({section:n,tool:i,activeEntry:s}),u=un(o),d=dn({activeEntry:s,runtimeSessionMatchesSelectedAgent:t.runtimeSessionMatchesSelectedAgent});return e`
  ...
  `}function bn(t){let a=!!t.configForm&&!t.configLoading&&!t.configSaving,o=d(t.configForm,t.agentId),s=Array.isArray(o.entry?.skills)?o.entry?.skills:void 0,c=new Set((s??[]).map(e=>e.trim()).filter(Boolean)),l=s!==void 0,u=!!(t.report&&t.activeAgentId===t.agentId),f=u?t.report?.skills??[]:[],p=i(t.filter),m=p?f.filter(e=>i([e.name,e.description,e.source].join(` `)).includes(p)):f,ee=A(m),h=l?f.filter(e=>c.has(e.name)).length:f.length,g=f.length;return e`
    <section class="card">
      <div class="row" style="justify-content: space-between; flex-wrap: wrap;">
        <div style="min-width: 0;">
          ...
          <div class="card-sub">
            ...
            ${g>0?e`<span class="mono">${h}/${g}</span>`:r}
          </div>
        </div>
      ...
      ${m.length===0?e` <div class="muted" style="margin-top: 16px">No skills found.</div> `:e`
            <div class="agent-skills-groups" style="margin-top: 16px;">
              ${ee.map(e=>xn(e,{agentId:t.agentId,allowSet:c,usingAllowlist:l,editable:a,onToggle:t.onToggle}))}
            </div>
          `}
    </section>
...
//# sourceMappingURL=agents-v9EIiiol.js.map