import{h as e,o as t,p as n}from"./string-coerce-Bb38bdND.js";import{d as r,i}from"./format-GXfF9CmD.js";import{F as a,a as o,c as s,f as c,m as l,n as u}from"./index-DG_qohbg.js";function d(){return[{value:`ok`,label:t(`cron.runs.runStatusOk`)},{value:`error`,label:t(`cron.runs.runStatusError`)},{value:`skipped`,label:t(`cron.runs.runStatusSkipped`)}]}function f(){return[{value:`delivered`,label:t(`cron.runs.deliveryDelivered`)},{value:`not-delivered`,label:t(`cron.runs.deliveryNotDelivered`)},{value:`unknown`,label:t(`cron.runs.deliveryUnknown`)},{value:`not-requested`,label:t(`cron.runs.deliveryNotRequested`)}]}function p(e,t,n){let r=new Set(e);return n?r.add(t):r.delete(t),Array.from(r)}function m(e,t){return e.length===0?t:e.length<=2?e.join(`, `):`${e[0]} +${e.length-1}`}function h(e){let t=[`last`,...e.channels.filter(Boolean)],n=e.form.deliveryChannel?.trim();n&&!t.includes(n)&&t.push(n);let r=new Set;return t.filter(e=>r.has(e)?!1:(r.add(e),!0))}function g(e,t){if(t===`last`)return`last`;let n=e.channelMeta?.find(e=>e.id===t);return n?.label?n.label:e.channelLabels?.[t]??t}function _(n){return e`
  ...
  `}function A(e){e.target?.closest(`a,button,input,textarea,select,summary,[role='button'],[role='link']`)&&e.stopPropagation()}function j(e){return typeof e!=`number`||!Number.isFinite(e)?t(`common.na`):r(e)}function M(e,n=Date.now()){let i=r(e);return t(e>n?`cron.runEntry.next`:`cron.runEntry.due`,{rel:i})}function N(n){let r=n.state?.lastStatus,a=r===`ok`?`cron-job-status-ok`:r===`error`?`cron-job-status-error`:r===`skipped`?`cron-job-status-skipped`:`cron-job-status-na`,o=t(r===`ok`?`cron.runs.runStatusOk`:r===`error`?`cron.runs.runStatusError`:r===`skipped`?`cron.runs.runStatusSkipped`:`common.na`),s=n.state?.nextRunAtMs,c=n.state?.lastRunAtMs;return e`
    ...
    <div class="list-item cron-run-entry">
      <div class="cron-run-entry__header">
        ...
        <div class="list-meta cron-run-entry__meta">
          ...
          ${typeof r.nextRunAtMs==`number`?e`<div class="muted">${M(r.nextRunAtMs)}</div>`:n}
          ${u?e`<div>
                <a
                  class="session-link"
                  href=${u}
...
//# sourceMappingURL=cron-ILI-mezr.js.map