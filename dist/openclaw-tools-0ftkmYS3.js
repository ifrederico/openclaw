...
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-E69J4lLI.js";
...
import { n as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CBe-gKry.js";
...
import { t as isInboundPathAllowed } from "./inbound-path-policy-CRVCy_2Y.js";
import "./config-Dq84uU6c.js";
import { n as isRestartEnabled } from "./commands.flags-B7qbzmZ1.js";
import { o as normalizeChannelId } from "./registry-By_qtZ6R.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-DQju26jn.js";
import { r as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-core-D2XbUpib.js";
import { u as normalizeMessageChannel } from "./message-channel-B1O_CztY.js";
import { d as readConnectPairingRequiredMessage } from "./connect-error-details-yQh0heaK.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-DyAc2t0f.js";
import { i as callGateway } from "./call-z1vgxJx0.js";
import { f as scheduleGatewaySigusr1Restart } from "./restart-Dd-BFtwl.js";
import { a as loadManifestContractSnapshot, i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane } from "./manifest-contract-eligibility-BuQOyv7-.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-CSgsEl_z.js";
import { a as resolveSessionFilePath, d as resolveStorePath, o as resolveSessionFilePathOptions } from "./paths-DG09LE-n.js";
import { i as normalizeDeliveryContext, t as deliveryContextFromSession } from "./delivery-context.shared-tofZwoN5.js";
import { d as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-DjtlQRVG.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, t as getChannelPlugin } from "./registry-BkuUNjzB.js";
import { n as resolveSessionConversationRef } from "./session-conversation-6JE9TRWs.js";
...
import { a as extractDeliveryInfo } from "./sessions-DEgkNCWw.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-Cl9AEOGH.js";
import { _ as modelKey, h as resolveModelRefFromString, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, v as normalizeModelRef } from "./model-selection-shared-DOxyWoaQ.js";
import { n as ensureOpenClawModelsJson } from "./models-config-BCL7xtRj.js";
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-u8IQheQP.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-G30DI_5w.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-BGVcDQat.js";
import { r as loadModelCatalog } from "./model-catalog-BlLdiT-K.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-DO_SYQPb.js";
import { n as extractTextFromChatContent } from "./chat-content-DT1PmzwJ.js";
import { u as stripReasoningTagsFromText } from "./assistant-visible-text-DWECa3ch.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-3Wy8T6mE.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as recordTaskRunProgressByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-BZXQbagB.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-CmpKr0jO.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-DOdi-EcR.js";
import { C as describeSessionsSendTool, S as describeSessionsListTool, T as describeUpdatePlanTool, _ as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, b as describeSessionStatusTool, g as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, h as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, m as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, p as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, u as CRON_TOOL_DISPLAY_SUMMARY, v as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, w as describeSessionsSpawnTool, x as describeSessionsHistoryTool, y as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY } from "./tool-policy-shared-Ce8ZI4la.js";
import { a as resolvePluginTools, c as hasNonEmptyManifestEnvCandidate, d as manifestProviderBaseUrlGuardPasses, l as manifestConfigSignalPasses, u as manifestPluginSetupProviderEnvVars } from "./tools-CIiGJzcD.js";
import { D as textToSpeech } from "./tts-runtime-Btvk-HT-.js";
import "./tts-B4VxOis2.js";
import { a as getImageMetadata } from "./image-ops-CofkDchS.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-DC32BHLQ.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-CtuVk7ji.js";
import { c as wrapToolWithBeforeToolCallHook, d as listAllChannelSupportedActions, o as isToolWrappedWithBeforeToolCallHook, p as listChannelSupportedActions } from "./pi-tools.before-tool-call-D0Kb8Xtm.js";
import "./auth-profiles-Dqjb7Hia.js";
import { n as listProfilesForProvider } from "./profile-list-DRiyVI2U.js";
import { r as getApiKeyForModel } from "./model-auth-CunBH4hV.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-BJUkaK0F.js";
import { t as SsrFBlockedError } from "./ssrf-B5bGsnx-.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Cq6IFZui.js";
import { n as extractAssistantText } from "./pi-embedded-utils-DgdXzFKk.js";
import { n as runWithImageModelFallback } from "./model-fallback-DIXhOaxb.js";
import { b as readSnakeCaseParamRaw, f as readNumberParam, g as readStringParam$1, i as asToolParamsRecord, l as jsonResult, m as readStringArrayParam, r as ToolInputError, s as imageResult } from "./common-CA61yuMe.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BLR6Zsy8.js";
import { o as trySafeFileURLToPath, r as hasEncodedFileUrlSeparator } from "./local-file-access-B_sfffxh.js";
import { n as assertSandboxPath } from "./sandbox-paths-DdSAJrH6.js";
import { n as normalizeWorkspaceDir, o as toRelativeWorkspacePath, r as resolveWorkspaceRoot } from "./read-capability-CNRnU0FP.js";
...
import "./delivery-context-D7rtxFDu.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-Cra6KiFJ.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-uCeCLCPX.js";
import { t as sniffMimeFromBase64 } from "./sniff-mime-from-base64-CYIkMwFc.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-BsidlL7H.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-ARCpniZT.js";
import { n as resolveSubagentAllowedTargetIds } from "./spawn-requester-origin-bdQglDT7.js";
import { a as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-DOfIn8YE.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-D-D4T8Yk.js";
import { r as stripToolMessages } from "./chat-history-text-DM8HgNri.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-7-BB7Fke.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-BU4GZFwt.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-DudlRWlk.js";
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-Cug13zAZ.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CEHMsNAM.js";
import { t as inferLegacyName } from "./normalize-Dk30Nk_g.js";
import { n as assertSafeCronSessionTargetId, t as normalizeHttpWebhookUrl } from "./webhook-url-BBNQdZHS.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-YzPFz2Pd.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-Ds1zOSz-.js";
import { a as normalizeDurationToClosestMax, d as throwCapabilityGenerationFailure, i as hasMediaNormalizationEntry, n as buildNoCapabilityModelConfiguredMessage, o as recordCapabilityCandidateFailure, s as resolveCapabilityModelCandidates, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-Cg0obnBB.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-D_ottjYC.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-BvOsP3BC.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-DwoHCTZn.js";
import { l as saveMediaBuffer } from "./store-LePoapNA.js";
import { a as classifyMediaReferenceSource, o as normalizeMediaReferenceSource, r as getDefaultLocalRoots } from "./local-media-access-yd5x-sCZ.js";
import { n as loadWebMediaRaw, t as loadWebMedia } from "./web-media-DgWVaCDY.js";
import { a as coerceImageModelConfig, c as resolveConfiguredImageModelRefs, d as coerceToolModelConfig, f as hasAuthForProvider, l as resolveProviderVisionModelFromConfig, m as resolveDefaultModelRef, n as isMinimaxVlmProvider, o as decodeDataUrl, p as hasToolModelConfig, u as buildToolModelConfigFromCandidates } from "./minimax-vlm-CxUo_los.js";
import { i as discoverModels, r as discoverAuthStorage } from "./pi-model-discovery-5JrZ5nj6.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-CWbS8Mzx.js";
import { n as normalizeMediaProviderId } from "./config-provider-models-DpUG7RLK.js";
import { n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-DF3zyacx.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-Dp3baQw5.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS } from "./defaults.constants-Bb4Dm6jL.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-BnKzLewz.js";
import { s as resolveTimeoutMs } from "./resolve-D7XwZuJE.js";
import { t as buildProviderRegistry } from "./runner-7mUEgagB.js";
import "./media-understanding-D-m_ASUa.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-CDhq_Cbf.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-CRTCUN3R.js";
import { o as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-raYM5-Vl.js";
import { a as POLL_CREATION_PARAM_DEFS, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, t as getToolResult } from "./message-action-runner-8S675UW4.js";
import { n as resolveMusicGenerationModeCapabilities, t as listSupportedMusicGenerationModes } from "./capabilities-BQoETXWe.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-C1j-hiPe.js";
import { n as formatAgentInternalEventsForPrompt } from "./internal-events-BNSVK5-K.js";
import { i as loadSessionEntryByKey, t as deliverSubagentAnnouncement } from "./subagent-announce-delivery-C21x0PIk.js";
...
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-lb8AEaSf.js";
import { t as parseTimeoutMs } from "./parse-timeout-DXmg9bxb.js";
import { n as resolveEnabledBundledManifestContractPlugins, t as extractPdfContent } from "./pdf-extract-OC2Wf-zR.js";
import { C as jsonUtf8Bytes, f as readSessionTitleFieldsFromTranscriptAsync, n as capArrayByJsonBytes } from "./session-utils.fs-KrU2mfs9.js";
import { _ as resolveSessionModelIdentityRef, n as deriveSessionTitle } from "./session-utils-Cl-I1HfR.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-CYZx2Rwc.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CFSHj6AB.js";
import { i as resolveNestedAgentLaneForSession } from "./lanes-BjTmNhYY.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-DovYK2fI.js";
import { _ as isReplySkip, f as runAgentStep, g as isNonDeliverableSessionsReply, h as isAnnounceSkip, m as REPLY_SKIP_TOKEN, p as ANNOUNCE_SKIP_TOKEN } from "./subagent-session-cleanup-BCiiUQZB.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-CksLUJN9.js";
import { p as registerSubagentRun } from "./subagent-registry-BTDmugmA.js";
import { n as SUBAGENT_SPAWN_CONTEXT_MODES, r as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-CZA9_Uwl.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-BZsaUczw.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-Cts92GIE.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, r as listSupportedVideoGenerationModes } from "./duration-support-DBMWvF-Y.js";
import { t as parseVideoGenerationModelRef } from "./model-ref-Bc03pLk6.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-D9UfqVAj.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-M-sFVDK7.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-BeR20r-M.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-C2klyNbz.js";
import { a as readResponseText, i as readCache, l as writeCache, o as resolveCacheTtlMs, r as normalizeCacheKey, s as resolveTimeoutSeconds } from "./web-shared-cXpllDuo.js";
import { i as runWebSearch } from "./runtime-Dl0SBgk6.js";
import "./web-search-provider-common-ByzoAZEn.js";
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-BxunCl1X.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-DBESmEjw.js"));
...
const webFetchRuntimeLoader = createLazyImportLoader(() => import("./runtime-7qIqajbN.js"));
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-DqXMQke7.js"));
...
//#endregion
export { isParentOwnedBackgroundAcpSession as C, setEmbeddedMode as S, resolveOpenClawPluginToolsForOptions as _, normalizeCronJobInput as a, stripProviderPrefix as b, createHostWorkspaceEditTool as c, createSandboxedEditTool as d, createSandboxedReadTool as f, wrapToolWorkspaceRootGuardWithOptions as g, wrapToolWorkspaceRootGuard as h, normalizeCronJobCreate as i, createHostWorkspaceWriteTool as l, wrapToolMemoryFlushAppendOnlyWrite as m, generateMusic as n, normalizeCronJobPatch as o, createSandboxedWriteTool as p, listRuntimeMusicGenerationProviders as r, resolveToolLoopDetectionConfig as s, createOpenClawTools as t, createOpenClawReadTool as u, isStrictAgenticExecutionContractActive as v, isEmbeddedMode as x, isStrictAgenticSupportedProviderModel as y };
