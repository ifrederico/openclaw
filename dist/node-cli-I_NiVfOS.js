...
import { o as sameFileIdentity } from "./boundary-file-read-CdxVvait.js";
...
import { r as theme, t as colorize } from "./theme-BeexRN7S.js";
import { i as resolveAgentConfig } from "./agent-scope-CXWTwwic.js";
import { a as logWarn } from "./logger-DC8YwEpM.js";
import { n as VERSION } from "./version-Bh_RSQ5Y.js";
import { J as resolveCommandResolutionFromArgv, K as resolveApprovalAuditCandidatePath, a as loadConfig, ct as unwrapKnownShellMultiplexerInvocation, dt as resolveInlineCommandMatch, et as resolveExecutableFromPathEnv, ht as normalizeExecutableToken, lt as POSIX_INLINE_COMMAND_FLAGS, mt as unwrapKnownDispatchWrapperInvocation, nt as POSIX_SHELL_WRAPPERS } from "./io-CS2J_l4V.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-D-6e61X4.js";
import { d as NODE_EXEC_APPROVALS_COMMANDS, p as NODE_SYSTEM_RUN_COMMANDS } from "./loader-BkajlJCF.js";
import "./config-dzPpvDz6.js";
import { t as formatCliCommand } from "./command-format-D6RJqoCJ.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-DRWfIhrn.js";
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-BwkS3bFW.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-CgEfWJeV.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BhzkNvfv.js";
...
import { d as resolveRuntimeStatusColor, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-DbEFE2sP.js";
import { a as formatRuntimeStatus, i as buildPlatformServiceStartHints, r as buildPlatformRuntimeLogHints } from "./systemd-hints-bQAQjsZ9.js";
import { t as parsePort } from "./parse-port-DpUYrM0p.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-d0r6RbUM.js";
import { d as getMachineDisplayName, n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-Dt2Y--UF.js";
import { t as splitShellArgs } from "./shell-argv-C85UOj5y.js";
import { A as saveExecApprovals, B as detectInterpreterInlineEvalArgv, C as requiresExecApproval, E as resolveExecApprovals, H as analyzeArgvCommand, J as resolvePlannedSegmentArgv, M as evaluateExecAllowlist, N as evaluateShellAllowlist, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, d as mergeExecApprovalsSocketDefaults, j as requestJsonlSocket, o as ensureExecApprovals, p as normalizeExecApprovals, s as hasDurableExecApproval, v as persistAllowAlwaysPatterns, y as readExecApprovalsSnapshot, z as describeInterpreterInlineEval } from "./exec-approvals-CBfBa44f.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-DXgF5fCJ.js";
...
import { t as ensureOpenClawCliOnPath } from "./path-env-4G7R9FHB.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-DOu2ELyv.js";
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-RGgHwAvi.js");
