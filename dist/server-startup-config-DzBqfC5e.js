...
import { A as applyConfigOverrides, f as readConfigFileSnapshotWithPluginMetadata } from "./io-E69J4lLI.js";
...
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-CwXN1_0V.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-BTdz7sXq.js";
...
async function loadGatewayStartupConfigSnapshot(params) {
	...
	if (configSnapshot.warnings.length > 0) params.log.warn(`gateway: config warnings:\n${formatConfigIssueLines(configSnapshot.warnings, "-").join("\n")}`);
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = () => {
		secretsRuntimePromise ??= import("./runtime-DNgdh7KK.js");
		return secretsRuntimePromise;
	};
	const loadAuthProfiles = () => {
		authProfilesPromise ??= import("./auth-profiles-Dus7EZn8.js");
