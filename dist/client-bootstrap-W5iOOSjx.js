...
import { t as getActiveMatrixClient } from "./active-client-DTd5NVib.js";
...
async function loadMatrixSharedClientRuntimeDeps() {
	matrixSharedClientRuntimeDepsPromise ??= Promise.all([import("./client-C2RsM6qm.js"), import("./shared-BITETIQ5.js")]).then(([clientModule, sharedModule]) => ({
